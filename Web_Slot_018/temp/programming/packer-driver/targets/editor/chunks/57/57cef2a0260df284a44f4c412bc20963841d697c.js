    ...
    execute: function () {
      ...
      _export("JpAniController", JpAniController = (_dec = ccclass('JpAniController'), _dec(_class = class JpAniController extends Component {
        constructor(...args) {
          ...
          this.afterJPAniShowCompleteEvent = async value => {
            ...
            const spine = this._spineTarget.spine; //spine.setCompleteListener(null); // 清除監
            //--loop
        ...
        playJPAnimation(value, rotationType) {
          ...
          const rotationKey = rotationType != null ? rotationType : this._screenRotationResolution === (_crd && Orientation === void 0 ? (_reportPossibleCrUseOfOrientation({
            error: Error()
        ...
        playAniForChangeRotationResolution(value) {
          ...
          const rotationType = value == (_crd && Orientation === void 0 ? (_reportPossibleCrUseOfOrientation({
            error: Error()
          }), Orientation) : Orientation).Landscape ? 'L' : 'P';

          const aniData_LP = this._spineTarget.getCustomizeSpineTrackEntry(rotationType);

          const spine = this._spineTarget.spine; //--LP
        ...
        async showJPWin(rotationType) {
          ...
          this._aryAniCtrlPropDefs = [aniData_coin, aniData_in, aniData_loop, aniData_LP]; // 播放 coin +  --LP 動畫
          ...
          spine.setCompleteListener(this._onSpineCompleteHandler); //--in
...
//# sourceMappingURL=57cef2a0260df284a44f4c412bc20963841d697c.js.map