  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameInfoUIFix", GameInfoUIFix = (_dec = ccclass("GameInfoUIFix"), _dec2 = property(CCBoolean), _dec3 = property(_crd && PageIconGroup === void 0 ? (_reportPossibleCrUseOfPageIconGroup({
        ...
        async spawnPages_test() {
          const currentLangKey = (_crd && Localization === void 0 ? (_reportPossibleCrUseOfLocalization({
            error: Error()
          ...
          const pagePromises = this.pagePrefabs.map(async (prefab, index) => {
            ...
            const localizationSpine = pageNode.getComponentInChildren(_crd && LocalizationSpine === void 0 ? (_reportPossibleCrUseOfLocalizationSpine({
              error: Error()
        ...
        async onRelease(dragDiff) {
          if (dragDiff.x === 0) return;
          this.dragNodeEvent.isDetecting = false;
          ...
          this.dragNodeEvent.isDetecting = true;
        }
