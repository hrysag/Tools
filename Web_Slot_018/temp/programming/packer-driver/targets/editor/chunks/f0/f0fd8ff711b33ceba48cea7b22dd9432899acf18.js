    ...
    execute: function () {
      ...
      _export("BuyFGGuiController", BuyFGGuiController = (_dec = ccclass('BuyFGGuiController'), _dec2 = property({
        ...
        constructor(..._args) {
          ...
          this.confirmClickHandler = async () => {
            var _this$confirmCallback, _this$closeCallback;
            ...
            await this._spController.playAniInPromise('out_confirm'); //this.node.active = false;

            this.close();
            (_this$confirmCallback = this.confirmCallback) == null || _this$confirmCallback.call(this, this.currentBetValue, this.currentFeatureTotal);
            (_this$closeCallback = this.closeCallback) == null || _this$closeCallback.call(this);
          };

          this.cancelClickHandler = async () => {
            var _this$closeCallback2;
            ...
            this.close();
            (_this$closeCallback2 = this.closeCallback) == null || _this$closeCallback2.call(this); //this.node.active = false;
          };
          ...
          this.spControllerKeyFrameEvtHandler = (...args) => {
        ...
        fadeOutGui() {
          const target = [this._confirmButton, this._cancelButton, this._addAmountButton, this._subtractAmountButton, this._totalBetNode, this._totalFGAmount, this._confirmButtonLanguageNode];
...
//# sourceMappingURL=f0fd8ff711b33ceba48cea7b22dd9432899acf18.js.map