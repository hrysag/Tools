  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameController018", GameController018 = (_dec = ccclass('GameController018'), _dec2 = property({
        ...
        constructor(...args) {
          ...
          */
          ...
          this.onGameViewShowEndEventHandler = () => {
            ...
            if (!this.isOnline) {
              let winMoney = (this._currentSlotInfo.allRoundOdds * this._currentSlotInfo.betValue).fixed();
          ...
          this.onGameViewBuyFgEventHandler = (sub, value) => {
            ...
            const isEnough = this.checkBuyFGBalanceAndProcessBtn(value[0].eventData.totalBetValue);
        ...
        setupBeforeGame() {
          const testVersion = '1.0.1-qa.20250731'; //--暫時的
        ...
        moveProfilerToTopRight() {
          ...
          if (profiler.offsetData) {
            const offsetData = profiler.offsetData;
        ...
        * */
        ...
        onReceiveBet(betData) {
          ...
          if (this._isBuyFg) {
            //--FG狀態
            let buyFGtotalBet = this._fgFinalBet;
          ...
          const roundData = this._currentSlotInfo.getCloneData();
        ...
        sendDataToServer(isBuyFG = false, buyFGBetValue) {
        ...
        startSpin(reelIds) {
          ...
          const isEnough = this.checkBalanceAndProcessBtn();
          if (isEnough) return;
        ...
        showBottomText(status, value) {
          switch (status) {
            ...
            case (_crd && ShowBottomTextStatus === void 0 ? (_reportPossibleCrUseOfShowBottomTextStatus({
              ...
              let showScore = 0; //--有FG的情況下FG的得分面板要顯示的跟bottomText一樣(從NG一路累加)
        ...
        async testReceiveBetData() {
          ...
          let testData = this._currentSlotInfo.getCloneData();

          this.checkServerDataAfterReceiveForShowScoreOnBottom(testData);

          this._gameView.setSeverReceiveData(testData); //this._gameView.stopSpin();
        ...
        testServerData() {
          ...
          const testBase64Data = [//'BHFTUwQzU1cz',//--平手有得分
          //'VUCEUhQBFDhF'
...
//# sourceMappingURL=1f5d142faeb732bca9d451c53b6727174b2795e2.js.map