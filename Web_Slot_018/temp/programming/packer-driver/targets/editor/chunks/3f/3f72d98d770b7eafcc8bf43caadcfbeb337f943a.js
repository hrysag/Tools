    ...
    execute: function () {
      ...
      _export("GateN2FTransition", GateN2FTransition = (_dec = ccclass('GateN2FTransition'), _dec2 = property({
        ...
        constructor(..._args) {
          ...
          this.spineGateKeyFrameEvtHandler = (...args) => {
            ...
            switch (args[0]) {
              ...
              case 'wiggle':
                this.shakeNode(this._targetNGSlotFrameNode, 0.13, 0.05, {
                  x: 0,
                  y: 8
                });
                break;
              ...
              case 'wiggle_small':
                this.shakeNode(this._targetNGSlotFrameNode, 0.66, 0.05, {
                  x: 2,
                  y: 2
                });
                break;
        ...
        testScreenCapture() {
          return;
          let testCapture = new (_crd && CanvasRender === void 0 ? (_reportPossibleCrUseOfCanvasRender({
            error: Error()
        ...
        async setCamp(value) {
          return new Promise(async resolve => {
            ...
            this._spine_gate.changeSkin(skin_id); //this._targetFGSlotFrameNode = this._scaleSlotFrameNode.getChildByName(targetFGDisplayFrameName);


            this._targetFGSlotFrameNode = (_crd && FindNode === void 0 ? (_reportPossibleCrUseOfFindNode({
              error: Error()
            }), FindNode) : FindNode).findChildByNameRecursive(this._scaleSlotFrameNode, targetFGDisplayFrameName);
        ...
        async playAinForStart(callBack) {
        ...
        cleanTransition() {
          ...
          const comp = this._targetFGSlotFrameNode.getComponent(_crd && FG_SpriteController === void 0 ? (_reportPossibleCrUseOfFG_SpriteController({
            error: Error()
        ...
        setupSpineAnimations(spine, defs) {
          for (const def of defs) {
            const ani = new (_crd && AniCtrlPropDef === void 0 ? (_reportPossibleCrUseOfAniCtrlPropDef({
              error: Error()
        ...
        //gui進場
        async fgUiActionByKeyFrameEvt(value) {
          ...
          if (this._resolvePromiseForOut) {
            ...
            this._resolvePromiseForOut = undefined; //await GameUtils.Defer(1000);
          }
        }
        /**
         * 
        ...
        tweenScaleForFadeOut() {
          let scaleValue = this._screenRotationResolution == (_crd && Orientation === void 0 ? (_reportPossibleCrUseOfOrientation({
            error: Error()
...
//# sourceMappingURL=3f72d98d770b7eafcc8bf43caadcfbeb337f943a.js.map