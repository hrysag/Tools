      ...
      _export("RPSCollection", RPSCollection = (_dec = ccclass('RPSCollection'), _dec2 = property({
        ...
        async setLevel(level) {
          return new Promise(async (resolve, reject) => {
            ...
            let lightComponent = null;
            let lightComponent_1 = null;
            let lightComponent_2 = null;
        ...
        getLightNodeComponent(lv) {
          let lightEffectComponent = this._mapRunningLight.get(lv);
        ...
        createLightNode(lv) {
          const light = (_crd && AnimationControllersPoolManager === void 0 ? (_reportPossibleCrUseOfAnimationControllersPoolManager({
            error: Error()
          ...
          const spineAniComponent = light.getComponent(_crd && SpineController === void 0 ? (_reportPossibleCrUseOfSpineController({
            error: Error()
          }), SpineController) : SpineController);
        ...
        changeSkin(spineAniComponent) {
          const skinName = 'FG_0' + this._startCamp; //console.log('changetSkin_wild', skinName);
...
//# sourceMappingURL=ff603126a042c65a0bfc171e67e6280e4c47358b.js.map