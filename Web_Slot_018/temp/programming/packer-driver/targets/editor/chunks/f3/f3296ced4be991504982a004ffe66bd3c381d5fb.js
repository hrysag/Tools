System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "1fefaH7U8BFmaBZQCq455LP", "NotifyCation", undefined);
      /**
      ...
      _export("NotifyCation", NotifyCation = class NotifyCation {
        ...
        async requestData(mainResponse, subRes, mainRequest, instance) {
          return new Promise((resolve, reject) => {
            ...
            this.on(mainResponse, subRes, data => {
              resolve(data);
            }, instance, true); //notification.emit("dataRequest", "subtopic");
...
//# sourceMappingURL=f3296ced4be991504982a004ffe66bd3c381d5fb.js.map