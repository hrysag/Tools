      ...
      _export("JpShowController", JpShowController = (_dec = ccclass('JpShowController'), _dec2 = property({
        ...
        constructor(...args) {
          ...
          this.blockBtnClickHandler = async () => {
            ...
            this._jpDigiAniNumber.checkFinishWinScoreShow(); //--true
        ...
        showJPWin(odds, totalBet) {
          return new Promise(async (resolve, reject) => {
            ...
            this.onScoreRunEnd(false); //await GameUtils.Defer(2000);
...
//# sourceMappingURL=fa3734097636d6fa607ba103e42555b65d6673d7.js.map