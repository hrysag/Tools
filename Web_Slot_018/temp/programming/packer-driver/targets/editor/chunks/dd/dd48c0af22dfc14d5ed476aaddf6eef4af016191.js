    ...
    execute: function () {
      ...
      _export("SlotMachineController018", SlotMachineController018 = (_dec = ccclass('SlotMachineController018'), _dec2 = property({
        ...
        generateRandomIconData(reelID, previousIcons) {
          const sourceList = this._slotMachineData.getTargetAllSymbolList(this._rollerStateForGame);

          const uniqueList = this._slotMachineData.getTargetUniqueSymbolList(reelID, this._rollerStateForGame);

          const pickedSymbols = [];
          const possibleSymbols = [];
          const usedUniqueSymbols = [];
          let iconAmount = this.getIconAmount(reelID); // 產生所有可能的符號組合
          ...
          for (let i = 0; i < iconAmount; i++) {
            ...
            let symbol = possibleSymbols[randomIndex]; // 檢查唯一性
...
//# sourceMappingURL=dd48c0af22dfc14d5ed476aaddf6eef4af016191.js.map