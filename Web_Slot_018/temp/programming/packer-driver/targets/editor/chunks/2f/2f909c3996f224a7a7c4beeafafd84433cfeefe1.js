System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, CalculatePayTable, WinData, PayLineData, _crd;

  _export({
    CalculatePayTable: void 0,
    WinData: void 0
  });
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f6fbeA/fYVIAbR8albDgubC", "CalculatePayTable", undefined);

      __checkObsolete__(['_decorator']);

      _export("CalculatePayTable", CalculatePayTable = class CalculatePayTable {
        /**
         * @param wild WILD圖示
        ...
        getConnectWinData(iconData, reelAmount, symbolLength, getAllConnect = false) {
          this.reelAmount = reelAmount;
          this.symbolLength = symbolLength;
          this.isGetAllConnect = getAllConnect;
          return this.connectWinData(iconData);
        }

        connectWinData(iconData) {
          const winDataList = [];
          ...
          for (let i = 0; i < this.payLine.length; i++) {
            ...
            if (result) {
              for (let [key, value] of result) {
                ...
                const winData = new WinData(i, key, value.Odd, value.Pos, pos2DData);
...
//# sourceMappingURL=2f909c3996f224a7a7c4beeafafd84433cfeefe1.js.map