      ...
      _export("DataString_MegaSize", DataString_MegaSize = class DataString_MegaSize {
        ...
        writeTo(dataView, iOffset) {
          ...
          if (this.m_bWithLength) {
            ...
            for (let i = (_crd && NetConst === void 0 ? (_reportPossibleCrUseOfNetConst({
              error: Error()
            }), NetConst) : NetConst).SAVE_BITS_MEGA_STRING - 1; i >= 0; --i) {
              // 3 bytes紀錄長度.
              dataView.setUint8(iOffset + i, iValue & 0xff);
              iValue >>= 8;
            }
      ...
      */
      ...
      _export("BinaryBufferWriter", BinaryBufferWriter = class BinaryBufferWriter {
        ...
        toArrayBuffer() {
          ...
          let iter = (_crd && IteratorFactory === void 0 ? (_reportPossibleCrUseOfIteratorFactory({
            error: Error()
        ...
        toArrayBufferWithSize() {
          ...
          let iBufferSize = iPacketSize + (_crd && NetConst === void 0 ? (_reportPossibleCrUseOfNetConst({
            error: Error()
          ...
          let headerData = new DataBytes(iPacketSize, (_crd && NetConst === void 0 ? (_reportPossibleCrUseOfNetConst({
            error: Error()
          }), NetConst) : NetConst).HEADER_SIZE);
...
//# sourceMappingURL=06d8960a3a43a7a5c546781457254b64906e9ffe.js.map