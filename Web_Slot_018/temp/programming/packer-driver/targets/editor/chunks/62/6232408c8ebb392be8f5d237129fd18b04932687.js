    ...
    execute: function () {
      ...
      _export("ShareBg", ShareBg = (_dec = ccclass('ShareBg'), _dec2 = property({
        ...
        playMutiTrackAni(rotationKey) {
          ...
          const aniKey2 = this._mapAniKey.get(rotationKey).get('sub'); //this._shareBg.playMutipleAni([aniKey1, aniKey2]);
        ...
        changeRotationResolution(value) {
          ...
          const comp = (_crd && FindComponent === void 0 ? (_reportPossibleCrUseOfFindComponent({
            error: Error()
...
//# sourceMappingURL=6232408c8ebb392be8f5d237129fd18b04932687.js.map