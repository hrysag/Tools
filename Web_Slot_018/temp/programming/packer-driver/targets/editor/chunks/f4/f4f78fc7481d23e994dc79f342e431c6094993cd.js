      ...
      _export("GameStartFix", GameStartFix = (_dec = ccclass('GameStartFix'), _dec2 = property(CCBoolean), _dec3 = property(JsonAsset), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(ProgressBar), _dec7 = property(Node), _dec8 = property(_crd && GameInfoUIFix === void 0 ? (_reportPossibleCrUseOfGameInfoUIFix({
        ...
        async startLoad() {
          ...
          if (this.isNewLoading) {
            ...
            await this.gameInfoUI.spawnPages_test(); //--fix 0711
        ...
        async checkInitGameScene() {
          if (this.isLoadSceneDone && this.getPlayerInfoDone) {
            var _this$runScenePromise;

            let gameRoot = director.getScene().getComponentInChildren('GameRoot');
            await gameRoot.init();
            (_this$runScenePromise = this.runScenePromiseResolve) == null || _this$runScenePromise.call(this);
          }
        }
        /**
         * 顯示繼續鍵
