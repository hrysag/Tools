      ...
      B = class B {
        ...
        flushDecodr() {
          return s(this, arguments, void 0, function* (t = !1) {
            if (null !== this.timeout && (clearTimeout(this.timeout), this.timeout = null), this.inputQueueFramesIndex = -1, this.playingVideo = null, this.isPlayer = !1, yield this.decoder.flush(), 0 !== this.frameInfoQueue.size() && this.frameInfoQueue.clear(), t) for (; 0 !== this.videoFrameQueue.size();) {
