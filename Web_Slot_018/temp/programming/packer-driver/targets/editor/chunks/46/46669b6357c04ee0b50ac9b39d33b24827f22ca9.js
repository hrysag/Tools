    ...
    execute: function () {
      ...
      _export("FG_BkgController", FG_BkgController = (_dec = ccclass('FG_BkgController'), _dec2 = property({
        ...
        async playWinAni() {
          if (this._gameState == (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            error: Error()
          }), GameState) : GameState).FREE_GAME && this._spPortrait) {
        ...
        getSpPortraitPlayState() {
          const playData = this._spPortrait.getCurrentSpineAniData();
...
//# sourceMappingURL=46669b6357c04ee0b50ac9b39d33b24827f22ca9.js.map