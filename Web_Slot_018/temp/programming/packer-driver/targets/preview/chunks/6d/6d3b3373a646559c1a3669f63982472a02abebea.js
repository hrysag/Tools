System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, HistoryItemInfo, NetAgent, PlayerInfo, _crd;

  function _reportPossibleCrUseOfHistoryItemInfo(extras) {
    _reporterNs.report("HistoryItemInfo", "../../GenericUI/Scripts/HistoryItemInfo", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      HistoryItemInfo = _unresolved_2.HistoryItemInfo;
      ...
      _export("PlayerInfo", PlayerInfo = class PlayerInfo {
        ...
        static getHistoryJson(gameID) {
          PlayerInfo._historyItemInfos = (_crd && NetAgent === void 0 ? (_reportPossibleCrUseOfNetAgent({
            ...
            var historyItemInfoItem = new (_crd && HistoryItemInfo === void 0 ? (_reportPossibleCrUseOfHistoryItemInfo({
              error: Error()
...
//# sourceMappingURL=6d3b3373a646559c1a3669f63982472a02abebea.js.map