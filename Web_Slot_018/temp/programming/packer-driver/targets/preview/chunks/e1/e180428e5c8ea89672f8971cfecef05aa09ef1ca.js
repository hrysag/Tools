System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfCommand(extras) {
    _reporterNs.report("Command", "./MoveParam", _context.meta, extras);
  }

  function _reportPossibleCrUseOfMoveParam(extras) {
    _reporterNs.report("MoveParam", "./MoveParam", _context.meta, extras);
  }

  function _reportPossibleCrUseOfState(extras) {
    _reporterNs.report("State", "./MoveParam", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "1e88cELdVhNQairTAso+J2c", "UniMovement", undefined);
      ...
      _export("UniMovement", UniMovement = (_dec = ccclass('UniMovement'), _dec2 = property(CCBoolean), _dec3 = property(CCFloat), _dec(_class = (_class2 = class UniMovement extends Component {
        ...
        moveTo(dest, duration, isLocal, ease, easedValueCustom) {
          if (isLocal === void 0) {
            isLocal = true;
          }
          ...
          var moveParam = (_crd && MoveParam === void 0 ? (_reportPossibleCrUseOfMoveParam({
            error: Error()
        ...
        moveFrom(from, dest, duration, isLocal, ease, easedValueCustom) {
          if (isLocal === void 0) {
            isLocal = true;
          }
        ...
        moveBy(offset, duration, ease, easedValueCustom) {
          if (ease === void 0) {
            ease = (_crd && EaseType === void 0 ? (_reportPossibleCrUseOfEaseType({
              error: Error()
            }), EaseType) : EaseType).Linear;
        ...
        _onMoveUpdate() {
          ...
          var progress = 0;
          var currentProgress = this._curParam.curTime / (this._curParam.duration + 0.000001);
...
//# sourceMappingURL=e180428e5c8ea89672f8971cfecef05aa09ef1ca.js.map