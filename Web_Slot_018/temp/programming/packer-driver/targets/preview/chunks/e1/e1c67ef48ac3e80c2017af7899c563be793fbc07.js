System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, CCString, Component, resources, Sprite, SpriteFrame, ButtonStatus, SlotRelayLang, Debug, GameSetting, _dec, _dec2, _dec3, _class, _class2, _descriptor, _crd, ccclass, requireComponent, property, LocalizationButton;
      ...
      _export("LocalizationButton", LocalizationButton = (_dec = ccclass('LocalizationButton'), _dec2 = requireComponent(Button), _dec3 = property(CCString), _dec(_class = _dec2(_class = (_class2 = class LocalizationButton extends Component {
        ...
        updateLocalization() {
          ...
          return _asyncToGenerator(function* () {
            ...
            yield _this.loadButtonImage(lang);
          })();
        }
        ...
        loadImageByStatus(langKey, status) {
          ...
          if (this.resourcePath) {
            var path = "Game/ImageLocalization/" + langString + "/" + this.resourcePath + "_" + status + "/spriteFrame";
...
//# sourceMappingURL=e1c67ef48ac3e80c2017af7899c563be793fbc07.js.map