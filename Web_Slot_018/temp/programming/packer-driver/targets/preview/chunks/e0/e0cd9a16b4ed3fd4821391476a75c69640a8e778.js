      ...
      _export("AnimationController", AnimationController = (_dec = ccclass('AnimationController'), _dec2 = property({
        ...
        onLoad() {
          ...
          var _loop = function _loop(clip) {
            ...
            var clipData = _this._animationPlayStateList.clipsInfo.find(data => data.targetName === clip.name);
            ...
            if (!clipData) {
              ...
              _this._animationPlayStateList.clipsInfo.push(clipData);
        ...
        restoreOriginAniData() {
          if (this._ani) {
            for (var clip of this._ani.clips) {
              ...
              var clipData = this.getOgirinAniData(clip.name);
        ...
        setAniDataInfo(value) {
          var playData = this.getCustomizeAniCtrlDef(value.targetName);
        ...
        pauseAni(value) {
          if (value) {
            var aniState = this._ani.getState(value);
        ...
        gotoAndPlayByFrame(value, frame) {
          ...
          var timeByFrame = this.getTimeByFrame(value, frame);
        ...
        playAniInPromise(value) {
          ...
          return new Promise((resolve, reject) => {
            ...
            var addEventListener = (eventType, callback) => {
        ...
        setAniStateForCustomizeClipData(value) {
          var clipData = this.checkPlayData(value);
        ...
        checkPlayData(targetName) {
          var foundData = this._animationPlayStateList.clipsInfo.find(data => data.targetName === targetName);
...
//# sourceMappingURL=e0cd9a16b4ed3fd4821391476a75c69640a8e778.js.map