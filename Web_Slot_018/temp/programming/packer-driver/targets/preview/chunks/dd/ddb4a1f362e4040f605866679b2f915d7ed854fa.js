    ...
    execute: function () {
      ...
      _export("RPSWildAnimationController", RPSWildAnimationController = (_dec = ccclass('RPSWildAnimationController'), _dec2 = property({
        ...
        init() {
          ...
          this.isPlaying = false;
          this._isCampDecided = false;
          var key = this.getAniNameByWildRoundState((_crd && RPSWildState === void 0 ? (_reportPossibleCrUseOfRPSWildState({
            error: Error()
        ...
        createCloneAniConnectData() {
          var wildStateKey = this._wildState == (_crd && RPSWildState === void 0 ? (_reportPossibleCrUseOfRPSWildState({
            error: Error()
          ...
          var wildConnectKey = this.getAniNameByWildRoundState(wildStateKey, (_crd && RPSWild_AniState === void 0 ? (_reportPossibleCrUseOfRPSWild_AniState({
            error: Error()
          }), RPSWild_AniState) : RPSWild_AniState).CONNECT);
          var baseAniData = this.getAniData(wildConnectKey);
          var cloneAniData = (_crd && GameUtils === void 0 ? (_reportPossibleCrUseOfGameUtils({
            error: Error()
        ...
        changeSkin(value) {
          if (this._spineBack) {
            var skinId = this._mapBackSkin.get(this._targetId).get(value); //let index=this.getSkinFrontEnumIndex(this._targetId);
            //@ts-ignore
        ...
        playAni(value) {
          ...
          if (value == (_crd && RPSWild_AniState === void 0 ? (_reportPossibleCrUseOfRPSWild_AniState({
            ...
            var targetState = this._wildState; //--要秀完才會changeFrame來去改變狀態..但流程修改後必須提前,所以先強塞
          ...
          var playData = this.checkSpinePlayData(key);
        ...
        playAniInPromiseForFirstRound(value) {
          var _this = this;

          return _asyncToGenerator(function* () {
            //--this.playSpineBackAniWithPromise(value),這個控制拳頭與背景 
            yield _this.playSpineBackAniWithPromise(value);
          })();
        }
        ...
        playAniInPromise(value) {
          ...
          return new Promise( /*#__PURE__*/_asyncToGenerator(function* (resolve, reject) {
            var promises = [_this2.playSpineBackAniWithPromise(value), _this2.playSpineFrontAniWithPromise(value)];
...
//# sourceMappingURL=ddb4a1f362e4040f605866679b2f915d7ed854fa.js.map