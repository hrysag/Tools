    ...
    execute: function () {
      ...
      _export("AnimationControllersPoolManager", AnimationControllersPoolManager = (_dec = ccclass('AnimationControllersPoolManager'), _dec2 = property({
        ...
        expandPool(prefabNodeListID, amount) {
          if (this._prefabMap[prefabNodeListID]) {
            for (var i = 0; i < amount; i++) {
              var node = instantiate(this._prefabMap[prefabNodeListID]);
        ...
        getInstantiatedNodeFromPoolById(id) {
          ...
          for (var list of this._prefabObjectPool.values()) {
        ...
        getPrefabNode(prefabNodeListID) {
          ...
          if (this._prefabObjectPool.has(prefabNodeListID)) {
            var prefabNodeInfoList = this._prefabObjectPool.get(prefabNodeListID);
        ...
        checkPoolStatusAfterPush() {
          ...
          for (var [_key, list] of this._prefabObjectPool.entries()) {
            console.log("Pool ID: " + _key + ", Size: " + list.length);
          }
...
//# sourceMappingURL=506b45377de8f36fe3d8014d86e894524fbf6e00.js.map