  ...
  return {
    ...
    execute: function () {
      ...
      _export("MainUI", MainUI = (_dec = ccclass('MainUI'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Label), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Sprite), _dec13 = property(Sprite), _dec14 = property(Node), _dec15 = property(Node), _dec16 = property(Node), _dec17 = property(Node), _dec18 = property(Node), _dec19 = property(Node), _dec(_class = (_class2 = class MainUI extends Component {
        ...
        setScreenStopBtnInteractable(b) {
          if (this.screenBtn) {
            this.screenBtn.getComponent(Button).interactable = b;
          }
        }

        setStopBtnInteractable(b) {
          for (var item of this.stopBtn.getComponents(Button)) {
            item.interactable = b;
          }

          if (b) {
            this.stopIcon.spriteFrame = (_crd && GenericUIRes === void 0 ? (_reportPossibleCrUseOfGenericUIRes({
              error: Error()
            }), GenericUIRes) : GenericUIRes).instance.stopIconNormal;
            this.stopArrow.spriteFrame = (_crd && GenericUIRes === void 0 ? (_reportPossibleCrUseOfGenericUIRes({
              error: Error()
            }), GenericUIRes) : GenericUIRes).instance.spinArrowNormal;
          } else {
            this.stopIcon.spriteFrame = (_crd && GenericUIRes === void 0 ? (_reportPossibleCrUseOfGenericUIRes({
              error: Error()
            }), GenericUIRes) : GenericUIRes).instance.stopIconDisabled;
            this.stopArrow.spriteFrame = (_crd && GenericUIRes === void 0 ? (_reportPossibleCrUseOfGenericUIRes({
              error: Error()
            }), GenericUIRes) : GenericUIRes).instance.spinArrowDisabled;
          }
        }
...
//# sourceMappingURL=2a65549b144dc8ca870aeb4fe6bacaa4274ebc27.js.map