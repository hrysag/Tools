      ...
      _export("LocalizationSpineTest", LocalizationSpineTest = (_dec = ccclass('LocalizationSpineTest'), _dec2 = requireComponent(_crd && SkeletonExtension === void 0 ? (_reportPossibleCrUseOfSkeletonExtension({
        ...
        loadAllSpine(langKey) {
          ...
          return _asyncToGenerator(function* () {
            ...
            var localizationSpine = _this.getComponent(_crd && SkeletonExtension === void 0 ? (_reportPossibleCrUseOfSkeletonExtension({
              error: Error()
            }), SkeletonExtension) : SkeletonExtension);

            if (localizationSpine === null) {
              console.error("Node \"" + _this.node.name + "\" LocalizationSpine No SpineAttach");
            }
            ...
            for (var i = 0; i < attachments.length; i++) {
              ...
              promiseList.push(_this.loadSpine2(langString, name, attachments[i]));
            }
...
//# sourceMappingURL=824bfcc6fb7f0963e6c24931867f57e076e774c3.js.map