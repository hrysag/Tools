  ...
  return {
    ...
    execute: function () {
      ...
      _export("RPSBattle", RPSBattle = (_dec = ccclass('RPSBattle'), _dec2 = property({
        ...
        closeAllRPSItem() {
          var allRPSItems = [...this._L_RPSItems, ...this._R_RPSItems];
        ...
        setResultForGuess(lrIndex, iconIndex, result) {
          ...
          var targetNode = this.getTargetRPSItem(targetBattleData, result);
        ...
        playRPSMotion() {
          ...
          return new Promise( /*#__PURE__*/_asyncToGenerator(function* (resolve, reject) {
            var promises = [_this.playRPSMotionPromise(), _this.playExplosionPromise()];

            try {
              yield Promise.all(promises);
              _this.node.active = false;

              _this.closeAllRPSItem();
        ...
        playRPSMotionPromise() {
          var _this2 = this;

          return _asyncToGenerator(function* () {
            return new Promise(resolve => {
              _this2._skMotion.setAnimation(0, 'battle', false);

              _this2._skMotion.setCompleteListener(() => {
                resolve();
              });
            });
          })();
        ...
        playExplosionPromise() {
          var _this3 = this;

          return _asyncToGenerator(function* () {
            return new Promise(resolve => {
              _this3._skExplosion.setAnimation(0, 'battle', false);

              _this3._skExplosion.setCompleteListener(() => {
                resolve();
              });
            });
          })();
        ...
        getTargetRPSItem(targetWildBattle, iconIndex) {
          ...
          for (var item of targetWildBattle.RPSGuessData) {
...
//# sourceMappingURL=a24e3d6f5adb06a304b15aadc7534a39146b611c.js.map