  ...
  return {
    ...
    execute: function () {
      ...
      _export("MessageBox", MessageBox = (_dec = ccclass('MessageBox'), _dec2 = property(_crd && MessageBoxUI === void 0 ? (_reportPossibleCrUseOfMessageBoxUI({
        ...
        static get instance() {
          var component = director.getScene().getComponentInChildren(MessageBox);
        ...
        showMsgBox(title, content, isShowConfirm, confirmCallback) {
          ...
          this.msgBoxUI.showUI(title, content, isShowConfirm, confirmCallback);
        }
        /*
...
//# sourceMappingURL=1a0cc379d00493284486e5301533e62b7faa7e4d.js.map