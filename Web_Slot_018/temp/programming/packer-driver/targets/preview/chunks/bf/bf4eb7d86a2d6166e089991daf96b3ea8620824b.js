      ...
      _export("WinScore", WinScore = (_dec = ccclass('WinScore'), _dec2 = property({
        ...
        constructor() {
          ...
          this.callBackForSpineEnd = () => {
            var spineComponentNode = this._aniSpine.spine;
        ...
        showFinalScoreInAndOut(finalScore) {
          var _this = this;

          return _asyncToGenerator(function* () {
            return new Promise( /*#__PURE__*/_asyncToGenerator(function* (resolve, reject) {
              _this.node.active = true;
              _this._finishResolvePromise = resolve;

              _this.setScoreLabel(finalScore);

              _this._aniSpine.playAniInPromise('score');

              yield _this.scoreLabelTweenFadeIn(); //await GameUtils.Defer(1000);
              ...
              _this._delayTweenCancel = delay.cancel;
              yield delay.promise; // 等待延遲完成

              _this._delayTweenCancel = null; // 清掉

              yield _this.scoreLabelTweenFadeOut();

              _this.safeResolveFinishPromise();
            }));
          })();
        }

        showFinalScoreIn(finalScore) {
          var _this2 = this;

          return _asyncToGenerator(function* () {
            return new Promise( /*#__PURE__*/_asyncToGenerator(function* (resolve, reject) {
              _this2._currentScore = finalScore;
              _this2.node.active = true;
              _this2._finishResolvePromise = resolve;

              _this2.setScoreLabel(finalScore);

              _this2._aniSpine.playAniInPromise('score');

              yield _this2.scoreLabelTweenFadeIn();

              _this2.safeResolveFinishPromise();
            }));
          })();
        }
        ...
        showFinalScoreOut() {
          ...
          return _asyncToGenerator(function* () {
            return new Promise( /*#__PURE__*/_asyncToGenerator(function* (resolve, reject) {
              ...
              _this3._finishResolvePromise = resolve;
              yield _this3.scoreLabelTweenFadeOut();

              _this3.safeResolveFinishPromise();
            }));
          })();
        }
        ...
        stopWinScoreAni() {
          ...
          return _asyncToGenerator(function* () {
            if (_this4.node.active) {
              if (_this4._delayTweenCancel) {
                _this4._delayTweenCancel(); //--強制終止 GameUtils.DeferByTweenPromiseWithCancel


                _this4._delayTweenCancel = undefined;
              }

              if (_this4._aniSpine.isPlaying) {
                _this4._aniSpine.stopPromiseAni(); //--直接去強制執行spine的promise resolve,並且清空


                _this4._aniSpine.resetSpinePoseData();
              }

              _this4.resetSocketNode();

              _this4._winScoreLabel.string = '';
              _this4._currentScore = 0;
              _this4.node.active = false;

              _this4.safeResolveFinishPromise();
            }
          })();
        }
        ...
        */
        ...
        playOpacityTweenAni() {
          ...
          return _asyncToGenerator(function* () {
            yield _this5.scoreLabelTweenFadeIn(); //await GameUtils.Defer(1000);

            yield (_crd && GameUtils === void 0 ? (_reportPossibleCrUseOfGameUtils({
              error: Error()
            }), GameUtils) : GameUtils).DeferByTweenPromise(1000 / 1000);
            yield _this5.scoreLabelTweenFadeOut();

            if (_this5._finishResolvePromise) {
              _this5._finishResolvePromise();

              _this5._finishResolvePromise = undefined;
            }
          })();
        }

        scoreLabelTweenFadeIn() {
          var _this6 = this;

          return _asyncToGenerator(function* () {
            _this6._isTweening = true;
            return new Promise((resolve, reject) => {
              tween(_this6._winScoreLabelNode.getComponent(UIOpacity)) //.by(0.8, { scale: v3(0.14, 0.14, 0) }, { easing: 'elasticOut' })
              .to(0.13, {
                opacity: 255
              }, {
                easing: 'linear'
              }).call(() => {
                _this6._isTweening = false;
                resolve();
              }).tag(1).start();
            });
          })();
        ...
        scoreLabelTweenFadeOut() {
          var _this7 = this;

          return _asyncToGenerator(function* () {
            _this7._isTweening = true;
            return new Promise((resolve, reject) => {
              tween(_this7._winScoreLabelNode.getComponent(UIOpacity)) //.by(0.8, { scale: v3(0.14, 0.14, 0) }, { easing: 'elasticOut' })
              .to(0.16, {
                opacity: 0
              }, {
                easing: 'linear'
              }).call(() => {
                _this7._isTweening = false;
                resolve();
              }).tag(1).start();
            });
          })();
...
//# sourceMappingURL=bf4eb7d86a2d6166e089991daf96b3ea8620824b.js.map