System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "cc/env", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, ResolutionPolicy, screen, view, Camera, director, Enum, RotationResize, Debug, Orientation, OrientationMode, RotationContentResize, OrientationTip, EDITOR, AutoOrientation, IWindowResize, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _class3, _crd, ccclass, property, DESIGN_WIDTH, DESIGN_HEIGHT, ResolutionPolicyValue, ScreenAdapter;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'ResolutionPolicy', 'screen', 'view', 'Camera', 'director', 'Enum', 'sys', 'game', 'error']);
      ...
      _export("ScreenAdapter", ScreenAdapter = (_dec = ccclass('ScreenAdapter'), _dec2 = property({
        ...
        start() {
          ...
          this.cameras = director.getScene().getComponentsInChildren(Camera);
...
//# sourceMappingURL=81d0985c97e0afdaf6137e464546f27d2b32640e.js.map