  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameIcon018", GameIcon018 = (_dec = ccclass('GameIcon018'), _dec2 = property({
        ...
        setAlpha(colorAlpha) {
          var colorAlphaValue = colorAlpha ? colorAlpha : this._ogColorAlphaValue;
        ...
        getCurrentCamp() {
          var currentCamp = this._iconData.camp;
        ...
        setTweenDark() {
          var darkBrightness = this._iconData.sp_darkBrightness;
          var colorNumber = {
            value: 255
          };
        ...
        setBrightness(isDark) {
          var darkBrightness = isDark ? this._iconData.darkBrightness : 255;
          this._gameSprite.color = color(darkBrightness, darkBrightness, darkBrightness, this._gameSprite.color.a);
          this.changeSpineColor(darkBrightness);
        }
        ...
        updateSymbol(symbolID) {
          ...
          var FINAL_SYMBOL_ID = INSTEAD_WILD;
          var isAlibaba = iconData.camp === 0;
          var isFinalRoll = this._rollState === (_crd && ReelRoundState === void 0 ? (_reportPossibleCrUseOfReelRoundState({
            error: Error()
          }), ReelRoundState) : ReelRoundState).FinalRoll;
          var isWildSymbol = WILD_LIST.includes(symbolID);
          var spriteFramesTarget;
          var blurSpriteFramesTarget;
        ...
        changeSpineColor(colorValue) {
          if (this._aniSymbol) {
            if (WILD_LIST.includes(this._aniSymbol[(_crd && DYN_NODE_PROPERTIES === void 0 ? (_reportPossibleCrUseOfDYN_NODE_PROPERTIES({
              ...
              var spineTargetTop = (_crd && FindComponent === void 0 ? (_reportPossibleCrUseOfFindComponent({
                error: Error()
              ...
              var spineTargetBottom = (_crd && FindComponent === void 0 ? (_reportPossibleCrUseOfFindComponent({
                error: Error()
              }), FindComponent) : FindComponent).findComponentInChildren(this._aniSymbol, _crd && RPSWildAnimationController === void 0 ? (_reportPossibleCrUseOfRPSWildAnimationController({
                error: Error()
              ...
              var spineTarget = (_crd && FindComponent === void 0 ? (_reportPossibleCrUseOfFindComponent({
                error: Error()
...
//# sourceMappingURL=98ed95487096329bb745805c223cb882f16f682f.js.map