System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, randomRangeInt, SlotMachineControllerBase, ReelRoundState, SlotMachineData, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, SlotMachineController;
  ...
  function _reportPossibleCrUseOfSlotMachineControllerBase(extras) {
    _reporterNs.report("SlotMachineControllerBase", "../../Scripts/SlotMachineControllerBase", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      SlotMachineData = _unresolved_4.SlotMachineData;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "1b7aeuocsNC7o5t/fhMi5gY", "SlotMachineController", undefined);
      ...
      _export("SlotMachineController", SlotMachineController = (_dec = ccclass('SlotMachineController'), _dec2 = property({
        type: _crd && SlotMachineData === void 0 ? (_reportPossibleCrUseOfSlotMachineData({
          error: Error()
        }), SlotMachineData) : SlotMachineData,
        visible: true
      }), _dec(_class = (_class2 = class SlotMachineController extends (_crd && SlotMachineControllerBase === void 0 ? (_reportPossibleCrUseOfSlotMachineControllerBase({
        error: Error()
        ...
        */
        ...
        sendNextRoundData(reelID) {
          var resultData = [...this._iconResultData[this._iconResultDataIndex]];
...
//# sourceMappingURL=f42f7cecbf8ceaa0cd73f65cf25d329abd0b04f8.js.map