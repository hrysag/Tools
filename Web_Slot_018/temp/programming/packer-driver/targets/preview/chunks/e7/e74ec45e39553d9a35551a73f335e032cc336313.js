      ...
      _export("FG_BonusCountTimes", FG_BonusCountTimes = (_dec = ccclass('FG_BonusCountTimes'), _dec2 = property({
        ...
        loadLanguageSprite() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (_this._currentLanguageKey != currentLanguageKey) {
              _this._currentLanguageKey = (_crd && Localization === void 0 ? (_reportPossibleCrUseOfLocalization({
                error: Error()
              }), Localization) : Localization).instance.currentLangKey;
              var localizationSprite = (_crd && FindComponent === void 0 ? (_reportPossibleCrUseOfFindComponent({
                error: Error()
              }), FindComponent) : FindComponent).findComponentInChildren(_this._bonusTimes_Title, _crd && LocalizationSprite === void 0 ? (_reportPossibleCrUseOfLocalizationSprite({
                error: Error()
              }), LocalizationSprite) : LocalizationSprite);

              if (localizationSprite) {
                yield localizationSprite.loadImage(currentLanguageKey);
                var titlePos;
                var countTimesPos;

                if (_this._currentLanguageKey == (_crd && SlotRelayLang === void 0 ? (_reportPossibleCrUseOfSlotRelayLang({
                  error: Error()
                }), SlotRelayLang) : SlotRelayLang).cn || _this._currentLanguageKey == (_crd && SlotRelayLang === void 0 ? (_reportPossibleCrUseOfSlotRelayLang({
                  error: Error()
                }), SlotRelayLang) : SlotRelayLang).tw) {
                  titlePos = _this._bonusTimes_Title_cnTw;
                  countTimesPos = _this._bonusTimes_cnTw;
                } else {
                  titlePos = _this._bonusTimes_Title_cnEn;
                  countTimesPos = _this._bonusTimes_cnEn;
                }

                _this._bonusTimes_Title.setPosition(v3(titlePos.x, titlePos.y, 0));

                _this._bonusTimesNode.setPosition(v3(countTimesPos.x, countTimesPos.y, 0));
              }
            }
          })();
        }
...
//# sourceMappingURL=e74ec45e39553d9a35551a73f335e032cc336313.js.map