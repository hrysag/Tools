System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, CCFloat, CCInteger, randomRangeInt, GenericUIManager, SlotMachineController, PublicReelConfigTest, GameController, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, NORMAL_SYMBOLS_LIST, MAGNIFICATION_SYMBOLS_LIST, ICON_AMOUNT, PublicReelGameControllerTest;
  ...
  function _reportPossibleCrUseOfGameMode(extras) {
    _reporterNs.report("GameMode", "../../../../../Utils/Config", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      PublicReelConfigTest = _unresolved_4.PublicReelConfigTest;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "d26bazLQ85GnrMr42dPwvEO", "PublicReelGameControllerTest", undefined);
      ...
      _export("PublicReelGameControllerTest", PublicReelGameControllerTest = (_dec = ccclass('PublicReelGameControllerTest'), _dec2 = property({
        type: _crd && SlotMachineController === void 0 ? (_reportPossibleCrUseOfSlotMachineController({
          error: Error()
        ...
        visible: true,
        tooltip: '用來測試聽牌效果'
      }), _dec(_class = (_class2 = class PublicReelGameControllerTest extends (_crd && GameController === void 0 ? (_reportPossibleCrUseOfGameController({
        error: Error()
        ...
        startSpin(reelIDs) {
          ...
          var resultData = this.handleData(testData);
...
//# sourceMappingURL=c293da16d49355bc4b672da7ed08ac32c644f62d.js.map