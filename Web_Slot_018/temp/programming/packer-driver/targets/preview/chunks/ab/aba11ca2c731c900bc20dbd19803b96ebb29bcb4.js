      ...
      _export("NetAgent", NetAgent = class NetAgent {
          ...
          return _asyncToGenerator(function* () {
            try {
              ...
              if (!_this4.parserWebConfig(connectSetting)) {
                throw Error("parser WebConfigUrl " + _this4._playerInfo.webConfigUrl + " Fail");
              }
        ...
        askPlayerHistory(historyHeight) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (!_this5._playerInfo.webConfig.CommonSetting.ESAPIHistoryURL) {
            ...
            var askBody = []; //只取 HistoryHeightMax 筆資料

            for (var i = historyHeight, count = 0; i > 0 && count < (_crd && HistoryHeightMax === void 0 ? (_reportPossibleCrUseOfHistoryHeightMax({
              error: Error()
            }), HistoryHeightMax) : HistoryHeightMax); i--, count++) {
              askBody.push((_crd && AskHistoryBodyFormat === void 0 ? (_reportPossibleCrUseOfAskHistoryBodyFormat({
                error: Error()
            ...
            try {
              ...
              var result = yield _this5.Post(_this5._playerInfo.webConfig.CommonSetting.ESAPIHistoryURL, body);

              _this5.parserHistoryHeight(JSON.parse(result));
            } catch (error) {
        ...
        Spin(bet, additionalPurchaseType) {
          ...
          return _asyncToGenerator(function* () {
            ...
            return new Promise((resolve, reject) => {
              if (_this6._cConnectManager == null) {
              ...
              _this6._cConnectManager.MainSend(bt.Buffer);

              _this6.askCommand((_crd && CCommand === void 0 ? (_reportPossibleCrUseOfCCommand({
                error: Error()
        ...
        insertHistory(spinAck) {
          ...
          if (this._history.length >= (_crd && HistoryHeightMax === void 0 ? (_reportPossibleCrUseOfHistoryHeightMax({
            ...
            this._history.length = (_crd && HistoryHeightMax === void 0 ? (_reportPossibleCrUseOfHistoryHeightMax({
              error: Error()
            }), HistoryHeightMax) : HistoryHeightMax) - 1;
          }
        } //轉換 historyData
...
//# sourceMappingURL=aba11ca2c731c900bc20dbd19803b96ebb29bcb4.js.map