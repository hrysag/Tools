    ...
    execute: function () {
      ...
      _export("AniSysTools", AniSysTools = class AniSysTools {
        ...
        static getTargetNodeComponent(targetNode) {
          var componentConstructors = [_crd && AnimationController === void 0 ? (_reportPossibleCrUseOfAnimationController({
            error: Error()
          ...
          for (var _constructor of componentConstructors) {
            if ((_crd && FindComponent === void 0 ? (_reportPossibleCrUseOfFindComponent({
              error: Error()
            }), FindComponent) : FindComponent).findComponentInChildren(targetNode, _constructor)) {
              return _constructor;
            }
            /*
        ...
        static findAndGetIAniComponent(targetNode) {
          ...
          for (var _constructor2 of componentConstructors) {
            var component = (_crd && FindComponent === void 0 ? (_reportPossibleCrUseOfFindComponent({
              error: Error()
            }), FindComponent) : FindComponent).findComponentInChildren(targetNode, _constructor2);
...
//# sourceMappingURL=59cca9530e44bec67be5b964534ddb6a0d5750a0.js.map