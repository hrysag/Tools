System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      B = class B {
        constructor(t) {
          this.queueMaxIndex = 8, this.videoFrameQueueMaxSize = 3, this.videoFrameQueue = new A(), this.frameInfoQueue = new A(), this.videoChunks = [], this.playingVideo = null, this.isPlayer = !1, this.timeout = null, this.inputQueueFramesIndex = -1, this.playListQueue = [], this.playListDequeue = null, this.playListFinish = null, this.decoder = new VideoDecoder({
        ...
        flushDecodr() {
          return s(this, arguments, void 0, function (t) {
            ...
            return function* () {
              if (null !== _this.timeout && (clearTimeout(_this.timeout), _this.timeout = null), _this.inputQueueFramesIndex = -1, _this.playingVideo = null, _this.isPlayer = !1, yield _this.decoder.flush(), 0 !== _this.frameInfoQueue.size() && _this.frameInfoQueue.clear(), t) for (; 0 !== _this.videoFrameQueue.size();) {
      ...
      _export("default", C = class C {
        ...
        closeDecoder() {
          return s(this, void 0, void 0, function* () {
            this.resetPlaybackState(), null !== r(this, u, "f") && (yield r(this, u, "f").flushDecodr(!0), r(this, u, "f").closeDecoder(), n(this, u, null, "f"));
          });
        }
...
//# sourceMappingURL=70bb21745b78a1d6745fcdf9dff09148208331c8.js.map