import { _decorator, CCInteger, Component, Graphics, Color, Mask, Layers, Node, Size, Sprite, SpriteFrame, tween, UITransform, v3, CCFloat } from 'cc';
...
export class SingleSlot extends Component {
    ...
    @property({ type: [SymbolIconData], visible: true, displayName: "Symbol SpriteFrames LeftSide", tooltip: "Symbol SpriteFrames 左側" })
    private _symbolSpriteFrames_L: SymbolIconData[] = [];

    @property({ type: [SymbolIconData], visible: true, displayName: "Blur SpriteFrames LeftSide", tooltip: "Blur SpriteFrames 左側" })
    private _blurSpriteFrames_L: SymbolIconData[] = [];

    @property({ type: [SymbolIconData], visible: true, displayName: "Symbol SpriteFrames RightSide", tooltip: "Symbol SpriteFrames 右側" })
    private _symbolSpriteFrames_R: SymbolIconData[] = [];

    @property({ type: [SymbolIconData], visible: true, displayName: "Blur SpriteFrames RightSide", tooltip: "Blur SpriteFrames 右側" })
    private _blurSpriteFrames_R: SymbolIconData[] = [];

    private _targetSymbolSpriteFrames: SymbolIconData[] = [];

    private _targetBlurSpriteFrames: SymbolIconData[] = [];
    ...
    private getBlurSpriteFrames(iconId: number): SpriteFrame {
