import { _decorator, CCString, Component, EventTarget, macro, Node, sp, ISchedulable } from 'cc';
import { AniCtrlPropDef, SpineSequenceList, SpineSequenceItem } from './AnimationPlayStateBase';
...
export class SpineSequencePlay extends EventTarget implements ISchedulable {
    ...
    //--相同ID的不會重複加入
    public setSequenceData(sequenceId: string, loopSequence: boolean, sequenceData: AniCtrlPropDef[]): void {
    ...
    public playSequence(sequenceName?: string) {
        ...
        let currentItem: AniCtrlPropDef;
    ...
    public playSpineAnimation(item: AniCtrlPropDef) {
