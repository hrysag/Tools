...
import {Node,math,v3, UITransform ,Size, BoxCollider, BoxCollider2D,Collider2D, Vec3, Collider} from 'cc';
import {log,BuiltinShape2D} from 'cc';

export class Fish1DynamicBulletPrefabAction extends AbstractBaseBullet
{
    ...
    constructor()
    {
        ...
        this.strSystemId=BulletActionType.BULLET_ACTION_DYNAMIC;    
    }
