 ...
 */
//=======================================================
export const ServerSendCode= 
{
    InitLocalDebug :'', //--local debug init
    EnterRoomLocalDebug :'',//local debug init
    InitPlayerInfoLocalDebug :'',//local debug init
    UpdateRoomStsteLocalDebug :'',//local debug UpdateRoomStste
    UpdatePropLocalDebug :'',//local debug UpdateProp
    NewFishLocalDebug:'',//local debug newFish
    ChoiceLobby :'',   //--選房
    GetBalance : '',   //--取餘額
    Exchange : '',     //--開分
    CashOut : '',      //--洗分
...
export const ServerResCode =
{
    ...
    WeaponSettings : '',               // 武器設定
    FishSettings : '',                 // 魚隻設定
    InitPlayerInfo : '',               // 更新房內玩家資訊
    SerialNumber : '',                 // 更新局號
    Balance : '',                      // 更新資產/餘額
    RefundBullet : '',                 // 回收子彈退分通知(call balance後,會再送這個出來)
    Exchange : '',                     // 換分結果通知
    Point : '',                        // 更新分數
    LeaveRoom : '',                    // 離開房間
    CashOut : '',                      // 洗分結果通知
    ...
    HitFish : '',                      // 擊中魚隻
    UpdateProp : '',                   //更新道具
    UpdateRoomStatus : '',             //更新房間狀態??
    UseProp : '' ,                      //使用道具
    BossWillComeIn : '' ,              //boss即將來襲
