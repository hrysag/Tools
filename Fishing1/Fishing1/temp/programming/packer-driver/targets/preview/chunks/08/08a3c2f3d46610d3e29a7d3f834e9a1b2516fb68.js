    ...
    execute: function () {
      ...
      _export("Fish1GameMain", Fish1GameMain = (_dec = ccclass('Fish1GameMain'), _dec2 = (_crd && gameMainAbstractView === void 0 ? (_reportPossibleCrUseOfgameMainAbstractView({
        ...
        constructor() {
          ...
          this._gameType = 38003; //profiler.hideStats();//--關閉相關測試面板
        }
        ...
        onLoad() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this._useGuiSystem = true;
            _this.gameCoordinatesMode = (_crd && GameCoordinateMode === void 0 ? (_reportPossibleCrUseOfGameCoordinateMode({
              error: Error()
            }), GameCoordinateMode) : GameCoordinateMode).GameViewMode_Four_in_one; //========================================
            //--到時候要換掉FishGameMainLogic,先暫時這樣2023-10-01

            var logicNode = new Node('gameMainLogicNode'); //--抽象類別不能直接實體化,一定要透過繼承,然後實體化繼承過來那個類別
            //this._gameLogic=logicNode.addComponent(FishGameMainLogic);

            _this._gameLogic = logicNode.addComponent(_crd && Fish1GameMainLogic === void 0 ? (_reportPossibleCrUseOfFish1GameMainLogic({
              error: Error()
        ...
        initGuiSystem() {
          var node = new Node('Fish1GuisSystemView');
        ...
        initUserViews() {
          var node = find('Canvas/fishNodeContainer/fishNode');
        ...
        setCollisionSystem() {
          var gameCollisionSystemNode = new Node('gameCollisionSystemNode'); //--抽象類別不能直接實體化,一定要透過繼承,然後實體化繼承過來那個類別
          //this._gameLogic=logicNode.addComponent(FishGameMainLogic);
        ...
        beforeinit() {
          var _superprop_getBeforeinit = () => super.beforeinit,
              _this2 = this;

          return _asyncToGenerator(function* () {
            _this2._coordinate = new (_crd && Fish1CoordinatesFormMode === void 0 ? (_reportPossibleCrUseOfFish1CoordinatesFormMode({
              error: Error()
            }), Fish1CoordinatesFormMode) : Fish1CoordinatesFormMode)();
            yield _superprop_getBeforeinit().call(_this2);
          })();
        }
...
//# sourceMappingURL=08a3c2f3d46610d3e29a7d3f834e9a1b2516fb68.js.map