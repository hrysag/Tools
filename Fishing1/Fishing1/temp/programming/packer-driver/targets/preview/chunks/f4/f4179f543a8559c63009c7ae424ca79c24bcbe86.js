        ...
        */
        ...
        setLayout() {
          ...
          return _asyncToGenerator(function* () {
            return new Promise(resolve => {
              _this._inGameMessageNode = instantiate((_crd && LoadingResManager === void 0 ? (_reportPossibleCrUseOfLoadingResManager({
                error: Error()
              }), LoadingResManager) : LoadingResManager).getInstance().getPrefab(_this._strprefab));

              _this.addChild(_this._inGameMessageNode);

              var labelNode = new Node('inGameMessageLabelNode');
              ...
              _this._label.fontSize = 40;
              _this._label.lineHeight = 50;
              _this._label.useSystemFont = true;
              _this._label.fontFamily = 'Arial';
              _this._label.isBold = true;

              _this._lableShowContainerNode.addChild(labelNode); //--這邊要在處理旋轉的顯示!!!


              _this._label.string = 'LLLLLLLLLLLLLLLLLLLLLLLLL';
              ...
              _this._label.node.active = false;
              _this.active = false; //---完成的時候做
        ...
        removeMessages(messages) {
          ...
          for (var i = 0; i < messages.length; i++) {
            for (var j = 0; j < this._aryTips.length; j++) {
        ...
        closeGameMessage(clean) {
          ...
          var tweenComponent = this.getComponent(_crd && TweenMaxCocosPlugin === void 0 ? (_reportPossibleCrUseOfTweenMaxCocosPlugin({
            error: Error()
          }), TweenMaxCocosPlugin) : TweenMaxCocosPlugin);
        ...
        setVisibleForPriority(value) {
          ...
          if (TweenMax.isTweening(tweenComponent)) {
            var flag = this._visibleForPriority ? false : true;
        ...
        showTipsforGameMessage() {
          var tipsObj = this._aryTips.shift();
...
//# sourceMappingURL=f4179f543a8559c63009c7ae424ca79c24bcbe86.js.map