  ...
  return {
    ...
    execute: function () {
      ...
      _export("MouseBehaviorBase", MouseBehaviorBase = class MouseBehaviorBase extends Component {
        ...
        setBoundary(w, h) {
          var uitransfrom = this.node.getComponent(UITransform);
          uitransfrom.contentSize = new Size(w, h);
          uitransfrom.anchorX = 0.5;
          uitransfrom.anchorY = 0.5;
          var distanceW = ((_crd && CocosGameSetting === void 0 ? (_reportPossibleCrUseOfCocosGameSetting({
            error: Error()
          }), CocosGameSetting) : CocosGameSetting).Game_Width - w) / 2;
          var distanceH = ((_crd && CocosGameSetting === void 0 ? (_reportPossibleCrUseOfCocosGameSetting({
            error: Error()
        ...
        afterRotationPos(value) {
          var uitransfrom = this.node.getComponent(UITransform); //let containSize=uitransfrom.contentSize;
...
//# sourceMappingURL=938578d344e92df83a095776bf0f8da4ea981c7d.js.map