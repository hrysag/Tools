      ...
      _export("FishGameMainLogic", FishGameMainLogic = (_dec = _crd && viewBind === void 0 ? (_reportPossibleCrUseOfviewBind({
        ...
        constructor() {
          ...
          this.autoUsePropUpdate = dt => {
            var roomStatus = this._viewModel['_roomStatus'].status;
            ...
            var target = this._aryAutoUseProps[this._autoUsePropCount];
            var originalCount = this._autoUsePropCount;
          ...
          this.autoShootHandler = value => {
            ...
            var rp = this.checkLockIsinSide(); //log('check_autoShootHandler_rp',rp);
            ...
            if (rp) {
              ...
              if (this._autoShootStatus && this._aryAutoLock.length > 0) {
                var checkfish = this.checkTargetAndAutoShoot();
        ...
        updateLockBullets() {
          if (this._fishGameAutoAndLockData) {
            var data = this._fishGameAutoAndLockData.updateLockBullets();
          ...
          return _asyncToGenerator(function* () {
            ...
            switch (dataKey) {
              case (_crd && GameViewMediatorUserDataKey === void 0 ? (_reportPossibleCrUseOfGameViewMediatorUserDataKey({
                ...
                //--serverback 新增子彈
                var fd = _this._gameMediator.getViewUserData((_crd && GameViewMediatorUser === void 0 ? (_reportPossibleCrUseOfGameViewMediatorUser({
                  error: Error()
                }), GameViewMediatorUser) : GameViewMediatorUser).FishView, (_crd && GameViewMediatorUserDataKey === void 0 ? (_reportPossibleCrUseOfGameViewMediatorUserDataKey({
                  error: Error()
                ...
                if (fd) {
                  var isPlayer = value.siteIndex == _this._playerTable ? true : false; //returnData = await this._fishGameAutoAndLockData.setLockFishBullet(

                  returnData = _this._fishGameAutoAndLockData.setLockFishBullet(fd, value.sn, value.siteIndex, isPlayer);
                } else {
                  returnData = null;
                }
              ...
              case (_crd && GameViewMediatorUserDataKey === void 0 ? (_reportPossibleCrUseOfGameViewMediatorUserDataKey({
                ...
                _this._fishGameAutoAndLockData.afterHitRemoveLockBulletData(value);
              ...
              case (_crd && GameViewMediatorUserDataKey === void 0 ? (_reportPossibleCrUseOfGameViewMediatorUserDataKey({
                ...
                _this._mouseBehavior.unBlockALL();
            ...
            case '_onCreditExchange':
              ...
              if (value[0]) {
                ...
                if (this._viewModel['_exchangePlayerCredit']) {
                  ...
                  var playercredit = this._viewModel['_exchangePlayerCredit'];
        ...
        removeAllLockDatabyRoomStatuChange() {
          if (this._fishGameAutoAndLockData) {
            //this._fishGameAutoAndLockData.removeAllLockData();
            var removeLockFishData = this._fishGameAutoAndLockData.removeAllLockDataAndGetLockFishs();
        ...
        beforeShootCheck(sendObj) {
          var s = sendObj;
          var fishTargetId; //let evt:GamePlayerModeEvent;
        ...
        shootBeforCheck(s) {
          ...
          if (shootflag) {
            ...
            var strLockTarget = -1; //let useProp:number=0;
            ...
            var sendData = this.getShootData(s);
        ...
        addFishAimTarget(value) {
          var previousFish = this._fishGameAutoAndLockData.addFishAimTarget(value); //--20231212
          //--這邊的fishID要寫進去
        ...
        cleanAutoLockCooldown() {
          ...
          */
          ...
          var previousFish = this._fishGameAutoAndLockData.aryLockFishBullets[this._playerTable].lockFish;
        ...
        addLockFishAimTarget(mouseX, mouseY) {
          ...
          if (this._shootFlag) {
            var checkPickUpData = this.checkLockFishAimTarget(mouseX, mouseY);
        ...
        checkLockIsinSide() {
          var rp = null; //let aryFishLockData: { lockFish: number, lockBullets: number[] }[] = this._fishGameAutoAndLockData.aryLockFishBullets;
          //let fishId: number = aryFishLockData[this._playerTable].lockFish;

          var fishId = this._fishGameAutoAndLockData.getLockFishData(this._playerTable); //log('checkLockIsinSide',aryFishLockData,fishId);
          //let fish2dNode:Node=


          if (fishId != 0) {
            var _f = this._gameMediator.getViewUserData((_crd && GameViewMediatorUser === void 0 ? (_reportPossibleCrUseOfGameViewMediatorUser({
              error: Error()
            }), GameViewMediatorUser) : GameViewMediatorUser).FishView, (_crd && GameViewMediatorUserDataKey === void 0 ? (_reportPossibleCrUseOfGameViewMediatorUserDataKey({
              error: Error()
            ...
            if (_f) {
              if (!_f.prohibit && !_f.isDead) {
                rp = this.checkFishDataInBaundary(_f);
              }
            }
            /*
            if(f)
        ...
        checkTargetAndAutoShoot() {
          ...
          if (this._autoShootStatus && this._aryAutoLock.length > 0) {
            var fishs = this._gameMediator.getViewUserData((_crd && GameViewMediatorUser === void 0 ? (_reportPossibleCrUseOfGameViewMediatorUser({
              error: Error()
            }), GameViewMediatorUser) : GameViewMediatorUser).FishView, (_crd && GameViewMediatorUserDataKey === void 0 ? (_reportPossibleCrUseOfGameViewMediatorUserDataKey({
              error: Error()
            }), GameViewMediatorUserDataKey) : GameViewMediatorUserDataKey).Fish_getFishs);

            var len = this._aryAutoLock.length;
...
//# sourceMappingURL=f14462933df40acc3260d44196dddc95ace47fa9.js.map