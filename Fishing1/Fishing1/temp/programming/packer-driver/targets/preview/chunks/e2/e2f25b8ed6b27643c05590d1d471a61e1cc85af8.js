    ...
    execute: function () {
      ...
      _export("GuisCenterFWBase", GuisCenterFWBase = class GuisCenterFWBase extends (_crd && AbstractView === void 0 ? (_reportPossibleCrUseOfAbstractView({
        ...
        createGuiNotifycationSubject() {
          for (var _key in _crd && GUIEvent === void 0 ? (_reportPossibleCrUseOfGUIEvent({
            error: Error()
          }), GUIEvent) : GUIEvent) {
            if (typeof (_crd && GUIEvent === void 0 ? (_reportPossibleCrUseOfGUIEvent({
              error: Error()
            }), GUIEvent) : GUIEvent)[_key] === 'string') {
        ...
        startLayout() {
          ...
          return _asyncToGenerator(function* () {
             ...
             * 裡面的then才有意義
             */
            for (var i of _this._aryLayoutData) {
              if (!(GuisCenterFWBase.aryMapGuiClass[i.id] instanceof (_crd && GuiBasic === void 0 ? (_reportPossibleCrUseOfGuiBasic({
                ...
                if (i.immediateSendEvt) {
                  ...
                  _this.sendEvt((_crd && GUIEvent === void 0 ? (_reportPossibleCrUseOfGUIEvent({
                    error: Error()
...
//# sourceMappingURL=e2f25b8ed6b27643c05590d1d471a61e1cc85af8.js.map