    ...
    execute: function () {
      ...
      _export("TweenMaxCocosPlugin", TweenMaxCocosPlugin = class TweenMaxCocosPlugin extends Component {
        ...
        set fillCenterX(value) {
          if (this.node.getComponent(Sprite)) {
            var fc = this.node.getComponent(Sprite).fillCenter;
            fc = v2(value, fc.y);
          }
        }
        ...
        get linePosEndX() {
          ...
          if (this.node.getComponent(Line)) {
            var linePos = this.node.getComponent(Line).positions;
            var len = linePos.length;
        ...
        set linePosEndX(value) {
          if (this.node.getComponent(Line)) {
            var linePos = this.node.getComponent(Line).positions;
            var len = linePos.length; //-- linecomponent.positions=posData as never;
        ...
        set lineOffestX(value) {
          if (this.node.getComponent(Line)) {
            ...
            var offset = this.node.getComponent(Line).offset;
...
//# sourceMappingURL=ee58a70a9a9f423b7fd30996a37495a26c3c9fc5.js.map