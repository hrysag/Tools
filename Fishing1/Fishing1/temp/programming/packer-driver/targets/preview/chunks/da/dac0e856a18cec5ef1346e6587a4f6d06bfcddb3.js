    ...
    execute: function () {
      ...
      _export("default", LocalizedUI = (_dec = ccclass('LocalizedUI'), _dec2 = menu('i18n/LocalizedUI'), _dec3 = property(SpriteAtlas), _dec4 = property({
        ...
        fetchRender() {
          ...
          var spriteFrame = sprite ? sprite.spriteFrame : button ? button.normalSprite : undefined;
          var bundleName = this.spritePath.split('/')[0];
        ...
        checkSpriteWithoutAtlas(bundle) {
          ...
          if (sprite) {
            var bundleName = this.spritePath.split('/')[0];
            var path = this.useCurrentLangKey(this.spritePath.replace(bundleName, ''));
        ...
        checkSpriteWithAtlas(bundle) {
          var sprite = this.getComponent(Sprite);
          var button = this.getComponent(Button);
          var newSpritePath = this.useCurrentLangKey(this.spritePath);
        ...
        updateSpriteOnly(bundle, sprite, newSpritePath) {
          var path = newSpritePath.substr(newSpritePath.indexOf('/'));
        ...
        useCurrentLangKey(path) {
          var langKey = this.getLangKey(path);
...
//# sourceMappingURL=dac0e856a18cec5ef1346e6587a4f6d06bfcddb3.js.map