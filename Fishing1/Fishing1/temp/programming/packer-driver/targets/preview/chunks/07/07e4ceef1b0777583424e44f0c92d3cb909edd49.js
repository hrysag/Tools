  ...
  return {
    ...
    execute: function () {
      ...
      _export("FishVM", FishVM = (_dec = _crd && Bindable === void 0 ? (_reportPossibleCrUseOfBindable({
        ...
        notify(key, value) {
          var _superprop_getNotify = () => super.notify,
              _this = this;
          ...
          return _asyncToGenerator(function* () {
            ...
            _superprop_getNotify().call(_this, key, value);

            if (key == '_setPlayerRoomforLocalDebug') {
              yield _this.localDebugInitRoom(key);
              yield _this.setBalance();

              _this.localDebugCreateFish();
            }

            if (key == '_testData') {
              _this.localDebugTestData();
            }
          })();
        }
        /*
        ...
        localDebugInitRoom(key) {//--call server(把資料寫回去繼續下一步驟)

          return _asyncToGenerator(function* () {})();
        }

        setBalance() {//--模擬進房後第一次server送進來的balance
...
//# sourceMappingURL=07e4ceef1b0777583424e44f0c92d3cb909edd49.js.map