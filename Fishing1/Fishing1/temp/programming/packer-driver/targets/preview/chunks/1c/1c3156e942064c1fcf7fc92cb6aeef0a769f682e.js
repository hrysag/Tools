    ...
    execute: function () {
      ...
      _export("SummonExploation", SummonExploation = class SummonExploation extends Component {
        ...
        onLoad() {
          ...
          var clip = this._topAnimation.clips;
      ...
      _export("CallAniEffect", CallAniEffect = class CallAniEffect {
        ...
        constructor() {
          ...
          this.finishEffectHandler = e => {
            ...
            for (var i = 0; i < this._aryRunningExprostationFx.length; i++) {
        ...
        setDataAfterSetRoom(playerPositions) {
          var len = this._summonDiscs.length;
          var dsicFX;
          ...
          for (var i = 0; i < len; i++) {
            ...
            var localV3 = this._container.getComponent(UITransform).convertToNodeSpaceAR(worldVec3); //dsicFX.setPosition(v3(0,0));
        ...
        closeEffect() {
          ...
          for (var j = 0; j < this._aryRunningExprostationFx.length; j++) {
            var nodeTarget = this._aryRunningExprostationFx[j];
            nodeTarget.off((_crd && BaseEvent === void 0 ? (_reportPossibleCrUseOfBaseEvent({
              error: Error()
            }), BaseEvent) : BaseEvent).COMPLETE, this.finishEffectHandler);
          ...
          for (var i = 0; i < this._summonDiscs.length; i++) {
...
//# sourceMappingURL=1c3156e942064c1fcf7fc92cb6aeef0a769f682e.js.map