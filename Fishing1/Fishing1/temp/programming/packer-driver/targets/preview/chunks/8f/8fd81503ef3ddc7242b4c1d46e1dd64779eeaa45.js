      ...
      _export("LoadingResProgress", LoadingResProgress = class LoadingResProgress extends (_crd && LoadingProgress === void 0 ? (_reportPossibleCrUseOfLoadingProgress({
        ...
        constructor() {
          ...
          this.onUpdateAssetsProgress = progress => {
            var ratio = progress / this._loadingQuene.length * 100 * 0.9; //log('check_assetsIsUpdate',ratio,this._count,this._loadingQuene.length);
...
//# sourceMappingURL=8fd81503ef3ddc7242b4c1d46e1dd64779eeaa45.js.map