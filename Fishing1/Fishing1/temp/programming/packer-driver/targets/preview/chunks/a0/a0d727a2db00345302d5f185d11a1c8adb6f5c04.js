      ...
      _export("CollisionSystemBase", CollisionSystemBase = class CollisionSystemBase extends (_crd && AbstractView === void 0 ? (_reportPossibleCrUseOfAbstractView({
        ...
        addCollisions(collisionDefinition) {
          ...
          if (!this._mapCollision[id]) {
            ...
            var classKey = strategyConstructorId;
        ...
        getCollision(id) {
          var index = this.getIdByClassName(id);
        ...
        getIdByClassName(id) {
          ...
          for (var i in this._mapUseCollision) {
            for (var j of this._mapUseCollision[i]) {
              if (j == id) {
                r = i;
                break;
              }
      ...
      _export("CollisionBase", CollisionBase = class CollisionBase {
        ...
        constructor() {
          ...
          */
          ...
          this._strategyAlgorithm = arguments.length <= 0 ? undefined : arguments[0];
        } //--塞入核心演算
...
//# sourceMappingURL=a0d727a2db00345302d5f185d11a1c8adb6f5c04.js.map