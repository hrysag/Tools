    ...
    execute: function () {
      ...
      _export("FishModelBase", FishModelBase = (_dec = _crd && Mutable === void 0 ? (_reportPossibleCrUseOfMutable({
        ...
        initSetRoom() {
          ...
          for (var i = 0; i < this._roomTableMax; i++) {
            table = {
              tableID: i,
              //--桌位編號 index 0-3
              userID: 0,
        ...
        setRoomCredit(index, credit) {
          //----20190221--正式要打開
          var len = this._aryRoomInfo.length;
        ...
        cleanRoom() {
          for (var i = 0; i < this._aryRoomInfo.length; i++) {
        ...
        getTableIdByUserId(id) {
          var uid = id == undefined ? this._uid : id; //log('getTableIdByUserId',id,uid,this._aryRoomInfo);
...
//# sourceMappingURL=3f1c6276c566e99bd651c291e0585436b9f2a4ea.js.map