    ...
    execute: function () {
      ...
      _export("default", LocalizedSpirtFrames = (_dec = ccclass('LocalizedSpirtFrames'), _dec2 = menu('i18n/LocalizedSpirtFrames'), _dec3 = property({
        ...
        fetchRender() {
          ...
          var dir = this.spritePath.slice(0, this.spritePath.length - 2);
          var newSpritePath = dir + LocalizedSpirtFrames.language;
            ...
            bundle.load(path, SpriteAtlas, (err, atlas) => {
              if (err) {
                ...
                for (var i = 0; i < this.spriteFrames.length; i++) {
                  var spriteFrames = this.spriteFrames[i];
        ...
        getSpriteFrameName(atlas) {
          var keys = Object.keys(atlas.spriteFrames);

          for (var sp of this.spriteFrames) {
            for (var key of keys) {
...
//# sourceMappingURL=71db75d5e53359984f870f9e9364e74c0e1efc94.js.map