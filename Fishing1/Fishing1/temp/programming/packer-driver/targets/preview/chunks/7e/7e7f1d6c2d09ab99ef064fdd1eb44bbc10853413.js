    ...
    execute: function () {
      ...
      _export("Fish1BulletPrefabAction", Fish1BulletPrefabAction = class Fish1BulletPrefabAction extends (_crd && AbstractBaseBullet === void 0 ? (_reportPossibleCrUseOfAbstractBaseBullet({
        ...
        updateBullet(t, b) {
          ...
          var right = 1920; // var right:number=CoreRenderMode.RenderCore.app.renderer.width;
          //let left:number=0;
          ...
          */
          ...
          if (!changeflag) {
            var theta = Math.atan2(b.position.y - b.ePosition.y, b.position.x - b.ePosition.x);
