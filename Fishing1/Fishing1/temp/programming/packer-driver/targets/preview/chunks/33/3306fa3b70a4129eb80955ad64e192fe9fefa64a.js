    ...
    execute: function () {
      ...
      _export("GiftBombAniEffect", GiftBombAniEffect = class GiftBombAniEffect extends EventTarget {
        constructor() {
          ...
          this.onCompleteBomb = () => {
            ...
            if (this._maximumBomb <= 0) {
              ...
              for (var i = 0; i < this._aryBombs.length; i++) {
        ...
        showBomb(data) {
          ...
          for (var i = 0; i < len; i++) {
            var BombNode = instantiate((_crd && LoadingResManager === void 0 ? (_reportPossibleCrUseOfLoadingResManager({
              error: Error()
...
//# sourceMappingURL=3306fa3b70a4129eb80955ad64e192fe9fefa64a.js.map