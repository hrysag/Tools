      ...
      _export("AbstractModel", AbstractModel = class AbstractModel {
        ...
        prepareBeforeConnect(gameType) {
          ...
          return _asyncToGenerator(function* () {
            return yield _this._netConnect.prepareBeforeConnect(gameType);
          })();
        } //--override it(該方法不對VM開放,直接由mediator操作)
        ...
        connect() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this2._netConnect.connect(); //log('NOOOOConnectGOGO');  
        ...
        addObserver(o) {
          var index = this._listeners.findIndex(item => this.compar(o));
...
//# sourceMappingURL=5c838016e0839759c2e3e9be30f26441fb9bf61f.js.map