    ...
    execute: function () {
      ...
      _export("Fish1GuisSystemView", Fish1GuisSystemView = (_dec = _crd && viewBind === void 0 ? (_reportPossibleCrUseOfviewBind({
            ...
            switch (sub) {
              ...
              case '_roomTableInfo':
                ...
                if (!value[0].firstIntoRoom) {
                  ...
                  var gunType = this._cannonGuiCenter.changeBulletStyle(this._viewModel['_playerTableId'], this._viewModel['_defualtGunValue']);
                ...
                if (value[0]) {
                  ...
                  if (!this._firstOpen) {
                    ...
                    if (this._viewModel['_autoCreditExchange'] && this._viewModel['_balance'] > 0 && !this._openExchangePanel) {
                       ...
                       * 但是在autoshoot當中則不會檢查
                       */
                      var checkCanExchange = true; //---沒錢就直接換了20240312
                      ...
                      if (checkCanExchange) {
                        ...
                        var checkAmount = this.checkPlayerAutoExchange();
                        ...
                        if (checkAmount > 0) {
                          ...
                          if (this._viewModel['_onCreditExchange']) {
                            ...
                            var ratio = this._viewModel['_base']; //log('check_autoExchangeRatio',ratio);

                            var messageData = (_crd && i18n === void 0 ? (_reportPossibleCrUseOfi18n({
                              error: Error()
              ...
              case '_errorCode':
                ...
                var messageContain = value[0].code + ':' + (_crd && i18n === void 0 ? (_reportPossibleCrUseOfi18n({
                  error: Error()
        ...
        guiEvtProcessHandler(sub, value) {
          ...
          switch (sub) {
            ...
            case (_crd && GUIEvent === void 0 ? (_reportPossibleCrUseOfGUIEvent({
              ...
              */
              var path_help_domain = (_crd && CocosGameSetting === void 0 ? (_reportPossibleCrUseOfCocosGameSetting({
                error: Error()
            ...
            case (_crd && GUIEvent === void 0 ? (_reportPossibleCrUseOfGUIEvent({
              ...
              var path_history_domain = (_crd && CocosGameSetting === void 0 ? (_reportPossibleCrUseOfCocosGameSetting({
                error: Error()
              }), CocosGameSetting) : CocosGameSetting).isLocal ? (_crd && CocosGameSetting === void 0 ? (_reportPossibleCrUseOfCocosGameSetting({
                error: Error()
              }), CocosGameSetting) : CocosGameSetting).localPathData.domain : (_crd && CocosGameSetting === void 0 ? (_reportPossibleCrUseOfCocosGameSetting({
              ...
              var url = 'https://' + path_history_domain + (_crd && CocosGameSetting === void 0 ? (_reportPossibleCrUseOfCocosGameSetting({
                error: Error()
        ...
        setDataAfterreadySetPlayerIndex() {
          ...
          var roomStatusData = this._viewModel['_roomStatus'];
        ...
        getData(dataKey, value) {
          ...
          switch (dataKey) {
            ...
            case (_crd && GameViewMediatorUserDataKey === void 0 ? (_reportPossibleCrUseOfGameViewMediatorUserDataKey({
              ...
              var messageContain = (_crd && i18n === void 0 ? (_reportPossibleCrUseOfi18n({
                error: Error()
              }), i18n) : i18n).t(value[0].error);
        ...
        init(value) {
          ...
          if (this._propGui) {
            var propData = this._viewModel['_props']; //-{[key:number]:{time:number,count:number}};

            var times = [propData[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
              error: Error()
        ...
        creditExchangeEnterGame(value) {
          ...
          var lastclickValue = value.sendObj.lastClick > 0 ? value.sendObj.lastClick : this._viewModel['_autoCreditMoney'];
        ...
        checkPlayerAutoExchange() {
          var changeCredit;
          var autoCreditMoney = this._viewModel['_autoCreditMoney'];
          var balance = this._viewModel['_balance'];
          var exchangeRatio = this._viewModel['_exchangeRatio'];
        ...
        checkPlayerCreditCanAutoExchange() {
          var playerCredit = this._viewModel['_aryRoomInfo'][this._playerIndex - 1].credit;
          var bulletScore = this._viewModel['_aryScorePool'];
          var f = true; //---這邊自動幫玩家換子彈--?

          for (var i = 0; i < bulletScore.length; i++) {
            for (var j = 0; j < bulletScore[i].length; j++) {
        ...
        */
        ...
        getMenuPositions() {
          var propData = this._propGui.getPropMenuPositions();
        ...
        autoUsePropCheck(value) {
          var props = this._viewModel['_props'];
          var propRunningdata = this._viewModel['_propRunData'];
        ...
        usePropCallServer(propType) {
          var props = this._viewModel['_props'];
          var propRunningdata = this._viewModel['_propRunData'];
          var playerCredit = this._viewModel['_credit'];
        ...
        showOpenAnimation() {
          ...
          var menuToolbtn = this._menuToolGui.getCompontItem('_menuToolBtn');

          var menuOgPosition = this._menuToolGui.ogPosition;
        ...
        showAlert(errorType, dictString, autoDisappearTime) {
          if (autoDisappearTime === void 0) {
            autoDisappearTime = 0;
          }
...
//# sourceMappingURL=490afb7e7ca05c42e34963517c13ab2ba42b8e1f.js.map