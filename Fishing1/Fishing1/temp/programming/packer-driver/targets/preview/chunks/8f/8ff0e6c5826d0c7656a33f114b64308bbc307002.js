        ...
        */
        ...
        processModelData(sub, value) {
          ...
          switch (sub) {
            ...
            case '_addFishs':
              ...
              var bossId = this.checkSpBossId(value[0]);
        ...
        getShootData(s) {
          ...
          */
          ...
          var props = this._viewModel['_propRunData'][(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
            error: Error()
        ...
        checkSpFishInSide(f) {
          ...
          var localPos = this._mouseContainerNode.getComponent(UITransform).convertToNodeSpaceAR(worldPos);
        ...
        checkLockFishAimTarget(x, y) {
          ...
          var wposClick = clickNode.getComponent(UITransform).convertToWorldSpaceAR(v3(x, y));
...
//# sourceMappingURL=8ff0e6c5826d0c7656a33f114b64308bbc307002.js.map