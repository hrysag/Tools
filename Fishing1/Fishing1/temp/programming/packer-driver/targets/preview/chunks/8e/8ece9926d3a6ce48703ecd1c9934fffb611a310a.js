System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, FishModelBase, fishMeshState, FishRotationState, BulletActionType, GUIEvent, ServerResCode, ServerSendCode, PropType, Mutable, director, macro, Scheduler, log, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _class, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _crd, Fish1Model;
  ...
  function _reportPossibleCrUseOfFishModelBase(extras) {
    _reporterNs.report("FishModelBase", "../../framework/logic/model/FishModel", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfaddbullet(extras) {
    _reporterNs.report("addbullet", "./Fish1ModelDefinitions", _context.meta, extras);
  }

  function _reportPossibleCrUseOfaddFish(extras) {
    _reporterNs.report("addFish", "./Fish1ModelDefinitions", _context.meta, extras);
  }

  function _reportPossibleCrUseOfPropType(extras) {
    _reporterNs.report("PropType", "./Fish1ModelDefinitions", _context.meta, extras);
  }

  function _reportPossibleCrUseOfMutable(extras) {
    _reporterNs.report("Mutable", "../../framework/abstract/mvvm/AbstractModel", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      FishModelBase = _unresolved_2.FishModelBase;
    }, function (_unresolved_3) {
      fishMeshState = _unresolved_3.fishMeshState;
    }, function (_unresolved_4) {
      FishRotationState = _unresolved_4.FishRotationState;
    }, function (_unresolved_5) {
      BulletActionType = _unresolved_5.BulletActionType;
    }, function (_unresolved_6) {
      GUIEvent = _unresolved_6.GUIEvent;
    }, function (_unresolved_7) {
      ServerResCode = _unresolved_7.ServerResCode;
      ServerSendCode = _unresolved_7.ServerSendCode;
    }, function (_unresolved_8) {
      PropType = _unresolved_8.PropType;
    }, function (_unresolved_9) {
      Mutable = _unresolved_9.Mutable;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "5b76awPWxFD4YTkrbQ5DKWn", "Fish1Model", undefined);
      /**
       * Created by EricHuang on 2023/9/22.
       */


      __checkObsolete__(['director', 'macro', 'Scheduler', 'log']);

      _export("Fish1Model", Fish1Model = (_dec = _crd && Mutable === void 0 ? (_reportPossibleCrUseOfMutable({
        error: Error()
        ...
        error: Error()
      }), Mutable) : Mutable, (_class = class Fish1Model extends (_crd && FishModelBase === void 0 ? (_reportPossibleCrUseOfFishModelBase({
        error: Error()
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "_mapCannonInfo", _descriptor2, this);

          _initializerDefineProperty(this, "_refundBullets", _descriptor3, this);

          //--退款退的子彈(ServerResCode.RefundBullet)
          //=====fish=========
          _initializerDefineProperty(this, "_addFishs", _descriptor4, this);

          _initializerDefineProperty(this, "_addPopFishs", _descriptor5, this);

          _initializerDefineProperty(this, "_hitFishs", _descriptor6, this);

          //=====Lobby==========
          _initializerDefineProperty(this, "_lobbyData", _descriptor7, this);

          _initializerDefineProperty(this, "_setPlayerRoomforLocalDebug", _descriptor8, this);

          _initializerDefineProperty(this, "_roomTableInfo", _descriptor9, this);

          //=====roomstatus========
          _initializerDefineProperty(this, "_roomStatus", _descriptor10, this);

          //===props==============
          _initializerDefineProperty(this, "_props", _descriptor11, this);

          //--server送進來的初始資料
          //--道具讀秒計時用的
          _initializerDefineProperty(this, "_propRunData", _descriptor12, this);

          _initializerDefineProperty(this, "_useProp", _descriptor13, this);

          //--使用道具通知
          _initializerDefineProperty(this, "_useSummonProp", _descriptor14, this);

          //--召喚道具使用通知
          _initializerDefineProperty(this, "_useCrazyProp", _descriptor15, this);

          //--狂暴道具使用通知
          //===boss=================
          _initializerDefineProperty(this, "_bossStatus", _descriptor16, this);
          ...
          //========test data===================
          _initializerDefineProperty(this, "_testData", _descriptor17, this);

          //--用來通知測試程式驅動相關功能
          this._firstIntoRoom = void 0;
          this._scheduler = void 0;
          //--其他玩家道具讀秒計時用的(狂暴才會用到)
          this._otherPlayerUseProp = void 0;
          ...
          this.serverResBack = value => {
            ...
            switch (value.type) {
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                log('Fish1model_ErrorCode', value); //--開黑色的面板

                this._errorCode = {
                  type: value.sendObject.type,
                  code: value.sendObject.code,
                  error: value.sendObject.error
                };
                break;
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                this._lobbyData = {
                  loginName: value.sendObject.playerId,
                  playerRoomBase: value.sendObject.playerRoomBase
                }; //--weapon setting
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                this._setPlayerRoomforLocalDebug = (_crd && GUIEvent === void 0 ? (_reportPossibleCrUseOfGUIEvent({
                  error: Error()
                }), GUIEvent) : GUIEvent).SET_PLAYER_ROOM; //--寫入道具的數量
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                this._hallID = value.sendObject.hallID; //--true=直接給他的錢包一次換完, false=正常換分(目前都只會送false)
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                if (value.sendObject.error) {
                  ...
                  this._betBase = value.sendObject.r; //---玩家使用的匯率

                  var aryRatio = this._base.split(':');
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                log('ServerResCode.UpdateRoomStatus_model', value.sendObject, Date.now()); //---魚潮或是boss(JP魚)啟動時,限制道具要鎖住,cd計時與道具效果要關閉

                if (value.sendObject.status == 0) {
                  //this._freeze=false;
                  this._bossStatus = '';
                } else if (value.sendObject.status == 1) {//--冰凍狀態
                  //this._freeze=true;
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                var cannondata = {}; //-_mapCannonInfo
                //-{[key:number]:{score:number,speed:number,powerup:number}};

                for (var _i in value.sendObject) {
                  cannondata[_i] = {
                    score: value.sendObject[_i].s,
                    speed: value.sendObject[_i].sp,
                    powerup: value.sendObject[_i].pur
                  };
                }
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                log('Fish1model_resback_InitPlayerInfo', value.sendObject); //--有玩家進房間就會送
                //--他是只會送該房間有幾個人就送幾個

                this.setRoom(value.sendObject); //--準備寫異動座位的資料

                this._roomTableInfo = {
                  tables: this._aryRoomInfo,
                  firstIntoRoom: this._firstIntoRoom
                ...
                if (!this._firstIntoRoom) {
                  ...
                  if (!this._debug) {
                    this.sendServer((_crd && ServerSendCode === void 0 ? (_reportPossibleCrUseOfServerSendCode({
                      error: Error()
                    }), ServerSendCode) : ServerSendCode).GetBalance, null);
                  }
                }
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                this.setRoomCredit(value.sendObject.siteIndex, value.sendObject.credit); //--異動分數

                this._exchangePlayerCredit = {
                  credits: this._aryRoomInfo
                };
                break;
                ...
                if (value.sendObject.error) {
                  ...
                  if (this._noExchange) {
                    ...
                    this._errorCode = {
                      type: 'exchangeError',
                      code: 1786601,
                      error: 'MSG.BALANCE_IS_NOT_ENOUGH'
                    };
                  } else {
                    ...
                    this._inGameMessage = {
                      type: 'exchangeError',
                      code: 1786601,
                      msg: 'MSG.BALANCE_IS_NOT_ENOUGH'
                    };
                  }
                } else {
                  this._credit = value.sendObject.credit; //this._balance = value.sendObject.balance; 
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                log('Fish1Modle_serverResBack_Point', value); //--玩家開洗分後會回來
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                //---test-20230926
                log('Fish1Modle_serverResBack_ShootBullet', value); //-siteIndex=0-3

                this.setRoomCredit(value.sendObject.siteIndex, value.sendObject.credit); //this._addbullets=value.sendObject.data.p;
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                log('Fish1Modle_serverResBack_hitFish', value); //---要把玩家的分數寫回去
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                log('Fish1Modle_serverResBack_UpdateProp', value); //--20240126--玩家沒有持有任何道具就是一個空物件
                //-{time:5,count:0} 

                var call_count = value.sendObject[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                  error: Error()
                }), PropType) : PropType).PROP_CALL] ? value.sendObject[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                  error: Error()
                }), PropType) : PropType).PROP_CALL] : 0;
                var freeze_count = value.sendObject[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                  error: Error()
                }), PropType) : PropType).PROP_FREEZE] ? value.sendObject[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                  error: Error()
                }), PropType) : PropType).PROP_FREEZE] : 0;
                var crazy_count = value.sendObject[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                  error: Error()
                }), PropType) : PropType).PROP_CRAZY] ? value.sendObject[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                  error: Error()
                }), PropType) : PropType).PROP_CRAZY] : 0;
                var propData = {
                  [(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                    error: Error()
                  }), PropType) : PropType).PROP_CALL]: {
                    time: this._props[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                      error: Error()
                    }), PropType) : PropType).PROP_CALL].time,
                    count: call_count
                  },
                  [(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                    error: Error()
                    ...
                    time: this._props[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                      error: Error()
                    }), PropType) : PropType).PROP_FREEZE].time,
                    count: freeze_count
                  },
                  [(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                    error: Error()
                    ...
                    time: this._props[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                      error: Error()
                    }), PropType) : PropType).PROP_CRAZY].time,
                    count: crazy_count
                  }
                };
                this._props = propData;
                log('check_fish1Model_Prop', propData, this._props); //--for test
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                log('Fish1Modle_serverResBack_UseProp', value, this._playerTableId); //--1.更新數量(server會送到UpdateProp) 2.設定dcd時間.3.啟動canuseProp(這個不確定?) 4.啟動timer  
                ...
                if (value.sendObject.error != null) {
                  ...
                  this._inGameMessage = {
                    type: '',
                    code: -1,
                    msg: 'MSG.CANT_NOT_USE_PROPS'
                  };
                } else {
                  if (value.sendObject.propType == (_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                    error: Error()
                  }), PropType) : PropType).PROP_CALL) {
                    //--使用召喚道具
                    this._useSummonProp = {
                      index: value.sendObject.tableIndex
                    };
                    this._addFishs = [value.sendObject.callFish]; //--這個砲台效果在叫出魚的瞬間就結束了
                  }
                  ...
                  if (value.sendObject.tableIndex == this._playerTableId) {
                    if (this._props[value.sendObject.propType].time != value.sendObject.coldDownTime) {
                      var propDataAfterUse = {
                        [(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                          ...
                          count: this._props[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                            error: Error()
                          }), PropType) : PropType).PROP_CALL].count
                        },
                        [(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                          error: Error()
                        }), PropType) : PropType).PROP_FREEZE]: {
                          ...
                          count: this._props[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                            error: Error()
                          }), PropType) : PropType).PROP_FREEZE].count
                        },
                        [(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                          error: Error()
                        }), PropType) : PropType).PROP_CRAZY]: {
                          ...
                          count: this._props[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                            error: Error()
                          }), PropType) : PropType).PROP_CRAZY].count
                        }
                      }; //--這邊的秒數都已經除以1000變成秒了
                    ...
                    this._useProp = {
                      propType: value.sendObject.propType,
                      index: value.sendObject.tableIndex
                    }; //--這邊要做後續處理

                    this.usePropByTime(value.sendObject.propType);
                  } else if (value.sendObject.propType == (_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                    error: Error()
                  }), PropType) : PropType).PROP_CRAZY) {
                    //--其他玩家啟動狂暴,啟動專屬計時器
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                log('Fish1Modle_serverResBack_BossWillComeIn', value); //this._wagersID=value.sendObject;
                //this._inGameMessage={type:'',code:-1,msg:'MSG.FE_BOSS_WAVE_ALERT'}; 

                this._inGameMessage = {
                  type: '',
                  code: 1786601,
                  msg: 'MSG.FE_BOSS_WAVE_ALERT'
                };
                break;
            }
          };
          ...
          this.updateScheduler = dt => {
            var playerSelf = this.playerUsePropTimer(dt);
            var otherPlayer = this.otherPlayerUseCrazyPropTimer(dt);
          ...
          this._testData = -1; //this._propsInfo={};
          //this._gameBase='';
        ...
        initModelData() {
          ...
          var fishtypeMap = {}; //-黃色小吻仔魚

          fishtypeMap[0] = {
            meshId: 'fish_01',
            level: false,
            fishMeshState: (_crd && fishMeshState === void 0 ? (_reportPossibleCrUseOffishMeshState({
              error: Error()
            }), fishMeshState) : fishMeshState).fish2D,
            rotationState: (_crd && FishRotationState === void 0 ? (_reportPossibleCrUseOfFishRotationState({
              error: Error()
          ...
          this._fishTypeKeyMap = fishtypeMap; //--id=fishtype

          this._aryOddsInfo = [//-黃色小吻仔魚
          {
            id: 0,
            odds: "2",
            name: 'fish_01',
          ...
          this._aryScorePool = [[2], [5], [10], [20], [50]]; //-{score:number,type:number,pu:number}[][]
          ...
          this._aryActionInfo[0] = [//---rd7 客端不主動用子彈生存時間做回收處理(所以lifetime=-1),由server 來做 
          {
            systemId: (_crd && BulletActionType === void 0 ? (_reportPossibleCrUseOfBulletActionType({
              error: Error()
            }), BulletActionType) : BulletActionType).BULLET_ACTION_PREFAB,
            amount: 1,
            sound: 'sounds/fire1',
            system2Dor3D: 1,
            effect2DAssetsID: "prefab/bullet/bullet1",
            strFishNetId: "fishNet_1",
            effectFishNetAtlasID: 'prefab/textures/fishHunterGui',
            collisionW: 0.5,
            collisionH: 0.5,
            fishNetW: 0,
            fishNetH: 0,
          ...
          }, //-正式要改回來秒數
          {
            ...
            sound: 'sounds/fire2',
            system2Dor3D: 1,
            effect2DAssetsID: "prefab/bullet/bullet2",
            strFishNetId: "fishNet_2",
            effectFishNetAtlasID: 'prefab/textures/fishHunterGui',
            collisionW: 0.5,
            collisionH: 0.5,
            fishNetW: 0,
          ...
          }, //-正式要改回來秒數
          {
            ...
            sound: 'sounds/fire3',
            system2Dor3D: 1,
            effect2DAssetsID: "prefab/bullet/bullet3",
            strFishNetId: "fishNet_3",
            effectFishNetAtlasID: 'prefab/textures/fishHunterGui',
            collisionW: 0.5,
            collisionH: 0.5,
            fishNetW: 0,
          ...
          }, //-正式要改回來秒數
          {
            ...
            sound: 'sounds/fire4',
            system2Dor3D: 1,
            effect2DAssetsID: "prefab/bullet/bullet4",
            strFishNetId: "fishNet_4",
            effectFishNetAtlasID: 'prefab/textures/fishHunterGui',
            collisionW: 0.5,
            collisionH: 0.5,
            fishNetW: 0,
          ...
          }, //-正式要改回來秒數
          {
            ...
            sound: 'sounds/fire5',
            system2Dor3D: 1,
            effect2DAssetsID: "prefab/bullet/bullet5",
            strFishNetId: "fishNet_5",
            effectFishNetAtlasID: 'prefab/textures/fishHunterGui',
            collisionW: 0.5,
            collisionH: 0.5,
            fishNetW: 0,
          ...
          this._balance = -10074160; //---玩家使用的匯率
        ...
        firstInGamePropforOtherPlayer(roomData) {
          //--把整個server的資料丟進來
        ...
        setScheduler() {
          this._scheduler = director.getScheduler(); //--20231116沒有uuid or id的cocos會幫你建立一個

          Scheduler.enableForTarget(this);

          this._scheduler.schedule(this.updateScheduler, this, 1, macro.REPEAT_FOREVER, 0, true); //this._scheduler.resumeTarget(this);

        } //--call server前檢查數量是否足夠或是還在運作當中


        checkPropStatus(propType) {
          return this._props[propType].count > 0 && !this._propRunData[propType].isRunning ? true : false;
        } //--開始啟動計時器(數量的改變已經會在server res的方法裡面更新)


        usePropByTime(propType) {
          if (!this._scheduler) {
            this._scheduler = director.getScheduler(); //--20231116沒有uuid or id的cocos會幫你建立一個

            Scheduler.enableForTarget(this); //--以秒為單位(60FPS)
        ...
        otherUseCrazyPropByTime(table, druingTime) {
          if (!this._scheduler) {
            this._scheduler = director.getScheduler(); //--20231116沒有uuid or id的cocos會幫你建立一個
        ...
        stopPropColdDown(propType) {
          ...
          this._propRunData[propType].timeCount = 0;
          this._propRunData[propType].isFinish = true; //--其他玩家的顯示也要停(crazy prop)嗎?
        }
        /**
         * 待補功能:20231122
        ...
        resetPropColdDown(time) {
          log('resetPropColdDown', time);
          var f = false;

          for (var i in this._propRunData) {
        ...
        otherPlayerUseCrazyPropTimer(dt) {
          var r = false; //--啟動相關的計時器

          if (this._otherPlayerUseProp.length > 0) {
            for (var i = 0; i < this._otherPlayerUseProp.length; i++) {
              if (this._otherPlayerUseProp[i].isRunning) {
                ...
                if (this._otherPlayerUseProp[i].timeCount >= this._otherPlayerUseProp[i].time) {
                  //---刪除+通知
                  this._useCrazyProp = {
                    index: this._otherPlayerUseProp[i].table,
                    open: false
                  };
        ...
        playerUsePropTimer(dt) {
          ...
          for (var i in this._propRunData) {
            total++;
            propRunning[i] = {
              time: this._propRunData[i].time,
              timeCount: this._propRunData[i].timeCount,
              isRunning: this._propRunData[i].isRunning
            };
            ...
            if (this._propRunData[i].isRunning) {
              ...
              if (propRunning[i].timeCount >= propRunning[i].time) {
                ...
                if (Number(i) == (_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                  error: Error()
                }), PropType) : PropType).PROP_CRAZY) {
                  this._useCrazyProp = {
                    index: this._playerTableId,
                    open: false
                  };
                }
              }
          ...
          if (stopCount == total) {
            ...
            log('prop finish'); //this._scheduler.pauseTarget(this);
            //--道具使用全部結束
        ...
        writable: true,
        initializer: null
      }), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "_mapCannonInfo", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "_refundBullets", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "_addFishs", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, "_addPopFishs", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor6 = _applyDecoratedDescriptor(_class.prototype, "_hitFishs", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor7 = _applyDecoratedDescriptor(_class.prototype, "_lobbyData", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor8 = _applyDecoratedDescriptor(_class.prototype, "_setPlayerRoomforLocalDebug", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor9 = _applyDecoratedDescriptor(_class.prototype, "_roomTableInfo", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
        ...
        writable: true,
        initializer: null
      }), _descriptor11 = _applyDecoratedDescriptor(_class.prototype, "_props", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor12 = _applyDecoratedDescriptor(_class.prototype, "_propRunData", [_dec12], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor13 = _applyDecoratedDescriptor(_class.prototype, "_useProp", [_dec13], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor14 = _applyDecoratedDescriptor(_class.prototype, "_useSummonProp", [_dec14], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor15 = _applyDecoratedDescriptor(_class.prototype, "_useCrazyProp", [_dec15], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor16 = _applyDecoratedDescriptor(_class.prototype, "_bossStatus", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor17 = _applyDecoratedDescriptor(_class.prototype, "_testData", [_dec17], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=8ece9926d3a6ce48703ecd1c9934fffb611a310a.js.map