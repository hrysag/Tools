    ...
    execute: function () {
      ...
      _export("FishGameConnectBase", FishGameConnectBase = class FishGameConnectBase extends (_crd && GameConnectBase === void 0 ? (_reportPossibleCrUseOfGameConnectBase({
        ...
        async prepareBeforeConnect(gameType) {
          return new Promise(async resolve => {
            ...
            */
            ...
            let data = utilTool.general.parseEntryData(url);
        ...
        async connect(ip) {
          ...
          if (!ip) {
            ...
            if ((_crd && CocosGameSetting === void 0 ? (_reportPossibleCrUseOfCocosGameSetting({
              ...
              */
              ...
              let gsSubDomain = (_crd && CocosGameSetting === void 0 ? (_reportPossibleCrUseOfCocosGameSetting({
                error: Error()
          ...
          if (resultforConnect) {
            ...
            */
            ...
            let resultforLogin = await this._connector.login(loginInfo);
            this.getConnectDataFromPomelo((_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
              error: Error()
        ...
        kickMsg(msg) {
          ...
          let sendEvent; //-sendEvent={type:code,sendObject:returnObj};
...
//# sourceMappingURL=397eb25d6ecfa79314afbf1c85e94bf61c5521a2.js.map