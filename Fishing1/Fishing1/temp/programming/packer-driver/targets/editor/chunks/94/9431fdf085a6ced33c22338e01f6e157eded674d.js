System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, AbstractView, viewBind, viewfun, log, _dec, _dec2, _class, _class2, _descriptor, _crd, TestGameView;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "2f59dV0ImhBG7RoGmL22oaP", "TestGameView", undefined);

      __checkObsolete__(['log']);

      _export("TestGameView", TestGameView = (_dec = (_crd && viewfun === void 0 ? (_reportPossibleCrUseOfviewfun({
        error: Error()
      }), viewfun) : viewfun)('TestView'), _dec2 = _crd && viewBind === void 0 ? (_reportPossibleCrUseOfviewBind({
        error: Error()
      }), viewBind) : viewBind, _dec(_class = (_class2 = class TestGameView extends (_crd && AbstractView === void 0 ? (_reportPossibleCrUseOfAbstractView({
        error: Error()
        ...
        constructor() {
          ...
          this._testgameview1Data = void 0;
          ...
          this._testgameview1Data = {
            value: 897
          };
        }

        onLoad() {
          super.onLoad(); //this.setModelData();
        }
        ...
        getVMData() {
           ...
           */
          log('getVMData_TestGameView', this._viewModel['_testTestModeValue2']); //--拿view的資料
...
//# sourceMappingURL=9431fdf085a6ced33c22338e01f6e157eded674d.js.map