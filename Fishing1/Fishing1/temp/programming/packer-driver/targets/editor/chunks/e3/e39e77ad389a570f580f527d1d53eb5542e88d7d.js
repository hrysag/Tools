    ...
    execute: function () {
      ...
      _export("DgOpenAniEffect", DgOpenAniEffect = class DgOpenAniEffect {
        constructor(...args) {
          ...
          this.aniOnComplete = (type, state) => {
            ...
            if (state.name == 'in') {
              ...
              let aniClipTop = this.getAnimationClip(this._animationTop, 'idle');
        ...
        bossOpenInInitGame() {
          ...
          let aniClipTop = this.getAnimationClip(this._animationTop, 'in');
          this._animationTop.defaultClip = aniClipTop;

          this._animationTop.play(aniClipTop.name); //--bg


          let aniClipBg = this.getAnimationClip(this._animationBgEffect, 'fishFx24Opening');
        ...
        bossOut() {
          if (this._nowStatus == 'out') {
            ...
            this._nowStatus = 'out';
            let aniClipTop = this.getAnimationClip(this._animationTop, 'out');
            this._animationTop.defaultClip = aniClipTop;
...
//# sourceMappingURL=e39e77ad389a570f580f527d1d53eb5542e88d7d.js.map