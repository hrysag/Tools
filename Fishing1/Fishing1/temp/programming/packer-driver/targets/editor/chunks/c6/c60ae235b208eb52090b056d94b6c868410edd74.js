    ...
    execute: function () {
      ...
      _export("MoneyEffect", MoneyEffect = class MoneyEffect {
        ...
        setDataAfterSetRoom(coinEndinfo) {
          ...
          let len = this._positionInfo.length;
          let lp;
        ...
        showMoneyAnimation(isPlayer, x, y, index) {
          ...
          let len = 10;
          let scaleXY = 1; //let localPoint:PIXI.Point=this._stage.toLocal(new PIXI.Point(x,y));
          ...
          for (let i = 0; i < len; i++) {
            if (this._aryMoneyPools.length > 0) {
              ...
              let spr = nodeCoin.addComponent(Sprite);
              /*
            ...
            */
            ...
            let t = nodeCoin.getComponent(_crd && TweenMaxCocosPlugin === void 0 ? (_reportPossibleCrUseOfTweenMaxCocosPlugin({
              error: Error()
...
//# sourceMappingURL=c60ae235b208eb52090b056d94b6c868410edd74.js.map