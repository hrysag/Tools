    ...
    execute: function () {
      ...
      _export("Fish1AniEffectView", Fish1AniEffectView = class Fish1AniEffectView extends (_crd && AnimationEffectViewBase === void 0 ? (_reportPossibleCrUseOfAnimationEffectViewBase({
        ...
        setDataAfterSetRoom() {
          ...
          let command = this.getCommand((_crd && AniEffectID === void 0 ? (_reportPossibleCrUseOfAniEffectID({
            error: Error()
        ...
        resetRoomData() {
          ...
          let command = this.getCommand((_crd && Fish1AniEffectID === void 0 ? (_reportPossibleCrUseOfFish1AniEffectID({
            error: Error()
          }), Fish1AniEffectID) : Fish1AniEffectID).ANI_AWARD_DISC_EFFECT);
...
//# sourceMappingURL=204b91a62f1651552211f1980fb73175d47b3f1b.js.map