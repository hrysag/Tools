  ...
  return {
    ...
    execute: function () {
      ...
      _export("GetPropAniEffect", GetPropAniEffect = class GetPropAniEffect {
        ...
        async showGetPropEffect(propType, worldV3) {
          let sprNode;
          ...
          let tweenComponent = sprNode.getComponent(_crd && TweenMaxCocosPlugin === void 0 ? (_reportPossibleCrUseOfTweenMaxCocosPlugin({
            error: Error()
          }), TweenMaxCocosPlugin) : TweenMaxCocosPlugin);
          let t1 = await this.jumpTween(tweenComponent, localStartPosition, midXY, endXY);
          let t2 = await this.goBacktoMenu(t1, localEndPosition);
        ...
        async jumpTween(target, localStartPosition, midXY, endXY) {
        ...
        async goBacktoMenu(target, endLocalPosition) {
          return new Promise(resolve => {
...
//# sourceMappingURL=cf663504d0bc93a1f3ff9e9920db24ca93684e67.js.map