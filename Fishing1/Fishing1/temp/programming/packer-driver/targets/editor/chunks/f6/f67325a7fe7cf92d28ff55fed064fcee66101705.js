    ...
    execute: function () {
      ...
      _export("LightningLine", LightningLine = class LightningLine extends Component {
        ...
        createLine() {
          ...
          let numberOfTile = Math.ceil(dist / this._targetTexture.width); //@ts-ignore 
          ...
          let posData = [this._startAndEndPos.startPos, this._startAndEndPos.endPos]; //--for test
      ...
      _export("LightningEffect", LightningEffect = class LightningEffect extends EventTarget {
        ...
        showLightningEffect(data) {
          ...
          let len = pos.length;
          let lightningLineNode;
          let lightningBallNode;
          let lpStart;
          let lpEnd; //let startAndEndPos:{startPos:Vec3,endPos:Vec3};
          ...
          for (let i = 0; i < len - 1; i++) {
            ...
            let lpStartScreen = this.converToSceneCoordinates(pos[i]);
            let lplpEndScreen = this.converToSceneCoordinates(pos[i + 1]); //--開始產生 LINE--
...
//# sourceMappingURL=f67325a7fe7cf92d28ff55fed064fcee66101705.js.map