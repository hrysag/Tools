      ...
      _export("FishGameMain", FishGameMain = class FishGameMain extends (_crd && GameMainAbstractView === void 0 ? (_reportPossibleCrUseOfGameMainAbstractView({
        ...
        constructor() {
          ...
          this.lobbyIsReady = () => {
            ...
            */
            ...
            let hallid = (_crd && FacadeForGameView === void 0 ? (_reportPossibleCrUseOfFacadeForGameView({
              error: Error()
          ...
          this.handleVisibilityChangeShow = () => {
            ...
            let missingTime = nowTimestamp - this._focusFalseTime;
        ...
        async beforeinit() {
          ...
          return new Promise(async (resolve, reject) => {
            ...
            let data;
            let gameSetting = new (_crd && CocosGameSetting === void 0 ? (_reportPossibleCrUseOfCocosGameSetting({
              error: Error()
            }), CocosGameSetting) : CocosGameSetting)(this._gameType, 1920, 1080); //if(!this._localDebug)
            //{

            data = await this.prepareBeforeConnect(this._gameType); //}else{
            //--這是資料回來的狀態(local需要模擬)
            ...
            await (_crd && i18n === void 0 ? (_reportPossibleCrUseOfi18n({
              error: Error()
            ...
            (_this$_coordinate = this._coordinate) == null ? void 0 : _this$_coordinate.initNodeContainer(); //let cameraNode=find('Main Camera');
        ...
        update(deltaTime) {
          ...
          if ((_this$_bulletSystem = this._bulletSystem) != null && _this$_bulletSystem.canUpdate) {
            let updateBulletData = this._bulletSystem.updateAction(deltaTime);
...
//# sourceMappingURL=b36ab3b1d21372bd8088b3758e5bca49b9273901.js.map