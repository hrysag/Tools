    ...
    execute: function () {
      ...
      _export("SoundsManager", SoundsManager = class SoundsManager {
        ...
        createSound(soundId, clipId) {
          if (!this._mapSounds[soundId]) {
            if (this._mapAudioClips[clipId]) {
              let audioNode = new Node(soundId);
              let audio = audioNode.addComponent(_crd && BasicSound === void 0 ? (_reportPossibleCrUseOfBasicSound({
                error: Error()
        ...
        playBGMusic(sound) {
          ...
          let len = this._bgSoundList.length;
...
//# sourceMappingURL=bec6fde26ab2429d02b5474d7e8ffdc5c84e82c8.js.map