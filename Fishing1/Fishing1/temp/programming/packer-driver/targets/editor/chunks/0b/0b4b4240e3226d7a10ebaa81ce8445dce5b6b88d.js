    ...
    execute: function () {
      ...
      _export("McEffectFactory", McEffectFactory = class McEffectFactory extends (_crd && BaseEffectFactory === void 0 ? (_reportPossibleCrUseOfBaseEffectFactory({
        ...
        createEffect(effectInfo) {
          ...
          let ani = effectNode.addComponent(Animation);
          let clip = AnimationClip.createWithSpriteFrames(effectInfo.assets, speed);
          ...
          if (option.baseEffect) {
            if (option.assetsId) {
              ...
              if (aryTextures.length > 0) {
                let aniComponent = option.baseEffect.effectObj.getComponent(Animation);
                let oldClip = aniComponent.clips[0];
                aniComponent.stop();
                ...
                let newClip = AnimationClip.createWithSpriteFrames(aryTextures, speed);
...
//# sourceMappingURL=0b4b4240e3226d7a10ebaa81ce8445dce5b6b88d.js.map