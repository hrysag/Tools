      ...
      _export("Digits", Digits = class Digits extends Component {
        ...
        */
        ...
        displayWithStr(digits, direction = "left") {
          ...
          let sp;
          let spNode;
          let uiTransformComponent; //let ogSize:Size;
        ...
        layout(digitsStr) {
          ...
          let sp;
          let length = this.arrDigit.length;
          ...
          let allTextSize = this.updateTextsSize();
          let distance = 0;
        ...
        checkSpriteFrameSize() {
          for (let i = 0; i < this.arrDigit.length; i++) {
...
//# sourceMappingURL=37ed7bcf13495472cdd089454c3ae623d0b953c0.js.map