    ...
    execute: function () {
      ...
      _export("Fish1GameAutoAndLockData", Fish1GameAutoAndLockData = class Fish1GameAutoAndLockData extends (_crd && FishGameAutoAndLockData === void 0 ? (_reportPossibleCrUseOfFishGameAutoAndLockData({
        ...
        spFishSetLockFishBullet(f, isPlayer) {
          ...
          let worldobb = shape.worldObb; //let worldPos:Vec3=this.getCanvasWorldPosition(f.fishMeshState,worldobb.center);
          ...
          let localPos = this._mouseNode.getComponent(UITransform).convertToNodeSpaceAR(worldPos);
        ...
        spFishupdateLockBullets(f, bulletId, isPlayer) {
          ...
          let rp = this._bulletNode.getComponent(UITransform).convertToNodeSpaceAR(worldPos); //--要判斷是不是玩家本人
...
//# sourceMappingURL=55db9949a4ed53900f577879d3f03c9fad7c83a4.js.map