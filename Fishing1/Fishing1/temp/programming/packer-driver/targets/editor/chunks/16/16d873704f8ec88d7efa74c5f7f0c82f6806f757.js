      ...
      _export("STAcollisionStrategy", STAcollisionStrategy = class STAcollisionStrategy {
        ...
        */
        getCollision(data) {
          ...
          let aryPointB1 = data.a;
          let aryPointB2 = data.b;
          ...
          for (let i = 0; i < 2; i++) {
            ...
            let axisLen = axis.x * axis.x + axis.y * axis.y;
            ...
            for (let j = 0; j < 4; j++) {
              ...
              let projLen = v.x * axis.x + v.y * axis.y;
...
//# sourceMappingURL=16d873704f8ec88d7efa74c5f7f0c82f6806f757.js.map