          ...
          */
          ...
          this._tween = new TweenMax(this._tweenObj, this._autoTime, {
            onComplete: () => {
              if (!this._autoShoot) {
                let clickObj = {};
                let directData = false; //--20230417如果計時器運作期間內,關閉定向射擊,他會打出最後一發
                ...
                if (this._lastShootForDirection) {
                  ...
                  let emitTimLongPress = Date.now(); //log('autoShootTimeStemp',emitTimLongPress-this._testTimeStemp);
                ...
                //log('finishAutoShoot');
                let emitTim = Date.now(); //log('autoShootTimeStemp',emitTim-this._testTimeStemp);
...
//# sourceMappingURL=313e285a817bed86518617bf3127242fc6b98483.js.map