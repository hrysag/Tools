    ...
    execute: function () {
      ...
      _export("CocosGameSetting", CocosGameSetting = class CocosGameSetting {
        ...
        */
        ...
        getURLLang() {
          let ary = window.location.href.split("?"); // url帶參數格式

          if (ary.length == 1) return 'en';
          let splitAnd = ary[1].split("&");

          for (var i = 0; i < splitAnd.length; i++) {
            let splitAry = splitAnd[i].split("=");
...
//# sourceMappingURL=1f865db8222d79393e98000e7617ab11313d993e.js.map