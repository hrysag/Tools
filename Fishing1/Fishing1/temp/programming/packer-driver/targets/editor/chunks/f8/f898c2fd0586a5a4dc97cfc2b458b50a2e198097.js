      ...
      _export("MouseBehaviorClick", MouseBehaviorClick = class MouseBehaviorClick extends (_crd && MouseBehaviorBase === void 0 ? (_reportPossibleCrUseOfMouseBehaviorBase({
        ...
        mouseStartHandler(e) {
          ...
          if (this._block) {
            ...
            let clickObj = this.getMousePosition(e); //-{endX:number,endY:number}
        ...
        getMousePosition(value) {
          ...
          if (value) {
            ...
            let mousePosition:Vec2=value.getLocation();
             ...
             mPosition={endX:wpos.x,endY:wpos.y};
            */
            let mousePosition = value.getLocation();

            let wpos = this._cameraComponentForUitransform.screenToWorld(v3(mousePosition.x, mousePosition.y)); //let mouseNode=find('Canvas/mouseNode');
...
//# sourceMappingURL=f898c2fd0586a5a4dc97cfc2b458b50a2e198097.js.map