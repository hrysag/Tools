    ...
    execute: function () {
      ...
      _export("GetPropAniEffectCommand", GetPropAniEffectCommand = class GetPropAniEffectCommand extends (_crd && AniEffectBaseCommand === void 0 ? (_reportPossibleCrUseOfAniEffectBaseCommand({
        ...
        constructor(...args) {
          ...
          this._getPropAniEffect = args[0]; //this._getPropAniEffect.on(AnimationEffectEvent.COMPLETE,this.sendEvt);
        }
        /*
...
//# sourceMappingURL=766c40d25c727d1ae122b373e666734efd6f9379.js.map