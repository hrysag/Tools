  ...
  return {
    ...
    execute: function () {
      ...
      _export("BtnExchangeMoney", BtnExchangeMoney = class BtnExchangeMoney extends Component {
        ...
        onLoad() {
          //--lastChoose--這個要補
          let lableSpriteFrames = (_crd && LoadingResManager === void 0 ? (_reportPossibleCrUseOfLoadingResManager({
            error: Error()
          ...
          let labelDisableSpriteFrames = (_crd && LoadingResManager === void 0 ? (_reportPossibleCrUseOfLoadingResManager({
            error: Error()
        ...
        */
        ...
        constructor() {
          ...
          this.creditExchangeBtnHandler = e => {
            ...
            let target = e.currentTarget.getComponent(BtnExchangeMoney);
        ...
        async setLayout() {
          return new Promise(resolve => {
            let creditExchange = instantiate((_crd && LoadingResManager === void 0 ? (_reportPossibleCrUseOfLoadingResManager({
              error: Error()
            }), LoadingResManager) : LoadingResManager).getInstance().getPrefab('prefab/gui/creditExchange'));
            let wholeContentWithoutBg = creditExchange.getChildByName('exchange');
            ...
            let titleBalanceSpriteFrame = (_crd && LoadingResManager === void 0 ? (_reportPossibleCrUseOfLoadingResManager({
              error: Error()
            ...
            let titleExchangeSpriteFrame = (_crd && LoadingResManager === void 0 ? (_reportPossibleCrUseOfLoadingResManager({
              error: Error()
            ...
            let titleRatioSpriteFrame = (_crd && LoadingResManager === void 0 ? (_reportPossibleCrUseOfLoadingResManager({
              error: Error()
            ...
            let autoExchangeBtnTitleSpriteFrame = (_crd && LoadingResManager === void 0 ? (_reportPossibleCrUseOfLoadingResManager({
              error: Error()
            ...
            let digitsSpruteFrames = (_crd && LoadingResManager === void 0 ? (_reportPossibleCrUseOfLoadingResManager({
              error: Error()
            ...
            this._balanceTx = wholeContentWithoutBg.getChildByName('labelR1').addComponent(_crd && Digits === void 0 ? (_reportPossibleCrUseOfDigits({
              error: Error()
            }), Digits) : Digits);
            ...
            this._creditTx = wholeContentWithoutBg.getChildByName('labelR2').addComponent(_crd && Digits === void 0 ? (_reportPossibleCrUseOfDigits({
              error: Error()
            }), Digits) : Digits);
            this._creditTx.textures = digitsSpruteFrames;
            this._creditTx.useCommand = true;
            this._ratioTx = wholeContentWithoutBg.getChildByName('labelR3').addComponent(_crd && Digits === void 0 ? (_reportPossibleCrUseOfDigits({
              error: Error()
            }), Digits) : Digits);
            this._ratioTx.textures = digitsSpruteFrames; //this._ratioTx.useCommand=true;

            this._ratioTx.symbolStr = [':', 'K', '-'];
            this._ratioTx.symbolIndex = [12, 13, 14]; //log('check_exchangeDigits',digitsSpruteFrames,this._ratioTx);
            ...
            */
            ...
            let enterSpriteFrame = (_crd && LoadingResManager === void 0 ? (_reportPossibleCrUseOfLoadingResManager({
              error: Error()
            ...
            let exitSpriteFrame = (_crd && LoadingResManager === void 0 ? (_reportPossibleCrUseOfLoadingResManager({
              error: Error()
            ...
            this._exitGameBtn.on(Node.EventType.TOUCH_START, this.infoBtnHandler); //let autoExchangeBtnNode:Node=wholeContentWithoutBg.getChildByName('autoExchange');
            ...
            for (let i = 0; i < this._exchangelist.length; i++) {
              ...
              btn.id = i;
              btn.setDigits(this._exchangelist[i]); //btn.node.addComponent(BlockInputEvents);
              //btn.node.on(Node.EventType.MOUSE_DOWN,this.creditExchangeBtnHandler);

              btn.node.on(Node.EventType.TOUCH_START, this.creditExchangeBtnHandler); //btn.setMouseStatus(false);
        ...
        setChangeRatio() {
          this._changeRatio = parseInt(this._nowBase.split(":")[0]) / parseInt(this._nowBase.split(":")[1]);
          let n = this._nowBase; //--test-
          //n='1:50000';
          //- let ary:string[]=baseRatio.split(":");

          let ary = n.split(':'); //n = ary[0] +  ":" + ary[1];
        ...
        openOrClose(f) {
          let c = this.getComponent(_crd && TweenMaxCocosPlugin === void 0 ? (_reportPossibleCrUseOfTweenMaxCocosPlugin({
            error: Error()
          }), TweenMaxCocosPlugin) : TweenMaxCocosPlugin);
        ...
        changeAutoState() {
          let sprTexture = this._changeAuto ? this._toggleTexture.on : this._toggleTexture.off;
        ...
        //--設定最後一次兌換的金額按鈕顯示
        resetLastChooseImg() {
          let len = this._aryExchangeBtns.length;
        ...
        reSetexChangePanel() {
          ...
          let exBalance = this.floatSubtraction(this._balance, this.floatMultipaction(this._exchange, this._changeRatio));
          let showBalance = exBalance.toString();
          let index = showBalance.indexOf(".");
...
//# sourceMappingURL=9339f48bfd5035d3ba47554d6ee4029b250ac816.js.map