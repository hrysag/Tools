    ...
    execute: function () {
      ...
      _export("Fish1Model", Fish1Model = (_dec = _crd && Mutable === void 0 ? (_reportPossibleCrUseOfMutable({
          ...
          this.serverResBack = value => {
            ...
            switch (value.type) {
              ...
              case (_crd && ServerResCode === void 0 ? (_reportPossibleCrUseOfServerResCode({
                ...
                let call_count = value.sendObject[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                  error: Error()
                ...
                let freeze_count = value.sendObject[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                  error: Error()
                ...
                let crazy_count = value.sendObject[(_crd && PropType === void 0 ? (_reportPossibleCrUseOfPropType({
                  error: Error()
        ...
        otherPlayerUseCrazyPropTimer(dt) {
          let r = false; //--啟動相關的計時器

          if (this._otherPlayerUseProp.length > 0) {
            for (let i = 0; i < this._otherPlayerUseProp.length; i++) {
