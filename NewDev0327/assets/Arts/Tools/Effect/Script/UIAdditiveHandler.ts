...
export class UIAdditiveHandler extends Component {
    ...
    @property({ tooltip: "main texture color" })
    /**
     * 主要貼圖的顏色
     */
    private _main_color: Color = new Color(255, 255, 255, 255);

    @property({ tooltip: "main texture color" })
    /**
     * 主要貼圖的顏色 getter
     */
    public get main_color(): Color { return this._main_color; }
    /**
     * 主要貼圖的顏色 setter
     */
    public set main_color(value: Color) {
        this._main_color = value;
        if (this.material) {
            this.material.setProperty('main_color', this._main_color);
        }
    }
    ...
    start() {
        if (this.renderer) {
            ...
            //initial value
            this.main_color = this._main_color;
