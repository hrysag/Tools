...
export class MessageBox extends Component {
    ...
    public showMsgBox(title: string, content: string, isShowConfirm: boolean = true, confirmCallback: Function = null, isShowClose: boolean = false, closeCallback: Function = null): void {
