...
export default class SpinAck extends Decoder {
    ...
    //AW幣基礎壓注額
    private awBaseBet: number = 0;
    //AW幣贏分
    private awWin: number = 0;
  ...
  */
    ...
    */
     ...
     * AW幣基礎壓注額
     */
    public get AwBaseBet(): number { return this.awBaseBet; }

    /**
     * AW幣贏分
     */
    public get AwWin(): number { return this.awWin; }
     ...
     * 歷程高度
     */
    public get HistoryHeight(): number { return this.historyHeight; }
    ...
    Decode(): void {
        ...
        this.awBaseBet = this.serverAck.ReadDouble(); // Double(AW幣基礎壓注額)
        this.awWin = this.serverAck.ReadDouble(); // Double(AW幣贏分)
        this.serialId = this.serverAck.ReadString();
        this.plant = this.serverAck.ReadLongString();
        this.time = this.serverAck.ReadString();
        this.historyHeight = this.serverAck.ReadLong(); // Long8(歷程高度)
    }
