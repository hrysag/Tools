...
//分流登入連線時敗
export const LoginReDispatcherConnectFail: number = -9996;
//分流Spin連線時敗
export const SpinReDispatcherConnectFail: number = -9997;
//分流ExtraInfo連線時敗
export const ExtraInfoReDispatcherConnectFail: number = -9998;
//歷史紀錄請求失敗
...
export interface IPlayerInfo extends IPlayerInfoBase {
    ...
    originalUrl?: string,  // 新增：保存原始URL用於FanTa解析
    optionSettings?: IOptionSettings,
    extraInfo?: IExtraInfo,  // 新增：額外資訊，包含ExtraInfoAck的相關資料
    moneyDecimal?: number  // 新增：小數點顯示位數，預設為0
}
