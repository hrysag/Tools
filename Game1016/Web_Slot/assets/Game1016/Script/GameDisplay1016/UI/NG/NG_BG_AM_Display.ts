import { _decorator, Component, Node, Sprite, sp, CCBoolean } from 'cc';
...
@ccclass('NG_BG_AM_Display')
export class NG_BG_AM_Display extends ContainerWholeBehavior implements IBkgDisplay {
