//import { IReel } from 'db://assets/Scripts/ReelTemplate/ReelTemplate_3/Scripts/Interface/IReel';
...
import { UniMovement, IReel, SymbolBase, UniIconBase } from '../ReferencePathForUniSlot';
import { Queue } from 'db://assets/Scripts/ModuleEntry';
...
@ccclass('BasicReel')
export abstract class BasicReel<S extends SymbolBase, Icon extends UniIconBase<S>> extends Component implements IReel {
    ...
    protected _testStopTime: number = 0;

    protected iconWarehouse: Icon[] = [];

    public get iconList(): Icon[] {
        return this._iconList;
    }

    protected maximumIconDic: number = 0;

    public onStartRoll: () => void;
    public onStopRoll: () => Promise<void>;
    ...
    protected async moveOnceComplete(move: UniMovement): Promise<void> {
        this.reArrangeIcon();
    ...
    protected getIconPositionByIndex(index: number): Vec3 {
        // 幾何中心在顯示範圍 [2] 和 [3] 之間
