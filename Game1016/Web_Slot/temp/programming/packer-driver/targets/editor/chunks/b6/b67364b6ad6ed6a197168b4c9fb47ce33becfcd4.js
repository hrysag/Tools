System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, AudioClip, Component, resources, AudioResource, Debug, IdStringPair, SlotRelayLang, _dec, _dec2, _dec3, _class, _class2, _descriptor, _crd, ccclass, requireComponent, property, LocalizationSound;
  ...
  function _reportPossibleCrUseOfIdStringPair(extras) {
    _reporterNs.report("IdStringPair", "../../Utils/Core", _context.meta, extras);
  }
                ...
                if (err) {
                  ...
                  if (err.message.includes("Bundle resources doesn't contain") && langKey !== (_crd && SlotRelayLang === void 0 ? (_reportPossibleCrUseOfSlotRelayLang({
                    ...
                    this.loadOneSound((_crd && SlotRelayLang === void 0 ? (_reportPossibleCrUseOfSlotRelayLang({
                      error: Error()
                    }), SlotRelayLang) : SlotRelayLang).en, path, id).then(() => {
                      resolve();
                    });
                  } else {
...
//# sourceMappingURL=b67364b6ad6ed6a197168b4c9fb47ce33becfcd4.js.map