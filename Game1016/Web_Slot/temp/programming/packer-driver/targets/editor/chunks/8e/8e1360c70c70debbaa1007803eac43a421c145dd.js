  ...
  return {
    ...
    execute: function () {
      ...
      _export("SlotDataParser", SlotDataParser = class SlotDataParser {
        ...
        setDetail(isWin, detailDataList) {
          ...
          if (!isWin) {
            ...
            for (let i = 0; i < detailDataList.winIconSymbolList.length; i++) {
              const allDetails = [];
              const score = detailDataList.megaWayCombinationCount !== undefined ? detailDataList.odds[i] * this.bet * detailDataList.megaWayCombinationCount[i] : detailDataList.odds[i] * this.bet;
        ...
        combineOneRoundData() {
          const round = this.createRound(SlotDataStringType.round, this.oneRound);
...
//# sourceMappingURL=8e1360c70c70debbaa1007803eac43a421c145dd.js.map