System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, AudioSource, Component, director, tween, warn, Debug, Utility, BindTarget, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _crd, ccclass, property, SOUND_TYPE, AudioManager;
  ...
  function _reportPossibleCrUseOfDebug(extras) {
    _reporterNs.report("Debug", "../Core", _context.meta, extras);
  }

  function _reportPossibleCrUseOfUtility(extras) {
    _reporterNs.report("Utility", "../Core", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _export("AudioManager", AudioManager = (_dec = ccclass('AudioManager'), _dec2 = property(AudioSource), _dec3 = property(AudioSource), _dec4 = property([AudioSource]), _dec5 = property(AudioSource), _dec6 = property([AudioSource]), _dec(_class = (_class2 = (_class3 = class AudioManager extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "musicExtraAudioSource", _descriptor3, this);

          _initializerDefineProperty(this, "soundAudioSource", _descriptor4, this);

          _initializerDefineProperty(this, "soundAudioSources", _descriptor5, this);
          ...
          this.fadeMusicExtraTween = [];
          this._isAudioEnable = true;
          this.musicVolume = 1;
          this.music2Volume = 1;
          this.musicExtraVolume = [];
        ...
        playGenericSound(id, type = SOUND_TYPE.ONE_SHOT, isLoop = false, sourceID = -1) {
        ...
        isPlaying(sourceID = -1) {
          let targetSource = sourceID === -1 ? this.soundAudioSource : this.soundAudioSources[sourceID];
          return targetSource.playing;
        }

        playSound(clipID, type = SOUND_TYPE.ONE_SHOT, sourceID = -1) {
          if (!this.soundAudioClips) {
            return;
          }

          let targetSource = sourceID === -1 ? this.soundAudioSource : this.soundAudioSources[sourceID];
          let soundClip = this.soundAudioClips[clipID];
        ...
        playSoundClip(clip, sourceID = -1) {
          let targetSource = sourceID === -1 ? this.soundAudioSource : this.soundAudioSources[sourceID];
          targetSource.playOneShot(clip);
        }

        playSoundRandom(ids, sourceID = -1) {
          if (!this.soundAudioClips) {
            return;
          }
        ...
        playSoundPromise(id, sourceID = -1) {
          let targetSource = sourceID === -1 ? this.soundAudioSource : this.soundAudioSources[sourceID];
        ...
        playSoundConsecutively(ids, sourceID = -1) {
          if (!this.soundAudioClips) {
            return;
          }
        ...
        fadeMusicVolume(startVolume, targetVolume, duration = 0.5, callback = null) {
        ...
        fadeMusic2Volume(startVolume, targetVolume, duration = 0.5, callback = null) {
        ...
        fadeMusicExtraVolume(index, startVolume, targetVolume, duration = 0.5, callback = null) {
          this.stopFadeMusicExtraTween(index);
          let target = new BindTarget();
          target.volume = startVolume;
          this.fadeMusicExtraTween[index] = tween(target).to(duration, {
            volume: targetVolume
          }, {
            onUpdate: (v, progress) => {
        ...
        fadeMusicVolumePromise(startVolume, targetVolume, duration = 0.5) {
          return new Promise((resolve, reject) => {
        ...
        fadeMusic2VolumePromise(startVolume, targetVolume, duration = 0.5) {
          return new Promise((resolve, reject) => {
        ...
        fadeMusicExtraVolumePromise(index, startVolume, targetVolume, duration = 0.5) {
          return new Promise((resolve, reject) => {
        ...
        playMusicExtraOncePromise(index, id) {
          return new Promise((resolve, reject) => {
            this.musicExtraAudioSource[index].stop();
        ...
        setAudioEnable(b) {
          let audioSources = director.getScene().getComponentsInChildren(AudioSource);
        ...
        setMusicExtraVolume(index, volume) {
        ...
        writable: true,
        initializer: null
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "musicExtraAudioSource", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "soundAudioSource", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "soundAudioSources", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=2f0c4d3526194e266f7f695bb7a5434a89b83ff9.js.map