    ...
    execute: function () {
      ...
      _export("GameUtilsTools", GameUtilsTools = class GameUtilsTools {
        ...
        */
        ...
        static deepCloneForObject(obj, map = new WeakMap()) {
        ...
        static deepClone(obj, map = new WeakMap()) {
        ...
        static createAndShuffleProbabilityPool(count) {
          ...
          const result = pool[0]; // 1 (true), 0 (false)
         ...
         * 
         */
        static debugLog(title, tag, payload = {}, level = 'log', count = 0) {
        ...
        */
        ...
        static TweenActionPromiseWithCancel(target, duration, finalProps, easing) {
          ...
          const t = tween(target).to(duration, finalProps, option).call(() => {
            if (!finished) {
              finished = true;
        ...
        static TweenActionSequencePromiseWithCancel(target, tweens) {
          let resolveFunc = null;
          let finished = false;
          const seq = tween(target).sequence(...tweens).call(() => {
            if (!finished) {
              finished = true;
              resolveFunc == null || resolveFunc();
            }
        ...
        static DeferByTweenPromise(duration = 0, tweenObj) {
          return new Promise((resolve, reject) => {
        ...
        static DeferByTweenPromiseWithCancel(duration = 0, tweenObj) {
          let isCanceled = false;
          let resolveFunc = null;
          const tObj = tweenObj || {};
          const t = tween(tObj).to(duration, {}).call(() => {
         ...
         * @returns 
         */
        static DeferByTweenPromiseTask(task, delayTime, ...args) {
        ...
        static DeferTaskWithCancelableDelay(task, delayTime, ...args) {
          const delay = GameUtilsTools.DeferByTweenPromiseWithCancel(delayTime);
        ...
        static withTimeout(ogPromise, seconds, meta, label = 'timeout', resolveOnTimeout = false, timeoutValue) {
        ...
        */
        ...
        static DeferByScheduleOnce(duration = 0) {
          return;
        ...
        static DeferByScheduleOnceWithComponent(targetComponent, duration = 0) {
          return new Promise((resolve, reject) => {
...
//# sourceMappingURL=8e9b1ec4f2710d01a4fbd20ee4891b2a6d242047.js.map