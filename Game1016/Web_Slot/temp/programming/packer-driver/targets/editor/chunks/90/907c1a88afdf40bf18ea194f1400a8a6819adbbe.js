System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, CCFloat, CCInteger, randomRangeInt, UniSlotMachineTempo, PublicReelConfigTest, GameController, GenericUIManager, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, NORMAL_SYMBOLS_LIST, MAGNIFICATION_SYMBOLS_LIST, ICON_AMOUNT, UniReelGameControllerTest;
  ...
  function _reportPossibleCrUseOfUniSlotMachineTempo(extras) {
    _reporterNs.report("UniSlotMachineTempo", "./UniSlotMachineTempo", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      UniSlotMachineTempo = _unresolved_2.UniSlotMachineTempo;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "293b2QwAl9NOqZaFt0EZ7aW", "GameControllerTempo", undefined);
      ...
      _export("UniReelGameControllerTest", UniReelGameControllerTest = (_dec = ccclass('UniReelGameControllerTest'), _dec2 = property({
        type: _crd && UniSlotMachineTempo === void 0 ? (_reportPossibleCrUseOfUniSlotMachineTempo({
          error: Error()
        }), UniSlotMachineTempo) : UniSlotMachineTempo,
        visible: true
...
//# sourceMappingURL=907c1a88afdf40bf18ea194f1400a8a6819adbbe.js.map