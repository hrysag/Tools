System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _utility.addEventHandlerToButton = (buttonNode, component, callback, customEventData = '') => (_crd && addEventHandlerToButton === void 0 ? (_reportPossibleCrUseOfaddEventHandlerToButton({
        error: Error()
      }), addEventHandlerToButton) : addEventHandlerToButton)(buttonNode, component, callback, customEventData);

      _utility.addEventHandlerToToggle = (toggleNode, component, callback, customEventData = '') => (_crd && addEventHandlerToToggle === void 0 ? (_reportPossibleCrUseOfaddEventHandlerToToggle({
        error: Error()
      }), addEventHandlerToToggle) : addEventHandlerToToggle)(toggleNode, component, callback, customEventData);

      _utility.waitPromise = (seconds, signal = undefined) => (_crd && waitPromise === void 0 ? (_reportPossibleCrUseOfwaitPromise({
        error: Error()
...
//# sourceMappingURL=05cb43e146515b8df44c6ef788b34d17adf36c16.js.map