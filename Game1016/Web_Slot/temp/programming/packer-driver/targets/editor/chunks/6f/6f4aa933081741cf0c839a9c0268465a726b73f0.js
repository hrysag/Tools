System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, CCFloat, UniReelView, UniDropReel, Utility, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, UniDropReelView;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      UniDropReel = _unresolved_3.UniDropReel;
    ...
    execute: function () {
      ...
      _export("UniDropReelView", UniDropReelView = (_dec = ccclass('DropUniReelView'), _dec2 = property(_crd && UniDropReel === void 0 ? (_reportPossibleCrUseOfUniDropReel({
         ...
         */
        async startDropOut(dropOutIdList) {
            ...
            if (index === lastIndex) {
              ...
              if (this.startSpaceTime >= 0 && !this.isFastModeCallback()) {
                await (_crd && Utility === void 0 ? (_reportPossibleCrUseOfUtility({
                  error: Error()
                }), Utility) : Utility).waitPromise(this.startSpaceTime);
              }
            }
          }
        }
          ...
          for (let index = 0; index < dropInIdList.length; index++) {
            ...
            if (index === lastIndex) {
              ...
              if (this.stopDropSpaceTime >= 0 && !this.isFastModeCallback()) {
                await (_crd && Utility === void 0 ? (_reportPossibleCrUseOfUtility({
                  error: Error()
                }), Utility) : Utility).waitPromise(this.stopDropSpaceTime);
              }
            }
          }
        }
...
//# sourceMappingURL=6f4aa933081741cf0c839a9c0268465a726b73f0.js.map