    ...
    execute: function () {
      ...
      _export("ReelManager", ReelManager = (_dec = ccclass('ReelManager'), _dec2 = property({
        ...
        getByState(reelState) {
          ...
          for (let reelID = 0; reelID < this._reelList.length; reelID++) {
            const reel = this._reelList[reelID];
...
//# sourceMappingURL=ca434c6a6f6b8b9075a950a055fa88db63f1db1e.js.map