    ...
    execute: function () {
      ...
      _export("JsonSerialization", JsonSerialization = (_dec = ccclass('JsonSerialization'), _dec2 = property({
        ...
        async startExportJson() {
          ...
          this.exporting = true;
          await Editor.Message.request('component-json-tools', 'export-json-for-component', this.node.uuid, componentName, componentName);
          this.exporting = false;
        }
...
//# sourceMappingURL=cebe36097b34a760385af4916c6dc5bd44e5bdc5.js.map