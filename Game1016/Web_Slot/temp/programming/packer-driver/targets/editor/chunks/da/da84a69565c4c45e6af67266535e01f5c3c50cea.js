System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfBetData(extras) {
    _reporterNs.report("BetData", "db://assets/Scripts/GameScripts/Networks", _context.meta, extras);
  }

  function _reportPossibleCrUseOfNetworkEvent(extras) {
    _reporterNs.report("NetworkEvent", "db://assets/Scripts/GameScripts/Networks", _context.meta, extras);
  }

  function _reportPossibleCrUseOfNetworkHandler(extras) {
    _reporterNs.report("NetworkHandler", "db://assets/Scripts/GameScripts/Networks", _context.meta, extras);
  }
    ...
    execute: function () {
      ...
      _export("CheckScoreTool", CheckScoreTool = (_dec = ccclass('CheckScoreTool'), _dec2 = property(CCInteger), _dec(_class = (_class2 = class CheckScoreTool extends Component {
        ...
        onReceiveBet(betData) {
          ...
          let serverOdds = (betData.score / betData.bet).fixed(); // 這行要加入自己計算Odds的邏輯
...
//# sourceMappingURL=da84a69565c4c45e6af67266535e01f5c3c50cea.js.map