System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, director, Label, Node, UITransform, Utility, AudioManager, GenericSound, WebViewH5, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, MessageBoxUI;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("MessageBoxUI", MessageBoxUI = (_dec = ccclass('MessageBoxUI'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Label), _dec(_class = (_class2 = class MessageBoxUI extends Component {
        ...
        showUI(title, content, isShowConfirm, confirmCallback = null, showCloseBtn = false, closeCallback = null) {
          this.hideWebview();
...
//# sourceMappingURL=2a7599b426d9e23d694496aa84146e5b61c40e65.js.map