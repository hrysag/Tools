  ...
  return {
    ...
    execute: function () {
      ...
      _export("IconExample", IconExample = (_dec = ccclass('IconExample'), _dec2 = property({
        ...
        init() {
          super.init();
          let reelData = (_crd && RunTimeData === void 0 ? (_reportPossibleCrUseOfRunTimeData({
            error: Error()
        ...
        createSymbol(prefabList) {
          ...
          for (let index = 0; index < prefabList.length; index++) {
            ...
            let symbolCtrl = node.addComponent(_crd && SymbolControllerExample === void 0 ? (_reportPossibleCrUseOfSymbolControllerExample({
              error: Error()
            }), SymbolControllerExample) : SymbolControllerExample);
            let defaultAnim = this.getSymbolAnim(index, (_crd && SymbolEventType === void 0 ? (_reportPossibleCrUseOfSymbolEventType({
              error: Error()
        ...
        getSymbolAnim(symbolID, symbolEventType) {
          let symbolData = (_crd && RunTimeData === void 0 ? (_reportPossibleCrUseOfRunTimeData({
            error: Error()
        ...
        playAnim(animName) {
          return new Promise((resolve, reject) => {
            ...
            if (!this.currentSymbol.isSprite) {
              ...
              let time = (_crd && RunTimeData === void 0 ? (_reportPossibleCrUseOfRunTimeData({
                error: Error()
        ...
        stopAnim() {
          let eventList = (_crd && RunTimeData === void 0 ? (_reportPossibleCrUseOfRunTimeData({
            error: Error()
          }), RunTimeData) : RunTimeData).instance.reelData.symbolDataList[this.symbol.symbolID].eventList;
          let defaultEvent = eventList.find(event => event.eventType === (_crd && SymbolEventType === void 0 ? (_reportPossibleCrUseOfSymbolEventType({
            error: Error()
          }), SymbolEventType) : SymbolEventType).Default);
...
//# sourceMappingURL=32554ed75a928e7b39cde16b15c584439a9f41bd.js.map