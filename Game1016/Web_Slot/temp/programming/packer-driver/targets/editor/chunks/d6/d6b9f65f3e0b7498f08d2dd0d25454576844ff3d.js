System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Animation, AudioClip, Button, CCBoolean, Component, instantiate, Node, Prefab, RichText, Sprite, tween, UIOpacity, v3, Vec3, Utility, Localization, PageIconGroup, AudioManager, RotationResize, Orientation, DragNodeEvent, SkeletonExtension, DragOutChecker, LoadingPage, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _descriptor20, _crd, ccclass, property, GameInfoUI;
  ...
  function _reportPossibleCrUseOfRotationResize(extras) {
    _reporterNs.report("RotationResize", "../Utils/RotationResize", _context.meta, extras);
  }

  function _reportPossibleCrUseOfOrientation(extras) {
    _reporterNs.report("Orientation", "../Utils/Config", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      DragNodeEvent = _unresolved_8.DragNodeEvent;
    }, function (_unresolved_9) {
      SkeletonExtension = _unresolved_9.SkeletonExtension;
    }, function (_unresolved_10) {
      DragOutChecker = _unresolved_10.DragOutChecker;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GameInfoUI", GameInfoUI = (_dec = ccclass("GameInfoUI"), _dec2 = property(CCBoolean), _dec3 = property(_crd && PageIconGroup === void 0 ? (_reportPossibleCrUseOfPageIconGroup({
        ...
        onDrag(dragDiff, touchPosOfNode, touchPosCanvas) {
          ...
          const prevID = this.getWrappedIndex(this.currentID - 1); // diffRatio 比例用 animationDistance控制而非換頁的比利用500控制而非換頁的 changeDistance
          ...
          const interpolatedX = diffRatio / this.settingRatio * this.gap; // Opacity 控制底下 Spine節點，若原欲設為0，則切換為任何數字都會看到spine瞬間出現，下一偵才切回指定透明度
          // 所以這邊不設為0，改設為0.1
        ...
        async onRelease(dragDiff, touchPosOfNode, touchPosCanvas) {
          if (!this.isDragging) {
            return;
          }
        ...
        async resetToOriginalPos(isDragRightReset) {
          const promises = [];
          promises.push(this.tweenToTargetPos(this.currentID, 0, this.transitionDuration));
          const sideID = isDragRightReset ? this.getWrappedIndex(this.currentID - 1) : this.getWrappedIndex(this.currentID + 1);
        ...
        async animatePageTransition(newID, oldID, direction) {
          await Promise.all([this.tweenToTargetPos(newID, 0, this.transitionDuration), this.tweenToTargetPos(oldID, direction, this.transitionDuration)]);
        }
      ...
      _export("LoadingPage", LoadingPage = class LoadingPage {
        ...
        playAnchorAnimation(orientation) {
          for (let i = 0; i < this.spineList.length; i++) {
            const targetAnchor = orientation === (_crd && Orientation === void 0 ? (_reportPossibleCrUseOfOrientation({
              error: Error()
...
//# sourceMappingURL=d6b9f65f3e0b7498f08d2dd0d25454576844ff3d.js.map