  ...
  return {
    ...
    execute: function () {
      ...
      _export("ByteWriterHelper", ByteWriterHelper = class ByteWriterHelper {
        ...
        static ConvertToInt16(value, isBigEndian = false) {
      ...
      _export("ByteReaderHelper", ByteReaderHelper = class ByteReaderHelper extends Uint8Array {
        ...
        ReadDouble() {
          ...
          let view = new DataView(buffer); // 將每個 byte 放入 DataView 中
...
//# sourceMappingURL=9ef945495625c523714bcab585b449e9bebf018a.js.map