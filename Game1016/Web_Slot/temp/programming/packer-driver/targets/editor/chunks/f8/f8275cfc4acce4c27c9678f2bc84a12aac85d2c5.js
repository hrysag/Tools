  ...
  return {
    ...
    execute: function () {
      ...
      p = E, E.defaultVideoFileOption = {
        fileTypes: "mp4"
      }, E.getVideoData = (t, ...e) => s(void 0, [t, ...e], void 0, function* (t, e = p.defaultVideoFileOption) {
        const {
          fileTypes: i
        } = e;
        ...
        return new Promise((s, r) => {
          ...
          a.onSamples = (t, e, i) => {
            ...
            if (e) {
              ...
              const t = a.moov.traks[0].mdia.minf.stbl.stsd.entries[0],
                    i = new w.DataStream(void 0, 0, w.DataStream.BIG_ENDIAN);
              t.avcC.write(i), d.description = new Uint8Array(i.buffer.slice(8)), d.width = e.track_width, d.height = e.track_height, d.codec = e.codec, a.start();
      ...
      A = class A {
        ...
        dequeue() {
          ...
          const t = this.storage[this.head];
      ...
      B = class B {
        ...
        flushDecodr() {
          return s(this, arguments, void 0, function* (t = !1) {
            let e;
            null !== this.timeout && (clearTimeout(this.timeout), this.timeout = null), this.inputQueueFramesIndex = -1, this.playingVideo = null, this.isPlayer = !1;
            const i = new Promise((t, i) => {
              e = setTimeout(() => {
                this.event.sendError(o.DecoderError, "decoder.flush() 超時"), t("decoder.flush() 超時");
              }, this.flushTimeoutMs);
            });
            if (yield Promise.race([this.decoder.flush, i]), e && clearTimeout(e), 0 !== this.frameInfoQueue.size() && this.frameInfoQueue.clear(), t) for (; 0 !== this.videoFrameQueue.size();) {
              const t = this.getFrameOutput();
              if (null === t) break;
              t.videoFrame.close();
            }
          });
        ...
        VideoFrameOutput(t) {
          const e = this.frameInfoQueue.dequeue();
        ...
        getFrameOutput() {
          const t = this.videoFrameQueue.dequeue();
      ...
      _export("default", C = class C {
        ...
        createDecoder() {
          return s(this, void 0, void 0, function* () {
            ...
            const i = yield r(this, u, "f").setDecoderconfigure({
            ...
            const h = new t.TextureSubresLayers();
            h.mipLevel = 0;
            const d = new t.Extent(this.videoChunks[0].width, this.videoChunks[0].height);
        ...
        update(e) {
          if (r(this, y, "f") && !r(this, S, "f") && r(this, u, "f") && (n(this, v, r(this, v, "f") + e, "f"), null === r(this, U, "f") && n(this, U, r(this, u, "f").getFrameOutput(), "f"), null !== r(this, U, "f") && r(this, v, "f") >= r(this, b, "f") && null !== r(this, _, "f") && null !== r(this, m, "f"))) {
            if (n(this, v, r(this, v, "f") - r(this, b, "f"), "f"), t.deviceManager.gfxDevice.copyTexImagesToTexture([r(this, U, "f").videoFrame], r(this, _, "f"), [r(this, m, "f")]), r(this, U, "f").videoFrame.close(), r(this, U, "f").isFirst) {
              const t = r(this, g, "f")[0];
              -1 === t ? (this.event.sendStart(), r(this, g, "f").shift()) : -2 === t ? (this.event.sendRepeat(), r(this, g, "f").shift()) : (this.event.sendNext(), n(this, v, 0, "f"));
