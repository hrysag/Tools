      ...
      (function (_UniTimeEffectFactory) {
        ...
        (function (_Node) {
          function moveTo(node, dest, duration, options = {}) {
            ...
            let startPos;
            const param = new (_crd && UniTask === void 0 ? (_reportPossibleCrUseOfUniTask({
              error: Error()
            }), UniTask) : UniTask)();
        ...
        (function (_Sprite) {
          function colorTo(sprite, color, duration, options = {}) {
            ...
            param.onUpdate = progress => {
              const easedProgress = (_crd && easeFunctions === void 0 ? (_reportPossibleCrUseOfeaseFunctions({
                error: Error()
...
//# sourceMappingURL=0bc252316cbe8002ddad93faaf42f2402d8b9043.js.map