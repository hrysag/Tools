System.register(["__unresolved_0", "cc", "cc/env", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, easing, v3, DEBUG, ReelEvent, ReelRoundState, ReelState, TweenEasingType, ReelBase, Movement, ComponentExt, _dec, _class, _crd, ccclass, property, IconReel;
  ...
  function _reportPossibleCrUseOfMovement(extras) {
    _reporterNs.report("Movement", "./Movement", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ReelBase = _unresolved_3.ReelBase;
    }, function (_unresolved_4) {
      Movement = _unresolved_4.Movement;
    }, function (_unresolved_5) {
      ComponentExt = _unresolved_5.ComponentExt;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "2dfd0LTrFNBG5zDDV/LQbzk", "IconReel", undefined);
      ...
      _export("IconReel", IconReel = (_dec = ccclass('IconReel'), _dec(_class = class IconReel extends (_crd && ReelBase === void 0 ? (_reportPossibleCrUseOfReelBase({
        ...
        startPullRollTween() {
          let movement = this.startPullIcon.getComponent(_crd && Movement === void 0 ? (_reportPossibleCrUseOfMovement({
            error: Error()
          }), Movement) : Movement);
        ...
        async bouncePromise(isBounceDown) {
          let promiseList = [];
        ...
        startBounceDownTween(index) {
          return new Promise((resolve, reject) => {
            ...
            let downEasing = (_crd && TweenEasingType === void 0 ? (_reportPossibleCrUseOfTweenEasingType({
              error: Error()
        ...
        startBounceUpTween(index) {
          return new Promise((resolve, reject) => {
            ...
            let upEasing = (_crd && TweenEasingType === void 0 ? (_reportPossibleCrUseOfTweenEasingType({
              error: Error()
        ...
        initIconMovement() {
          for (let i = 0; i < this.iconNodeList.length; i++) {
            let movement = this.iconNodeList[i].getComponent(_crd && Movement === void 0 ? (_reportPossibleCrUseOfMovement({
              error: Error()
            }), Movement) : Movement);
        ...
        initShowIcon(showIcons) {
          for (let index = 0; index < showIcons.length; index++) {
            let icon = (_crd && ComponentExt === void 0 ? (_reportPossibleCrUseOfComponentExt({
              error: Error()
            }), ComponentExt) : ComponentExt).getComp(showIcons[index], 'GameIcon');
            let isStartPull = index === 0;
...
//# sourceMappingURL=ac95e7bea81b5d79b2c72c36a131af533d179c4f.js.map