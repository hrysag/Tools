    ...
    execute: function () {
      ...
      _export("AbstractBasicGameController", AbstractBasicGameController = (_dec = ccclass('AbstractBasicGameController'), _dec2 = property({
        ...
        constructor(...args) {
          ...
          */
          this.onGameViewShowEndEventHandler = async () => {
        ...
        initBuyFeature() {
          ...
          let card = new (_crd && BuyFeatureCardInfo === void 0 ? (_reportPossibleCrUseOfBuyFeatureCardInfo({
            error: Error()
...
//# sourceMappingURL=c3944f406e44e0f78deb3b3a7c982ffffc0cd0e7.js.map