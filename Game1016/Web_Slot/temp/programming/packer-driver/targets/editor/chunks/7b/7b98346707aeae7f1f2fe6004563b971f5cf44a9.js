System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, sys, screen, CCBoolean, director, GameSetting, OrientationMode, WebViewH5, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, OrientationTip;
  ...
  function _reportPossibleCrUseOfGameSetting(extras) {
    _reporterNs.report("GameSetting", "../../GameScripts/Definition", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfWebViewH(extras) {
    _reporterNs.report("WebViewH5", "../WebView", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "d031ejc+pBEOImFeAuywxOb", "OrientationTip", undefined);
      ...
      _export("OrientationTip", OrientationTip = (_dec = ccclass('OrientationTip'), _dec2 = property(CCBoolean), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property({
        ...
        init(orientationMode = (_crd && OrientationMode === void 0 ? (_reportPossibleCrUseOfOrientationMode({
          error: Error()
          ...
          if (orientationMode === (_crd && OrientationMode === void 0 ? (_reportPossibleCrUseOfOrientationMode({
            ...
            if (currentOrientation === (_crd && OrientationMode === void 0 ? (_reportPossibleCrUseOfOrientationMode({
              ...
              (_crd && GameSetting === void 0 ? (_reportPossibleCrUseOfGameSetting({
                error: Error()
              }), GameSetting) : GameSetting).keyboardLock = true; //鎖定鍵盤輸入
            } else {
              this.tipToLandscape.active = false;
              this.setWebviewActive(true);
              (_crd && GameSetting === void 0 ? (_reportPossibleCrUseOfGameSetting({
                error: Error()
              }), GameSetting) : GameSetting).keyboardLock = false; //解鎖鍵盤輸入
            }
        ...
        isChangeOrientation(currentOrientation) {
          let isChange = this.lastOrientation !== currentOrientation;
        ...
        setWebviewActive(isActive, isChange = false) {
          if (!sys.isMobile) {
            return;
          }
...
//# sourceMappingURL=7b98346707aeae7f1f2fe6004563b971f5cf44a9.js.map