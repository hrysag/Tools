System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17", "__unresolved_18"], function (_export, _context) {
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GameRoot = _unresolved_19.GameRoot;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GameStart", GameStart = (_dec = ccclass('GameStart'), _dec2 = property(CCBoolean), _dec3 = property(JsonAsset), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(ProgressBar), _dec7 = property(Node), _dec8 = property(_crd && GameInfoUI === void 0 ? (_reportPossibleCrUseOfGameInfoUI({
        ...
        async startLoad() {
          try {
            ...
            this.showContinueBtn(); // 淡出 ApexWin Logo
        ...
        async loadScenePromise() {
          ...
          let gameRoot = director.getScene().getComponentInChildren(_crd && GameRoot === void 0 ? (_reportPossibleCrUseOfGameRoot({
            error: Error()
          }), GameRoot) : GameRoot);
          await gameRoot.init();
        }
...
//# sourceMappingURL=3b67ae63f763bf4b9ab3d0e2358cdeec267369eb.js.map