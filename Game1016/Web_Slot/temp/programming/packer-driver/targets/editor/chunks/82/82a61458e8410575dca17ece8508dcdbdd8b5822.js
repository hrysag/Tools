System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f262byF6DtD+IBS7URDjSgC", "SlotMachineData", undefined);
        ...
        updateEveryReelAllSymbolList() {
          for (let reelID = 0; reelID < this.everyReelAllSymbolList.length; reelID++) {
            ...
            if (this.noAppearSymbolList[reelID]) {
              this.everyReelAllSymbolList[reelID] = this.everyReelAllSymbolList[reelID].filter(symbolID => !this.noAppearSymbolList[reelID].includes(symbolID));
            }
          }
        }
...
//# sourceMappingURL=82a61458e8410575dca17ece8508dcdbdd8b5822.js.map