  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameControllerExample", GameControllerExample = (_dec = ccclass('GameControllerExample'), _dec2 = property({
        ...
        async startSpinPerformance(reelIDs) {
          (_crd && GenericUIManager === void 0 ? (_reportPossibleCrUseOfGenericUIManager({
            error: Error()
          ...
          if ((_crd && GenericUIManager === void 0 ? (_reportPossibleCrUseOfGenericUIManager({
            ...
            let awaitTime = (_crd && GenericUIManager === void 0 ? (_reportPossibleCrUseOfGenericUIManager({
              error: Error()
            }), GenericUIManager) : GenericUIManager).instance.isTurboOn ? this.processSetting.turboRoundSpaceTime : this.processSetting.normalRoundSpaceTime;
        ...
        async winPerformance(fakeData) {
          let awaitTime = (_crd && GenericUIManager === void 0 ? (_reportPossibleCrUseOfGenericUIManager({
            error: Error()
          }), GenericUIManager) : GenericUIManager).instance.isTurboOn ? this.processSetting.turboStopToPlayWinTime : this.processSetting.normalStopToPlayWinTime;
...
//# sourceMappingURL=05a87488428279d4e785cbe42c98d082fcf24ba0.js.map