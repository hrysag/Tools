System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Component, Label, Node, UIOpacity, UITransform, Widget, WebViewH5, Utility, RotationResize, ScreenAdapter, GenericSound, Orientation, AudioManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, InfoType, InfoUI;
    ...
    execute: function () {
      ...
      _export("InfoUI", InfoUI = (_dec = ccclass('InfoUI'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec(_class = (_class2 = class InfoUI extends Component {
        ...
        setURL(infoType, url) {
          ...
          let webview = webviewNode.getComponent(_crd && WebViewH5 === void 0 ? (_reportPossibleCrUseOfWebViewH({
            error: Error()
          }), WebViewH5) : WebViewH5);
          webview.init();
...
//# sourceMappingURL=805dcd62abcb62c62da1cdbcae38f03d2c62b8a4.js.map