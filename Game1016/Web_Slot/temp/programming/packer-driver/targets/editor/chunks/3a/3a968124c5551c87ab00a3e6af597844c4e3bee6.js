System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "cc/env"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, easing, tween, v3, Vec3, ReelBase, ComponentExt, ReelEvent, ReelRoundState, ReelState, TweenEasingType, DEBUG, _dec, _class, _crd, ccclass, property, GameReel;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ReelState = _unresolved_4.ReelState;
      TweenEasingType = _unresolved_4.TweenEasingType;
    }, function (_ccEnv) {
      DEBUG = _ccEnv.DEBUG;
    }],
    execute: function () {
      ...
      _cclegacy._RF.push({}, "34f697HvFhJMY7H9KEtba5W", "GameReel", undefined);
      ...
      _export("GameReel", GameReel = (_dec = ccclass('GameReel'), _dec(_class = class GameReel extends (_crd && ReelBase === void 0 ? (_reportPossibleCrUseOfReelBase({
        ...
        bounceUpTween() {
          ...
          let resultTween = tween(this._rootNode).by(duration, {
...
//# sourceMappingURL=3a968124c5551c87ab00a3e6af597844c4e3bee6.js.map