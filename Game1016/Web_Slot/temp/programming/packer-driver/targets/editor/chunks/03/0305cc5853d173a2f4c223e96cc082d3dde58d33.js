System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfGameTimeScale(extras) {
    _reporterNs.report("GameTimeScale", "./GameTimeScale", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _export("SpineTimeScaleTuner", SpineTimeScaleTuner = (_dec = ccclass('SpineTimeScaleTuner'), _dec2 = property(CCString), _dec(_class = (_class2 = class SpineTimeScaleTuner extends Component {
        ...
        tuneAnimationByTimeScale(gameTimeScale = (_crd && GameTimeScale === void 0 ? (_reportPossibleCrUseOfGameTimeScale({
          error: Error()
          ...
          if (this.spineSkeletons) {
            ...
            let tracks = (_this$spineSkeletons$ = this.spineSkeletons.getState()) == null ? void 0 : _this$spineSkeletons$.tracks;
...
//# sourceMappingURL=0305cc5853d173a2f4c223e96cc082d3dde58d33.js.map