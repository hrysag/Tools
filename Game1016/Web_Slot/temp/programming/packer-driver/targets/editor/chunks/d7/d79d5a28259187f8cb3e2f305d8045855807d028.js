  ...
  return {
    ...
    execute: function () {
      ...
      _export("GenericUIManager", GenericUIManager = (_dec = ccclass('GenericUIManager'), _dec2 = property(_crd && GenericUIRes === void 0 ? (_reportPossibleCrUseOfGenericUIRes({
        ...
        hasAutoNext(context) {
          // 滿足任一停止自動 spin 條件
          let isMeetsAnyStopCondition = context ? this.autoSpinUI.isMeetsAnyStopCondition(context) : false; // 下一局是否還可以Auto
...
//# sourceMappingURL=d79d5a28259187f8cb3e2f305d8045855807d028.js.map