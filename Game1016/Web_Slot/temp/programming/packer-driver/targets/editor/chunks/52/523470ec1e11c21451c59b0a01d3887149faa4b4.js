System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, SpriteFrame, GenericUIManager, BuyFeatureCardInfo, PlayerInfo, GameSetting, SlotRelayLang, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _crd, ccclass, property, ZGenericUISceneTest;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      BuyFeatureCardInfo = _unresolved_3.BuyFeatureCardInfo;
    }, function (_unresolved_4) {
      PlayerInfo = _unresolved_4.PlayerInfo;
    }, function (_unresolved_5) {
      GameSetting = _unresolved_5.GameSetting;
      SlotRelayLang = _unresolved_5.SlotRelayLang;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("ZGenericUISceneTest", ZGenericUISceneTest = (_dec = ccclass('ZGenericUISceneTest'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(SpriteFrame), _dec5 = property(Node), _dec6 = property(SpriteFrame), _dec7 = property(SpriteFrame), _dec8 = property(SpriteFrame), _dec9 = property(SpriteFrame), _dec10 = property(SpriteFrame), _dec11 = property(SpriteFrame), _dec12 = property(SpriteFrame), _dec13 = property(SpriteFrame), _dec(_class = (_class2 = class ZGenericUISceneTest extends Component {
        ...
        start() {
          ...
          let cardInfo0 = new (_crd && BuyFeatureCardInfo === void 0 ? (_reportPossibleCrUseOfBuyFeatureCardInfo({
            error: Error()
          ...
          let cardInfo1 = new (_crd && BuyFeatureCardInfo === void 0 ? (_reportPossibleCrUseOfBuyFeatureCardInfo({
            error: Error()
          }), BuyFeatureCardInfo) : BuyFeatureCardInfo)();
          ...
          let cardInfo2 = new (_crd && BuyFeatureCardInfo === void 0 ? (_reportPossibleCrUseOfBuyFeatureCardInfo({
            error: Error()
          }), BuyFeatureCardInfo) : BuyFeatureCardInfo)();
          ...
          let cardInfo3 = new (_crd && BuyFeatureCardInfo === void 0 ? (_reportPossibleCrUseOfBuyFeatureCardInfo({
            error: Error()
          }), BuyFeatureCardInfo) : BuyFeatureCardInfo)();
          ...
          let cardInfo4 = new (_crd && BuyFeatureCardInfo === void 0 ? (_reportPossibleCrUseOfBuyFeatureCardInfo({
            error: Error()
          }), BuyFeatureCardInfo) : BuyFeatureCardInfo)();
...
//# sourceMappingURL=523470ec1e11c21451c59b0a01d3887149faa4b4.js.map