System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, AudioClip, AudioSource, Component, KeyCode, Node, randomRangeInt, WinSingle, WinType, Debug, Utility, GameTimeScale, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _crd, ccclass, property, WinScoreSound, ShowWin;
  ...
  function _reportPossibleCrUseOfGameTimeScale(extras) {
    _reporterNs.report("GameTimeScale", "db://assets/Scripts/Utils/GameTimeScale", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GameTimeScale = _unresolved_6.GameTimeScale;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("ShowWin", ShowWin = (_dec = ccclass('ShowWin'), _dec2 = property(_crd && WinSingle === void 0 ? (_reportPossibleCrUseOfWinSingle({
        ...
        showSpecialWin(odds, totalBet, needShowEpic = false) {
          return new Promise((resolve, reject) => {
            (_crd && GameTimeScale === void 0 ? (_reportPossibleCrUseOfGameTimeScale({
              error: Error()
            }), GameTimeScale) : GameTimeScale).forceResetTimeScaleStart();
            let type = (_crd && WinType === void 0 ? (_reportPossibleCrUseOfWinType({
              error: Error()
        ...
        showWin(type, score, onEnd = null) {
          ...
          this.currentWin.showWin(score, scoreRunDuration, idleLoopDuration, this.onScoreRunEnd.bind(this), () => {
            ...
            (_crd && GameTimeScale === void 0 ? (_reportPossibleCrUseOfGameTimeScale({
              error: Error()
            }), GameTimeScale) : GameTimeScale).forceResetTimeScaleEnd();
            onEnd == null || onEnd();
          });
        }
...
//# sourceMappingURL=b72e0e869242f2460c094cbd7955f1eb13e44e2d.js.map