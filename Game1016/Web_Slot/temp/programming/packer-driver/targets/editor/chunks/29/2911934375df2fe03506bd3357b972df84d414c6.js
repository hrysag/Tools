  ...
  return {
    ...
    execute: function () {
      ...
      _export("BmfAdditiveLabel", BmfAdditiveLabel = (_dec = ccclass('BmfAdditiveLabel'), _dec2 = property({
        ...
        _flushAssembler() {
          const assembler = this.font instanceof BitmapFont && this._isAdditive ? _crd && bmfAdditiveAssembler === void 0 ? (_reportPossibleCrUseOfbmfAdditiveAssembler({
            error: Error()
...
//# sourceMappingURL=2911934375df2fe03506bd3357b972df84d414c6.js.map