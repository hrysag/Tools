System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17", "__unresolved_18", "__unresolved_19", "__unresolved_20"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, math, view, Debug, MainUI, NewFlashModeEnum, MenuUI, BetSelectUI, AUTO_INFINITY_NUMBER, AutoSpinSelectUI, BottomBarUI, GenericUIRes, InfoType, InfoUI, MainUIBtnState, AudioManager, BuyFeatureMode, GenericSound, Orientation, SlotRelayLang, Localization, HistoryUI, FeatureSettingUI, BuyFeatureInfoUI, GameStatus, RotationContentResize, AdaptWindowSize, ScreenAdapter, PlayerInfo, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _class3, _crd, ccclass, property, GenericUIManager;
  ...
  function _reportPossibleCrUseOfBuyFeatureMode(extras) {
    _reporterNs.report("BuyFeatureMode", "../../Scripts/Utils/Config", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfGameStatus(extras) {
    _reporterNs.report("GameStatus", "../../Scripts/GameScripts/GameSetting", _context.meta, extras);
  }

  function _reportPossibleCrUseOfRotationContentResize(extras) {
    _reporterNs.report("RotationContentResize", "../../Scripts/Utils/RotationContentResize", _context.meta, extras);
  }

  function _reportPossibleCrUseOfAdaptWindowSize(extras) {
    _reporterNs.report("AdaptWindowSize", "../../Scripts/Utils/AdaptWindowSize", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GameStatus = _unresolved_17.GameStatus;
    }, function (_unresolved_18) {
      RotationContentResize = _unresolved_18.RotationContentResize;
    }, function (_unresolved_19) {
      AdaptWindowSize = _unresolved_19.AdaptWindowSize;
    }, function (_unresolved_20) {
      ScreenAdapter = _unresolved_20.ScreenAdapter;
    }, function (_unresolved_21) {
      PlayerInfo = _unresolved_21.PlayerInfo;
    }],
    execute: function () {
      _crd = true;
      ...
      __checkObsolete__(['_decorator', 'Canvas', 'Color', 'Component', 'director', 'math', 'Node', 'SpriteFrame', 'view', 'Widget']);
      ...
      _export("GenericUIManager", GenericUIManager = (_dec = ccclass('GenericUIManager'), _dec2 = property(_crd && GenericUIRes === void 0 ? (_reportPossibleCrUseOfGenericUIRes({
        ...
        error: Error()
      }), HistoryUI) : HistoryUI), _dec10 = property(_crd && FeatureSettingUI === void 0 ? (_reportPossibleCrUseOfFeatureSettingUI({
        error: Error()
      }), FeatureSettingUI) : FeatureSettingUI), _dec11 = property(_crd && BuyFeatureInfoUI === void 0 ? (_reportPossibleCrUseOfBuyFeatureInfoUI({
        error: Error()
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "featureSettingUI", _descriptor9, this);

          _initializerDefineProperty(this, "buyFeatureInfoUI", _descriptor10, this);
        ...
        */
        ...
        setBetSelectUIBetValue(betValue) {
          let betIndex = (_crd && PlayerInfo === void 0 ? (_reportPossibleCrUseOfPlayerInfo({
            error: Error()
        ...
        setAutoResize(isOn) {
          if (isOn) {
            const rotationContentResize = this.getComponent(_crd && RotationContentResize === void 0 ? (_reportPossibleCrUseOfRotationContentResize({
              error: Error()
            ...
            let adaptWindowSize = this.node.getComponent(_crd && AdaptWindowSize === void 0 ? (_reportPossibleCrUseOfAdaptWindowSize({
              error: Error()
            ...
            const adaptWindowSize = this.getComponent(_crd && AdaptWindowSize === void 0 ? (_reportPossibleCrUseOfAdaptWindowSize({
              error: Error()
            }), AdaptWindowSize) : AdaptWindowSize);
            ...
            let rotationContentResize = this.node.getComponent(_crd && RotationContentResize === void 0 ? (_reportPossibleCrUseOfRotationContentResize({
              error: Error()
            }), RotationContentResize) : RotationContentResize);

            if (rotationContentResize === null) {
              rotationContentResize = this.node.addComponent(_crd && RotationContentResize === void 0 ? (_reportPossibleCrUseOfRotationContentResize({
                error: Error()
              }), RotationContentResize) : RotationContentResize);
            }
            ...
            rotationContentResize.onRotationResize((_crd && ScreenAdapter === void 0 ? (_reportPossibleCrUseOfScreenAdapter({
              error: Error()
            }), ScreenAdapter) : ScreenAdapter).UI_Orientation);
          }
        }
        ...
        writable: true,
        initializer: null
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "featureSettingUI", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "buyFeatureInfoUI", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=d73d2fa02f7b19653ecfe053a7ffe2e30796d540.js.map