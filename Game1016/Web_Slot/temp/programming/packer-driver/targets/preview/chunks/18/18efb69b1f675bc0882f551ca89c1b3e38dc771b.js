System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "cc/env", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  "use strict";

  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, ResolutionPolicy, screen, view, director, Enum, Canvas, RotationResize, RotationContentResize, EDITOR, AutoOrientation, IWindowResize, Debug, OrientationTip, Orientation, OrientationMode, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _class3, _crd, ccclass, property, DESIGN_WIDTH, DESIGN_HEIGHT, ResolutionPolicyValue, ScreenAdapter;
  ...
  function _reportPossibleCrUseOfOrientationTip(extras) {
    _reporterNs.report("OrientationTip", "./OrientationTip", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfOrientationMode(extras) {
    _reporterNs.report("OrientationMode", "../../GameScripts/Definition", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      RotationContentResize = _unresolved_3.RotationContentResize;
    }, function (_ccEnv) {
      EDITOR = _ccEnv.EDITOR;
    }, function (_unresolved_4) {
      AutoOrientation = _unresolved_4.AutoOrientation;
    }, function (_unresolved_5) {
      IWindowResize = _unresolved_5.IWindowResize;
    }, function (_unresolved_6) {
      Debug = _unresolved_6.Debug;
    }, function (_unresolved_7) {
      OrientationTip = _unresolved_7.OrientationTip;
    }, function (_unresolved_8) {
      Orientation = _unresolved_8.Orientation;
      OrientationMode = _unresolved_8.OrientationMode;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("ScreenAdapter", ScreenAdapter = (_dec = ccclass('ScreenAdapter'), _dec2 = property({
        ...
        start() {
          var canvasResizeEvent = 'canvas-resize';
          (_crd && Debug === void 0 ? (_reportPossibleCrUseOfDebug({
            error: Error()
          ...
          var canvases = director.getScene().getComponentsInChildren(Canvas);
        ...
        resetDesignResolution(windowWidth, windowHeight) {
          ...
          var resizeComponents = director.getScene().getComponentsInChildren(_crd && RotationResize === void 0 ? (_reportPossibleCrUseOfRotationResize({
            error: Error()
          }), RotationResize) : RotationResize);

          for (var item of resizeComponents) {
          ...
          var resizeContent = director.getScene().getComponentsInChildren(_crd && RotationContentResize === void 0 ? (_reportPossibleCrUseOfRotationContentResize({
            error: Error()
          }), RotationContentResize) : RotationContentResize);

          for (var _item of resizeContent) {
            _item.onRotationResize(ScreenAdapter.UI_Orientation);
          }

          var windowResizeComponents = this.getComponentsInChildren(_crd && IWindowResize === void 0 ? (_reportPossibleCrUseOfIWindowResize({
            error: Error()
          }), IWindowResize) : IWindowResize);

          for (var _item2 of windowResizeComponents) {
            _item2.onWindowResize(ScreenAdapter.UI_Orientation);
          }

          for (var _item3 of this.autoOrientations) {
            _item3.onResize(ScreenAdapter.UI_Orientation);
          }
...
//# sourceMappingURL=18efb69b1f675bc0882f551ca89c1b3e38dc771b.js.map