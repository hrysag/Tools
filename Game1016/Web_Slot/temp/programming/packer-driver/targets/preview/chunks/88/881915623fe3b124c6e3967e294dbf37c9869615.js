      ...
      _export("BottomBarUI", BottomBarUI = (_dec = ccclass('BottomBarUI'), _dec2 = property(RichText), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec(_class = (_class2 = class BottomBarUI extends Component {
        constructor() {
          ...
          this.showWinScore = score => {
            var originalActive = this.winGroup.active;
        ...
        showBottomTextGaming() {
          this.setTipActive();
          var len = this.bottomGamingShowTexts.length;
        ...
        showBottomTextIdle() {
          this.setTipActive();
          var len = this.bottomIdleShowTexts.length;
          var id = (_crd && Utility === void 0 ? (_reportPossibleCrUseOfUtility({
            error: Error()
          }), Utility) : Utility).getRandomInt(len);
        ...
        setDebugText(text) {
          for (var label of this.debugLabels) {
            label.string = text;
          }
        }

        setVersionText(text) {
          for (var label of this.versionLabels) {
            label.string = text;
          }
        }

        setLogoText(text) {
          for (var label of this.logoLabels) {
            label.string = text;
          }
        }
        ...
        setTipText(text, tipMode) {
          ...
          var tipTransform = this.tipRichText.getComponent(UITransform);

          if (tipTransform.width <= TIP_WIDTH) {
            this.tipRichText.node.scale = Vec3.ONE;
          } else {
            var scaleNum = TIP_WIDTH / tipTransform.width;
        ...
        setTipTextWithKey(textKey, tipMode) {
          var text = (_crd && Localization === void 0 ? (_reportPossibleCrUseOfLocalization({
            error: Error()
...
//# sourceMappingURL=881915623fe3b124c6e3967e294dbf37c9869615.js.map