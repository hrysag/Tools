System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, CCFloat, CCInteger, Enum, randomRangeInt, PublicReelConfigTest, UniDropSlotMachineExample, GameController, GenericUIManager, Utility, FillIconData, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class2, _class3, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, NORMAL_SYMBOLS_LIST, MAGNIFICATION_SYMBOLS_LIST, ICON_AMOUNT, REEL_AMOUNT, SlotType, UniDropReelGameControllerTest;
  ...
  function _reportPossibleCrUseOfPublicReelConfigTest(extras) {
    _reporterNs.report("PublicReelConfigTest", "../../../../v2/deprecation/Example/Scripts/PublicReelConfigTest", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      UniDropSlotMachineExample = _unresolved_3.UniDropSlotMachineExample;
        ...
        startSpin(reelIDs) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (_this2.slotType === SlotType.Drop) {
              console.log(_this2.defaultDropIconIdList);
...
//# sourceMappingURL=3ecb0f9de1b853a54343f816dbb8e22d0b240818.js.map