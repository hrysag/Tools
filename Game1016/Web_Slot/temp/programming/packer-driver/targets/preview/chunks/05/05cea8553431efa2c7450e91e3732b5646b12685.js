System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfGameStatus(extras) {
    _reporterNs.report("GameStatus", "./GameSetting", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GameStatus = _unresolved_16.GameStatus;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GameRoot", GameRoot = (_dec = ccclass('GameRoot'), _dec2 = requireComponent(_crd && AudioResource === void 0 ? (_reportPossibleCrUseOfAudioResource({
        ...
        onLoad() {
          ...
          if (true) {
            ...
            var fps = (_this$gameConfig$json2 = this.gameConfig.json.mobileFPS) != null ? _this$gameConfig$json2 : 61;
            game.frameRate = fps;
          }
        }
        ...
        init() {
          return new Promise(resolve => {
            var genericUI = instantiate(this.genericUIPrefab);
            ...
            if (director.getScene().getComponentInChildren(_crd && MessageBox === void 0 ? (_reportPossibleCrUseOfMessageBox({
              ...
              var messageBox = instantiate(this.messageBoxPrefab);
            ...
            Promise.all([(_crd && Localization === void 0 ? (_reportPossibleCrUseOfLocalization({
              ...
              (_crd && GenericUIManager === void 0 ? (_reportPossibleCrUseOfGenericUIManager({
                ...
                error: Error()
              }), Localization) : Localization).instance.currentLangKey, this.canvasNode);
              ...
              var payTableURL = (_crd && Utility === void 0 ? (_reportPossibleCrUseOfUtility({
                error: Error()
              }), Utility) : Utility).getPayTableURL(this.gameID, this.getLanguage());
              var ruleURL = (_crd && Utility === void 0 ? (_reportPossibleCrUseOfUtility({
                error: Error()
              ...
              if ((_crd && NetworkHandler === void 0 ? (_reportPossibleCrUseOfNetworkHandler({
                error: Error()
              }), NetworkHandler) : NetworkHandler).instance.isLogin && (_crd && NetworkHandler === void 0 ? (_reportPossibleCrUseOfNetworkHandler({
                error: Error()
              }), NetworkHandler) : NetworkHandler).instance.demo && (_crd && NetworkHandler === void 0 ? (_reportPossibleCrUseOfNetworkHandler({
                error: Error()
              ...
              */
              ...
              var platform = (_crd && NetworkHandler === void 0 ? (_reportPossibleCrUseOfNetworkHandler({
                error: Error()
        ...
        onGenericUIMenuUIShow() {
          ...
          var historyJsonString = (_crd && PlayerInfo === void 0 ? (_reportPossibleCrUseOfPlayerInfo({
            error: Error()
          }), PlayerInfo) : PlayerInfo).getHistoryJson(this.gameID);
          var historyURL = (_crd && Utility === void 0 ? (_reportPossibleCrUseOfUtility({
            error: Error()
        ...
        showCanvas() {
          ...
          var messageBoxNode = director.getScene().getComponentInChildren(_crd && MessageBox === void 0 ? (_reportPossibleCrUseOfMessageBox({
            error: Error()
        ...
        forceChangeLanguage(lang) {
          var langStr = (_crd && SlotRelayLang === void 0 ? (_reportPossibleCrUseOfSlotRelayLang({
            error: Error()
...
//# sourceMappingURL=05cea8553431efa2c7450e91e3732b5646b12685.js.map