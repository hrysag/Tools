      ...
      _export("CustomTestButton", CustomTestButton = (_dec = ccclass('CustomTestButton'), _dec2 = property({
        ...
        set runFunction(value) {
          if (this._targetComponent) {
            var targetFunction = this._targetComponent[this.functionName];

            if (targetFunction) {
              var jsonString = ("[" + this.functionArgs.join(',') + "]").replace(/'/g, '"');
...
//# sourceMappingURL=c344d778c215a7d5f2427942702e53acc902512d.js.map