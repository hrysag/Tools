    ...
    execute: function () {
      ...
      _export("UnitTestComponent", UnitTestComponent = (_dec = ccclass('UnitTestComponent'), _dec2 = property({
        ...
        onLoad() {
          ...
          var components = this.node.components.filter(component => component !== this);
          components.forEach(component => {
             ...
             * 但如果不把這個腳本掛到場景上就沒事
            */
            var newUnit = new (_crd && TestScriptUnit === void 0 ? (_reportPossibleCrUseOfTestScriptUnit({
              error: Error()
            }), TestScriptUnit) : TestScriptUnit)();
...
//# sourceMappingURL=2a5ec81cfcc69a74baa7894c67c240ecc3b1a2aa.js.map