      ...
      _export("SimpleLineSprite", SimpleLineSprite = (_dec = ccclass('SimpleLineSprite'), _dec2 = property({
        ...
        */
        ...
        calculateExtendedPoints(previousPoint, currentPoint, nextPoint) {
          ...
          var previousPerpendicular = this._previousRadian - RADIAN_OFFSET;
          var nextPerpendicular = this._nextRadian - RADIAN_OFFSET; // 計算延伸點
          ...
          var top = this.findIntersection(previousPoints.top, this._previousRadian, nextPoints.top, this._nextRadian + Math.PI);
          var bottom = this.findIntersection(previousPoints.bottom, this._previousRadian + Math.PI, nextPoints.bottom, this._nextRadian);
...
//# sourceMappingURL=6079b7cf25f96c781427ad260afc9d685da78799.js.map