System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfLocalizationLabel(extras) {
    _reporterNs.report("LocalizationLabel", "../../Localization", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      NumberSelectBtn = _unresolved_2.NumberSelectBtn;
    ...
    execute: function () {
      ...
      _export("BetSelectUI", BetSelectUI = (_dec = ccclass('BetSelectUI'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class BetSelectUI extends Component {
        ...
        setInfos(betValues) {
          ...
          for (var _i = 0; _i < this.betValues.length; _i++) {
            if (_i >= BTN_LENGTH) {
            ...
            this.numberSelectBtn[_i].node.active = true;

            this.numberSelectBtn[_i].getComponent(_crd && NumberSelectBtn === void 0 ? (_reportPossibleCrUseOfNumberSelectBtn({
              error: Error()
            }), NumberSelectBtn) : NumberSelectBtn).init();

            this.numberSelectBtn[_i].getComponent(_crd && NumberSelectBtn === void 0 ? (_reportPossibleCrUseOfNumberSelectBtn({
              error: Error()
            }), NumberSelectBtn) : NumberSelectBtn).setLabel(this.betValues[_i].numberComma());
          }
        }
        ...
        showUI() {
          ...
          var activeCnt = this.numberSelectBtn.filter(v => v.node.active).length; // 如果24個按鈕，就縮小按鈕高度從70到60
          ...
          for (var item of this.numberSelectBtn) {
...
//# sourceMappingURL=c2f8f51bcd6809db63419fa3bddfcfe81fbaaf09.js.map