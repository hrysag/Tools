  ...
  return {
    ...
    execute: function () {
      ...
      _export("FeatherRTHelper", FeatherRTHelper = (_dec = ccclass('FeatherRTHelper'), _dec2 = property({
        ...
        createCanvas() {
          var canvasNode = new Node("FeatherCanvas");
          this.canvas = canvasNode.addComponent(Canvas);
        }

        createCamera() {
          var cameraNode = new Node("FeatherCamera");
        ...
        alignCameraSetting() {
          var featherSize = this.getFeatherObjectSize();
        ...
        createRenderTexture() {
          if (this.isUsedCustomRenderTexture) {
            ...
            var size = this.getFeatherObjectSize();
        ...
        fitCameraToTargetSize(targetWidth, targetHeight) {
          var aspect = this.camera.camera.aspect;
          var targetAspect = targetWidth / targetHeight;

          if (aspect > targetAspect) {
            return targetHeight / 2; // camera 比例相對較寬，直接以高度為基準計算高度
          } else {
            var visibleHeight = targetWidth / aspect;
...
//# sourceMappingURL=f3a494aef2c285bfa3b2571052ac69778635f779.js.map