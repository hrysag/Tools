    ...
    execute: function () {
      ...
      _export("RespinBoardController", RespinBoardController = (_dec = ccclass('RespinBoardController'), _dec2 = property({
        ...
        setReSpinTimes(count) {
          var index = count == 2 ? 0 : 1;
          this._fakeLabelSprite.spriteFrame = this._numberSpriteFrames[index]; //this._label.string = count.numberComma();
        }

        openWithEvtAndFinishPromise(evtCallBack) {
          var _this = this;

          return _asyncToGenerator(function* () {
            var duringBoardTime = (_crd && GlobalAccessReader === void 0 ? (_reportPossibleCrUseOfGlobalAccessReader({
              error: Error()
            ...
            _this._animationController.changeSpeedWithAep({
            ...
            var h = _this.playAniAsCancelable({
              aniState: ANI_SHOWUP_NAME
            }, evtCallBack);
            ...
            var task = _this._async.registerCancelablePromise(SIGNAL_KEY, h.promise, callbackWrapper, signal, SIGNAL_KEY);
            /*
...
//# sourceMappingURL=59c9182b2c44fb85d1225f40a050f453bb6a014e.js.map