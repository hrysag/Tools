    ...
    execute: function () {
      ...
      _export("AniBuilderMediator", AniBuilderMediator = class AniBuilderMediator {
        ...
        requestNodeByInput(inp) {
          var playData = this.buildPlayData(inp);
          var poolKey = playData.prefabKey;

          var instance = this._pool.getInstantiatedObjFromPool(poolKey);
        ...
        requestNodeByKey(key) {
          ...
          return _asyncToGenerator(function* () {
            ...
            var asInput = key;
            return _this.requestNodeByInput(asInput);
          })();
        }
        /** （可選）只產資料不取節點，提供需要的人用 */
        //-T=IProcessInput
...
//# sourceMappingURL=8e3ef39375b2a733d26376effacb74b5bc8d4e7c.js.map