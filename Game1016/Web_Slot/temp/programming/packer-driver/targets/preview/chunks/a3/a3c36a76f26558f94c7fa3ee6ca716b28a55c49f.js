    ...
    execute: function () {
      ...
      _export("ResizeHandler", ResizeHandler = class ResizeHandler {
        ...
        applyMultiResize(target, resizeStateList, currentContainer) {
          for (var stateInfo of resizeStateList.stateInfo) {
            var action = this._resizeActionMap[stateInfo.resizeStateType];
        ...
        doSwitchUITransform(target, currentContainer) {
          if (target && currentContainer) {
            ...
            var currentUITransform = currentContainer.getComponent(UITransform);
        ...
        doSetCustomUITransform(target, custom) {
          if (target) {
            // Perform UI transform on the target node
            var targetUITransform = custom.customChangeUITransformTarget.getComponent(UITransform);
...
//# sourceMappingURL=a3c36a76f26558f94c7fa3ee6ca716b28a55c49f.js.map