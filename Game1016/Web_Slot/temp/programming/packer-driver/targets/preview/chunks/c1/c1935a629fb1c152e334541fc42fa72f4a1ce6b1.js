System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Component, Label, Node, Sprite, Toggle, UIOpacity, UITransform, Widget, Utility, GameStatus, LocalizationButton, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _crd, ccclass, property, FeatureSettingUI;
  ...
  function _reportPossibleCrUseOfLocalizationButton(extras) {
    _reporterNs.report("LocalizationButton", "../../Scripts/GameScripts/LocalizationButton", _context.meta, extras);
  }
    ...
    execute: function () {
      ...
      _export("FeatureSettingUI", FeatureSettingUI = (_dec = ccclass('FeatureSettingUI'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(UIOpacity), _dec6 = property(Node), _dec7 = property(Sprite), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(UITransform), _dec11 = property(Label), _dec12 = property(Node), _dec13 = property(Widget), _dec14 = property(Widget), _dec15 = property(Widget), _dec16 = property(Widget), _dec(_class = (_class2 = class FeatureSettingUI extends Component {
        ...
        setBuyBonusBtnInteractable(b) {
          ...
          var uiOpacity = this.buyBonusBtn.getComponent(UIOpacity);
        ...
        setExtraBetToggleInteractable(b) {
          ...
          var uiOpacity = this.extraBetToggle.getComponent(UIOpacity);
        ...
        setBuyBonusIconInteractable(b) {
          var uiOpacity = this.buyBonusIcon.getComponent(UIOpacity);
        ...
        showExtraBetTip() {
          ...
          this.scheduleOnce(() => {
            ...
            var labelHeight = this.extraBetTipLabel.getComponent(UITransform).height;
        ...
        setBuyBonusBtnCustomSprite(normalSpriteBG, pressedSpriteBG, hoverSpriteBG, disabledSpriteBG, normalSpriteCrown, pressedSpriteCrown, hoverSpriteCrown, disabledSpriteCrown, textPath) {
          var buttonComponents = this.buyBonusBtn.getComponents(Button);
          var buttonBG = buttonComponents[1];
          var buttonCrown = buttonComponents[2];
          ...
          var textLocalization = this.buyBonusBtn.getComponent(_crd && LocalizationButton === void 0 ? (_reportPossibleCrUseOfLocalizationButton({
            error: Error()
...
//# sourceMappingURL=c1935a629fb1c152e334541fc42fa72f4a1ce6b1.js.map