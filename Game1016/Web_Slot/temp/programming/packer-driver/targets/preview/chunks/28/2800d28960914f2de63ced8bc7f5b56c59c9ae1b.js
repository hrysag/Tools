System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "44540OfoBdCl5FGVikrEDiM", "Movement", undefined);
      ...
      _export("Movement", Movement = (_dec = ccclass('Movement'), _dec(_class = class Movement extends Component {
        ...
        moveTo(dest, duration, isLocal, ease) {
          if (isLocal === void 0) {
            isLocal = true;
          }
          ...
          var newDuration = this.calculateDuration(duration);
          var targetPos = dest.clone();
        ...
        moveBy(delta, duration, isLocal, ease) {
          if (isLocal === void 0) {
            isLocal = true;
          }
        ...
        moveFrom(from, dest, duration, isLocal, ease) {
          if (isLocal === void 0) {
            isLocal = true;
          }
        ...
        addCallback(callback) {
          this.append(tween(this.node).call(() => {
            callback();
          }));
          return this;
        }
        ...
        calculateDuration(duration) {
          var updateCount = Math.floor(duration / game.frameTime * 1000) + 1;
          var newDuration = game.frameTime * updateCount / 1000;
...
//# sourceMappingURL=2800d28960914f2de63ced8bc7f5b56c59c9ae1b.js.map