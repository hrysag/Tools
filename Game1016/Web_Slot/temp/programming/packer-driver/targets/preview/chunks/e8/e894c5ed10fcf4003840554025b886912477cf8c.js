  ...
  return {
    ...
    execute: function () {
      ...
      _export("UniDropSlotMachine", UniDropSlotMachine = (_dec = ccclass('UniDropSlotMachine'), _dec2 = property({
         ...
         */
        startDropOut(isTurboMode, dropOutIdList) {
          var _this = this;
          ...
          return _asyncToGenerator(function* () {
            ...
            yield _this._dropReelView.startDropOut(dropOutIdList);
          })();
        }
        /**
        ...
        startDropIn(dropInIdList, resultData) {
          ...
          return _asyncToGenerator(function* () {
            ...
            yield _this2._dropReelView.startDropIn(dropInIdList, _this2._iconResultData);
          })();
        }
        /**
         * 補盤方法，資料由實作層設定好傳入
        ...
        startDropRefill(removeIdList, resultData) {
          ...
          return _asyncToGenerator(function* () {
            ...
            yield _this3._dropReelView.startDropRefill(removeIdList, _this3._iconResultData);
          })();
        }
...
//# sourceMappingURL=e894c5ed10fcf4003840554025b886912477cf8c.js.map