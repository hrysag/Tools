System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, BoardAnalysis, EliminationWinScoreAnalyzerTest, ClientData, TestConfig, _class2, _crd, EliminationWinScoreAnalyzer;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "a3d44BPhbZCn4MW555sCofK", "EliminationWinScoreAnalyzerTest", undefined);

      EliminationWinScoreAnalyzer = (_crd && BoardAnalysis === void 0 ? (_reportPossibleCrUseOfBoardAnalysis({
        error: Error()
      }), BoardAnalysis) : BoardAnalysis).EliminationWinScoreAnalyzer;

      _export("EliminationWinScoreAnalyzerTest", EliminationWinScoreAnalyzerTest = class EliminationWinScoreAnalyzerTest extends EliminationWinScoreAnalyzer {
        /**
         * 建構子
         */
        constructor() {
        ...
        getWinData(iconList) {
          ...
          var winPos = [];
          var dataList = [];
          var winData = this.getEliminationWinData(iconList, TestConfig.REEL_AMOUNT, TestConfig.SYMBOL_LENGTH, TestConfig.WILD_LIST);
...
//# sourceMappingURL=95d842be62b6519ac308c1fc0614372015b29e67.js.map