System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, CCInteger, Label, Node, UniReelView, SymbolNumber, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, UniReelViewExample;
  ...
  function _reportPossibleCrUseOfUniReelView(extras) {
    _reporterNs.report("UniReelView", "db://assets/Scripts/ReelTemplate/ReelTemplate_3", _context.meta, extras);
  }

  function _reportPossibleCrUseOfUniReelTempo(extras) {
    _reporterNs.report("UniReelTempo", "./UniReelTempo", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "fd483WuAohH/5FzSfOuGyyx", "UniReelViewTempo", undefined);

      __checkObsolete__(['_decorator', 'CCInteger', 'Component', 'Label', 'Node']);
      ...
      _export("UniReelViewExample", UniReelViewExample = (_dec = ccclass('UniReelViewExample'), _dec2 = property(Node), _dec3 = property({
        type: CCInteger,
        tooltip: '隨機資料長度，數值越大滾輪間隔停止越久'
      }), _dec4 = property({
        type: CCInteger,
        tooltip: '聽牌的隨機資料長度，數值越大滾輪間隔停止越久'
      }), _dec5 = property(Label), _dec6 = property(Label), _dec(_class = (_class2 = class UniReelViewExample extends (_crd && UniReelView === void 0 ? (_reportPossibleCrUseOfUniReelView({
        error: Error()
...
//# sourceMappingURL=50adac753dfcdd2784acf33c3e2173733184ee1b.js.map