System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, NetConst, ArrayUtil, BinaryBufferWriter, BinaryBuffer, _crd;
    ...
    execute: function () {
      ...
      _export("BinaryBuffer", BinaryBuffer = class BinaryBuffer {
        ...
        getBytesRanged(iStartPos, iLength) {
          ...
          var dataView = new BinaryBuffer(this.m_Buffer.slice(iStartPos, iStartPos + iLength));
          return dataView;
        }
        /**
        ...
        getBytes(iLength) {
          ...
          var dataView = new BinaryBuffer(this.m_Buffer.slice(this.m_nReadIndex, this.m_nReadIndex + iLength));
          this.m_nReadIndex += iLength;
          return dataView;
        ...
        getString_MegaSize() {
          var ret = this.getPositiveNumber((_crd && NetConst === void 0 ? (_reportPossibleCrUseOfNetConst({
            error: Error()
        ...
        GetBinaryBuffer(arrTemp) {
          var binaryBufferWriter = new (_crd && BinaryBufferWriter === void 0 ? (_reportPossibleCrUseOfBinaryBufferWriter({
            error: Error()
          ...
          var data = new BinaryBuffer(arrayBuffer);
          return data;
        }
...
//# sourceMappingURL=e4a499f719aa81ea7418321768271a5f3830a93e.js.map