    ...
    execute: function () {
      ...
      _export("TestScriptUnit", TestScriptUnit = (_dec = ccclass('TestScriptUnit'), _dec2 = property({
        ...
        updatePropertyTestButtons() {
          ...
          var component = this._targetComponent;
          var registry = (_crd && autoTestRegistry === void 0 ? (_reportPossibleCrUseOfautoTestRegistry({
            error: Error()
          }), autoTestRegistry) : autoTestRegistry).get(component.constructor);
          if (!registry) return;

          for (var entry of registry) {
            var testFunction = component[entry.name];
            var newTestButton = new (_crd && PropertyTestButton === void 0 ? (_reportPossibleCrUseOfPropertyTestButton({
              error: Error()
...
//# sourceMappingURL=d21b2bc4195090d7ec39004777749bfa4bc57a17.js.map