    ...
    execute: function () {
      ...
      _export("AudioManager", AudioManager = (_dec = ccclass('AudioManager'), _dec2 = property(AudioSource), _dec3 = property(AudioSource), _dec4 = property([AudioSource]), _dec5 = property(AudioSource), _dec6 = property([AudioSource]), _dec(_class = (_class2 = (_class3 = class AudioManager extends Component {
        ...
        onLoad() {
          ...
          for (var i = 0; i < this.musicExtraAudioSource.length; i++) {
        ...
        fadeMusicExtraVolume(index, startVolume, targetVolume, duration, callback) {
          if (duration === void 0) {
            duration = 0.5;
          }
        ...
        fadeMusicExtraVolumePromise(index, startVolume, targetVolume, duration) {
          if (duration === void 0) {
            duration = 0.5;
          }
