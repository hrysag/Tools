    ...
    execute: function () {
      ...
      _export("GameController016", GameController016 = (_dec = ccclass('GameController016'), _dec(_class = class GameController016 extends (_crd && AbstractBasicGameController === void 0 ? (_reportPossibleCrUseOfAbstractBasicGameController({
        ...
        randomRangeVoiceForBegin() {
          var targetPool = [(_crd && SoundList === void 0 ? (_reportPossibleCrUseOfSoundList({
            error: Error()
          ...
          var index = (_crd && GameUtilsTools === void 0 ? (_reportPossibleCrUseOfGameUtilsTools({
            error: Error()
        ...
        */
        ...
        initForOtherSystem() {
          ...
          var currentTurboMode = (_crd && GenericUIManager === void 0 ? (_reportPossibleCrUseOfGenericUIManager({
            error: Error()
        ...
        processInShowEndEvent() {//--準備要下一局的資料
          //--不能做在這裡
        ...
        processReceiveBet(betData) {
          ...
          var roundData = (_this$_currentSlotInf2 = this._currentSlotInfo) == null ? void 0 : _this$_currentSlotInf2.getCloneData(); //=======公版GUI需要的每一局的資料========
          //--其他款的話還要再判斷是否有其他符合條件的遊戲流程-20251219

          var hasFGOthers = roundData.freeGameReelInfo.length > 0 ? true : false;
          var roundTotalOdds = roundData.allRoundOdds;
          this._autoNextDataForGui = {
        ...
        testReceiveBetData() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var cloneData = (_this$_currentSlotInf4 = _this._currentSlotInfo) == null ? void 0 : _this$_currentSlotInf4.getCloneData(); //console.log('cloneData:', cloneData);
            //this._gameViewManager.runTest(cloneData);
            //return;//-測試先關閉往下

            _this._gameViewManager.setServerReceiveData(cloneData);

            _this._gameViewManager.newRoundDataToStopSpin();
          })();
        }
        /**
         * 維多利亞強開：
        ...
        testServerData() {
          ...
          var testBase64Data = [//'AQAAAAAICAoBCAgICQkJBQUFBQICAAA=',//--沒有位移的2個wild
          ...
          this.resetRoundData();
          var itemBase64 = testBase64Data[this._testIndex];
          var aryBuffer = (_crd && Utility === void 0 ? (_reportPossibleCrUseOfUtility({
            error: Error()
...
//# sourceMappingURL=f6468cf5382a098b73cec39c5dfaaa8af06b537c.js.map