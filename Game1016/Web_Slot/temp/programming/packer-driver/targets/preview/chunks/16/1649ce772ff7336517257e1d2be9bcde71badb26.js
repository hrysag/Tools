    ...
    execute: function () {
      ...
      _export("PortraitBGModifier", PortraitBGModifier = (_dec = ccclass('PortraitBGModifier'), _dec2 = property(Widget), _dec3 = property(Widget), _dec(_class = (_class2 = class PortraitBGModifier extends Widget {
        ...
        updateAlignment() {
          ...
          var parentUITransform = this.node.parent.getComponent(UITransform);
          var currentUITransform = this.node.getComponent(UITransform);
...
//# sourceMappingURL=1649ce772ff7336517257e1d2be9bcde71badb26.js.map