        ...
        var MyLib = (_class => {
          ...
          var MegaWaysWinScoreAnalyzer = class {
            ...
            megaWaysWinData(iconData) {
              ...
              for (var icon of this.iconList) {
                ...
                for (var [key, value] of oneIconMatchMap) {
                  var winData = new MegaWaysWinData(key, value.odd, value.pos, value.oneMatchPos, value.win2DPos);
            ...
            calculateOneIconMegaWays(icon, icon2DData) {
              ...
              var oneIconMatchMap = /* @__PURE__ */new Map();
              ...
              var _loop2 = function _loop2(i) {
                ...
                if (icon2DData[i].includes(icon) || hasWild) {
                  ...
                  if (tempOdds > 0) {
                    var win2DPos = _this.convertWinIndexTo2DArray(allPosList);

                    var payLineData = new MegaWaysWinData(icon, tempOdds, allPosList, expandedWinPaths, win2DPos);
          ...
          var RoundModel055 = class {
            ...
            calculateExtraData(extraData, winPosData, isChangeSixDisk) {
              ...
              if (isChangeSixDisk) {
                ...
                for (var _index = startReelID; _index < extraData.length; _index++) {
                  result[_index] = extraData[_index].slice(0, 2);
                }
              }
          ...
          function _checkScore(base64Str) {
            var binaryBuffer = base64ToBinaryBuffer(base64Str);
            var slotInfo = new SlotInfo055(binaryBuffer, 100);
            var odd = slotInfo.getTotalOdd();
            return odd;
          }
...
//# sourceMappingURL=3b257cbd795fd2cd823095a34730cc9afe544c0d.js.map