    ...
    execute: function () {
      ...
      _export("ShowContainerWithResizeManager", ShowContainerWithResizeManager = (_dec = ccclass('ShowContainerWithResizeManager'), _dec2 = property({
        ...
        changeRotationResolution(orientation) {
          ...
          for (var containerList of this._basicShowContainerManager.showContainerMap.values()) {
            for (var nodeAry of containerList) {
              ...
              for (var displayItem of nodeAry.gameNodeHashInfo) {
                var displayNode = displayItem.displayNode; //-ContainerWholeBehavior
        ...
        changeGameState(gameState, condition) {
          ...
          var mainTarget = this._basicShowContainerManager.getTargetContainer(gameState, condition);

          var showContainerList = this._basicShowContainerManager.showContainerMap;
          var processed = new Set();

          for (var [mapGameState, containerList] of showContainerList.entries()) {
            for (var group of containerList) {
              ...
              for (var node of group.gameNodeHashInfo) {
                ...
                var displayNode = node.displayNode;
        ...
        initComps() {
          ...
          var targetMap = (_this$_basicShowConta11 = this._basicShowContainerManager) == null ? void 0 : _this$_basicShowConta11.showContainerMap;

          for (var containerList of targetMap.values()) {
...
//# sourceMappingURL=f648c486e011d535e6fdbc246f5126e807ebaef8.js.map