System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Vec3, UniReel, EaseType, DropType, _dec, _class, _crd, ccclass, property, UniDropReel;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      DropType = _unresolved_4.DropType;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("UniDropReel", UniDropReel = (_dec = ccclass('DropUniReel'), _dec(_class = class UniDropReel extends (_crd && UniReel === void 0 ? (_reportPossibleCrUseOfUniReel({
        ...
        drop(ease, easedValueCustom) {
          ...
          var _loop = function _loop(i) {
            ...
            dropIcons[i].addCallback(() => {
              _this4.dropComplete(dropIcons[i], lastIcon);
            });
          };
        ...
        setDropIconTopPos(idList) {
          ...
          var directionMultiplier = this.inverseDirection ? -1 : 1;
          var lastIconIndex = this.iconAmount - 1;

          var _loop2 = function _loop2() {
            var iconIndex = resetIdList[i];
            var offset = _this5.moveDis * (lastIconIndex + i) * directionMultiplier;
...
//# sourceMappingURL=2172342fed7b8cf814da5a2be156dcbfa6763a3b.js.map