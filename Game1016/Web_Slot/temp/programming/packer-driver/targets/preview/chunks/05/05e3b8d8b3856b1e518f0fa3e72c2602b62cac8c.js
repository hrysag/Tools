  ...
  return {
    ...
    execute: function () {
      ...
      _export("SkeletonExtension", SkeletonExtension = (_dec = ccclass('SkeletonExtension'), _dec2 = property({
        ...
        updateSlotTexture() {
          for (var slotAttach of this.slotAttaches) {
            var tex = slotAttach.spriteFrame.texture;
            this.setSlotTexture(slotAttach.slotName, tex, this.isCreateNew);
          }
        }

        playLocalizationSpine(animName, track, isLoop) {
          if (track === void 0) {
            track = 0;
          }
        ...
        playLocalizationSpinePromise(animName, track, isLoop) {
          if (track === void 0) {
            track = 0;
          }
          ...
          return new Promise((resolve, reject) => {
            var tr = this.setAnimation(track, animName, isLoop);
...
//# sourceMappingURL=05e3b8d8b3856b1e518f0fa3e72c2602b62cac8c.js.map