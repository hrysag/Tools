    ...
    execute: function () {
      ...
      _export("Test", Test = (_dec = ccclass('Test'), _dec(_class = class Test extends Component {
        ...
        start() {
          ...
          var winEvent = new (_crd && ActionEvent === void 0 ? (_reportPossibleCrUseOfActionEvent({
            error: Error()
          ...
          input.on(Input.EventType.KEY_DOWN, event => {
            ...
            if (event.keyCode === KeyCode.KEY_B) {
              var appearEvent = this.aep.EventList[0];
              appearEvent.frame = 2;
...
//# sourceMappingURL=b2a53a7e717675a6d06a197e67e8b62e77fa56c6.js.map