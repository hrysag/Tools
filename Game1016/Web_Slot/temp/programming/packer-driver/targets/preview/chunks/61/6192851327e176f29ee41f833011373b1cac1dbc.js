    ...
    execute: function () {
      ...
      _export("AutoSpinAreaUI", AutoSpinAreaUI = (_dec = ccclass('AutoSpinAreaUI'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Animation), _dec7 = property(Animation), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec(_class = (_class2 = class AutoSpinAreaUI extends (_crd && IWindowResize === void 0 ? (_reportPossibleCrUseOfIWindowResize({
        ...
        showUI() {
          ...
          var spinBtnState = this.spinBtnAnimation.getState('spinRotate');
          var startBtnState = this.startBtnAnimation.getState('spinRotate');
        ...
        onStartBtnClick() {
          ...
          if (this.autoSpinAmountArea) {
            var autoSpinAmountSelectedID = this.autoSpinAmountArea.getCustomData();
        ...
        createAreas(customAreaPrefabs) {
          customAreaPrefabs.forEach(areaPrefab => {
            var areaNode = instantiate(areaPrefab);
            var area = (_crd && getCustomArea === void 0 ? (_reportPossibleCrUseOfgetCustomArea({
              error: Error()
        ...
        setKeyboardBtnEvent() {
          this.setKeyDot();
          var keyboardDataList = [(_crd && KeyboardData === void 0 ? (_reportPossibleCrUseOfKeyboardData({
            error: Error()
          ...
          var keyboardBtns = this.keyboardBtnRootNode.getComponentsInChildren(Button);
        ...
        showKeyboard(selectedConditionArea) {
          ...
          this.calculateKeyboardPosition();
          var isDark = this.selectedConditionArea.selectedLine.isThresholdMaxLength();
        ...
        calculateKeyboardPosition() {
          ...
          var worldPosition = this.selectedConditionArea.selectedLine.getThresholdLabelWorldPosition();
          var heightThreshold = view.getDesignResolutionSize().height / 2 * 0.6;
          var realY = worldPosition.y < heightThreshold ? worldPosition.y + 100 : worldPosition.y - 100;
        ...
        setKeyboardDarkLabel(isDark) {
          var keyBoardLabels = this.keyboardBtnRootNode.getComponentsInChildren(Label);
          var lightness = isDark ? 127 : 255;
        ...
        getAreasCustomData() {
          var autoSpinAreaSelections = [];
          this.customAreas.forEach(area => {
            if (area.node.active) {
              var customData = area.getCustomData();
        ...
        isMeetsAnyStopCondition(context) {
          var conditionAreas = this.customAreas.filter(area => area.autoSpinAreaType === (_crd && AutoSpinAreaType === void 0 ? (_reportPossibleCrUseOfAutoSpinAreaType({
            error: Error()
          }), AutoSpinAreaType) : AutoSpinAreaType).Condition);
...
//# sourceMappingURL=6192851327e176f29ee41f833011373b1cac1dbc.js.map