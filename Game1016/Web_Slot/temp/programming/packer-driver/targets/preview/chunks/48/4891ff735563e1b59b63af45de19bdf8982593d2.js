    ...
    execute: function () {
      ...
      _export("JpShowCtrl1016", JpShowCtrl1016 = (_dec = ccclass('JpShowCtrl1016'), _dec2 = property({
        ...
        constructor() {
          ...
          //--78有夠不好做的功能
          this.frameEvtCallBack = /*#__PURE__*/_asyncToGenerator(function* () {
            //console.log('FrameEvtCallBack: HideNumber');
            yield _this.tweenOpacity(_this._bgDarkNode, 0, 0.25);
            _this._bgDarkNode.active = false;
          });
        }
        ...
        register() {
          var gameStepDelayTimeList = (_crd && GlobalAccessReader === void 0 ? (_reportPossibleCrUseOfGlobalAccessReader({
            error: Error()
        ...
        processBoardIn() {
          ...
          return _asyncToGenerator(function* () {
            _this2._currentJpBoard.node.active = true;
            _this2._bgDarkNode.active = true;

            _this2.tweenOpacity(_this2._bgDarkNode, 255, 0.25);

            yield _this2._currentJpBoard.openUIBoard();
          })();
        } //--override it


        addFrameEventCallBack() {
          var jpAniCtrl = this._currentJpBoard;
        ...
        tweenOpacity(target, opacityValue, duration) {
          var upOpacity = target.getComponent(UIOpacity);
          var {
            promise,
            cancel
        ...
        processRunScoreLabel(value) {
          ...
          return _asyncToGenerator(function* () {
            var label = _this3._currentJpBoard.labelNumber;

            if (label) {
              _this3._jpDigitsAniNumber.setLabelNode(label);
            }
        ...
        fadeInOrOutBGMusic(value) {
          var music1Playing = this._bgmAudioSource1.playing;
          var music2Playing = this._bgmAudioSource2.playing; //const currentMusicSource = music1Playing ? this._bgmAudioSource1 : (music2Playing ? this._bgmAudioSource2 : null);
...
//# sourceMappingURL=4891ff735563e1b59b63af45de19bdf8982593d2.js.map