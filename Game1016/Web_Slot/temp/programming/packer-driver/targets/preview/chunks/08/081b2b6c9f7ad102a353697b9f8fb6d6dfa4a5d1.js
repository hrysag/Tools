System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, WaysWinScoreAnalyzer, WaysWinScoreAnalyzerTest, ClientLineData, TestConfig, _class3, _crd;

  function _reportPossibleCrUseOfWaysWinData(extras) {
    _reporterNs.report("WaysWinData", "db://assets/Scripts/ModuleEntry", _context.meta, extras);
  }

  function _reportPossibleCrUseOfWaysWinScoreAnalyzer(extras) {
    _reporterNs.report("WaysWinScoreAnalyzer", "db://assets/Scripts/ModuleEntry", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "4dd226+50NB7JoH5NI5Vutu", "WaysWinScoreAnalyzerTest", undefined);
      ...
      _export("WaysWinScoreAnalyzerTest", WaysWinScoreAnalyzerTest = class WaysWinScoreAnalyzerTest extends (_crd && WaysWinScoreAnalyzer === void 0 ? (_reportPossibleCrUseOfWaysWinScoreAnalyzer({
        ...
        getHasWildMultiplierWinData(dataList) {
          ...
          for (var item of dataList) {
            var lineWildOdd = this.getHasLineWildMultiplier(item.pos, this.multipleWildPosList);
        ...
        getHasLineWildMultiplier(winPos, multipleWildPosList) {
          var wildOdd = 1;
          var wildMultiplierPos = new Set(multipleWildPosList);
        ...
        static getConnectCondition(mainSymbolID, nextSymbolID) {
          var wild = [8];
          var isEqual = wild.includes(nextSymbolID) || mainSymbolID === nextSymbolID || wild.includes(mainSymbolID);
          var isLegal = TestConfig.SCORE_ICON_LIST.includes(nextSymbolID) && TestConfig.SCORE_ICON_LIST.includes(mainSymbolID);
        ...
        getWinData(iconList) {
          ...
          var winData = this.getWaysAllWinData(iconList, TestConfig.REEL_AMOUNT, TestConfig.SYMBOL_LENGTH, this.getBiggerWinData.bind(this));

          for (var item of winData) {
            var lineWinOdd = (item.odd * this.getLineMultiplier(item.pos.length)).fixed();
            var lineWinData = new ClientLineData(item.winLineID, item.symbolID, lineWinOdd, item.pos, item.win2DPos);
...
//# sourceMappingURL=081b2b6c9f7ad102a353697b9f8fb6d6dfa4a5d1.js.map