System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, tween, v3, Vec3, ReelBase, DropMode, DropState, _dec, _class, _crd, ccclass, property, DropReel;
  ...
  function _reportPossibleCrUseOfDropReelData(extras) {
    _reporterNs.report("DropReelData", "../Model/DropReel/DropReelData", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "52dc3L38m5La5l01cyWd47r", "DropReel", undefined);
      ...
      _export("DropReel", DropReel = (_dec = ccclass('DropReel'), _dec(_class = class DropReel extends (_crd && ReelBase === void 0 ? (_reportPossibleCrUseOfReelBase({
        ...
        init(reelID, iconNodes, havePrepareIcon) {
          if (havePrepareIcon === void 0) {
            havePrepareIcon = false;
          }
        ...
        startDropTween(data, state) {
          var _this = this;

          return _asyncToGenerator(function* () {
            var mode = _this._curMode;

            _this.rollSetting(state, mode);
            ...
            for (var i = data.length - 1; i >= 0; i--) {
              ...
              var delayTime = _this._curDropSpacingTime * delayCount;

              var tweenPromise = _this.delayDropTween(delayTime, data[i].node, data[i].moveCount, _this._curEasingType);
        ...
        delayDropTween(delay, node, moveCount, easingType) {
          var _this2 = this;

          return _asyncToGenerator(function* () {
            yield _this2.delay(delay);
            yield _this2.dropTween(node, moveCount, easingType);
          })();
        }
        ...
        resetDropOutIconPos(data) {
          var resetDistance = new Vec3();
          var resetPos = new Vec3();
...
//# sourceMappingURL=5423e01fa9bceaecfca91a1bc6e3de32e46bf9e4.js.map