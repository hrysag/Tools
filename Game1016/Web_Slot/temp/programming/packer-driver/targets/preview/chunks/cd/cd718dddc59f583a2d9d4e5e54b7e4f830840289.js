      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(CCString), _dec(_class = (_class2 = class GameController extends Component {
        ...
        checkConditionValid(conditionLine) {
          ...
          if (conditionLine.isMeetsStopCondition(this.checkAutoNextData)) {
            var conditionLineData = conditionLine.getConditionLineData();
        ...
        onShowAutoUI() {
          this.getAutoSpinAreasCustomData();
          var conditionAreasData = this.autoSpinAreasCustomData[this.conditionAreaIndex];
          ...
          if (conditionAreasData && Array.isArray(conditionAreasData)) {
            ...
            // }
            // 取消勾選所有所有選項
            var shouldCloseConditionIndexes = Array.from({
        ...
        sendBet(bet, additionalPurchaseType) {
        ...
        onTimeScaleChange() {
          ...
          var items = director.getScene().getComponentsInChildren(_crd && SpineTimeScaleTuner === void 0 ? (_reportPossibleCrUseOfSpineTimeScaleTuner({
            error: Error()
          ...
          var animationsItems = director.getScene().getComponentsInChildren(_crd && AnimationTimeScaleTuner === void 0 ? (_reportPossibleCrUseOfAnimationTimeScaleTuner({
            error: Error()
          }), AnimationTimeScaleTuner) : AnimationTimeScaleTuner);

          for (var _item of animationsItems) {
            _item.tuneAnimationByTimeScale();
          }
        }
        ...
        fetchLastPlantData() {
          return new Promise((resolve, reject) => {
            if ((_crd && NetworkHandler === void 0 ? (_reportPossibleCrUseOfNetworkHandler({
              ...
              var base64Data = (_crd && Utility === void 0 ? (_reportPossibleCrUseOfUtility({
                error: Error()
...
//# sourceMappingURL=cd718dddc59f583a2d9d4e5e54b7e4f830840289.js.map