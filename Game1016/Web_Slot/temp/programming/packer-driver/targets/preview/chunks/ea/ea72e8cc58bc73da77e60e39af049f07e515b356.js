    ...
    execute: function () {
      ...
      _export("AutoSizeWithAdaptWindowSize", AutoSizeWithAdaptWindowSize = (_dec = ccclass('AutoSizeWithAdaptWindowSize'), _dec2 = property({
        ...
        */
        ...
        onResize(newSize) {
          for (var i = 0; i < this.resizeNodeList.length; i++) {
            var currentUITransform = this.resizeNodeList[i].getComponent(UITransform);
...
//# sourceMappingURL=ea72e8cc58bc73da77e60e39af049f07e515b356.js.map