System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f2a7bcZd0FHcpJ7z2jQLKDA", "GameSetting", undefined);
      ...
      _export("GameSetting", GameSetting = (_dec = ccclass('GameSetting'), _dec(_class = (_class2 = class GameSetting {
        ...
        error: Error()
      }), SlotRelayLang) : SlotRelayLang).tw, _class2._gameLogo = "ApexWin", _class2.isShowAWLogo = true, _class2.isShowBottomAWLogo = true, _class2.isShowCoinAWLogo = true, _class2.shouldSwapThousandAndDecimalSeparators = false, _class2.keyboardLock = false, _class2.historyURL = "https://dev-gamerecord.apex-win.com/#/game-list?lang=[lang]&history=[json]", _class2.payTableURL = "https://gameapi.apex-win.com/ApexWin?gameID=[gameID]&lang=[lang]&page=introduction", _class2.ruleURL = "https://gameapi.apex-win.com/ApexWin?gameID=[gameID]&lang=[lang]&page=operation", _class2.customData = "", _class2.customDataJson = {}, _class2._platformBetValueList = [100, 200, 300, 500, 800, 1000, 1500, 2000, 2500, 3000, 5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000, 20000, 30000, 50000], _class2)) || _class));
...
//# sourceMappingURL=7245e285a456d8efe0a2a9df8d0f14b41b6f023a.js.map