      ...
      _export("FG_UI_Display", FG_UI_Display = (_dec = ccclass('FG_UI_Display'), _dec2 = property({
        ...
        triggerFGCountUp(value) {
          ...
          return _asyncToGenerator(function* () {
            ...
            (_this$_aniCtrl2 = _this._aniCtrl) == null || _this$_aniCtrl2.gotoPlayLastFrame({
              aniState: ANIMATION_FGUI_TYPE.FG_COUNT
            });

            var signal = _this._async.createAbortScope(SIGNAL_KEY);

            var p = _this._aniCtrl.playAniInPromise({
              aniState: ANIMATION_FGUI_TYPE.FG_COUNT
            });
            ...
            var cancel = value => {
              ...
              //--加速
              (_this$_aniCtrl3 = _this._aniCtrl) == null || _this$_aniCtrl3.goBackToDefault();
            };

            _this._async.withTimeout(p, timeout, //--race time
            {
        ...
        getFGCountWPos() {
          var parentUiTransform = this._fgLabelNode.parent.getComponent(UITransform);

          if (parentUiTransform) {
            var lPos = this._fgLabelNode.position.clone();
...
//# sourceMappingURL=4915e5e8ec45a2ee97a2067bf6e598ede8718357.js.map