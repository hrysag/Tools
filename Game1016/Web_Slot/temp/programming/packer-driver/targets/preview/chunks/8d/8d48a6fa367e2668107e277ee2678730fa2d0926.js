System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "cc/env"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Canvas, Size, UITransform, view, Widget, IWindowResize, ScreenAdapter, Orientation, BUILD, EDITOR, PREVIEW, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, AdaptWindowSize;
  ...
  function _reportPossibleCrUseOfIWindowResize(extras) {
    _reporterNs.report("IWindowResize", "../Orientation", _context.meta, extras);
  }

  function _reportPossibleCrUseOfScreenAdapter(extras) {
    _reporterNs.report("ScreenAdapter", "../Orientation", _context.meta, extras);
  }
    ...
    execute: function () {
      ...
      _export("AdaptWindowSize", AdaptWindowSize = (_dec = ccclass('AdaptWindowSize'), _dec2 = property({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "maxSize", _descriptor2, this);
        ...
        onEnable() {
          this.onWindowResize((_crd && ScreenAdapter === void 0 ? (_reportPossibleCrUseOfScreenAdapter({
            error: Error()
        ...
        onResize(orientation) {
          ...
          var preferredWidth = this._canvasHtmlElement.clientWidth;
          var preferredHeight = this._canvasHtmlElement.clientHeight;
          var viewSize = view.getVisibleSizeInPixel();

          if (orientation === (_crd && Orientation === void 0 ? (_reportPossibleCrUseOfOrientation({
            error: Error()
          }), Orientation) : Orientation).Landscape) {
            var actualAspectRatio = preferredWidth / preferredHeight;
            ...
            var _actualAspectRatio = preferredHeight / preferredWidth;
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "maxSize", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=8d48a6fa367e2668107e277ee2678730fa2d0926.js.map