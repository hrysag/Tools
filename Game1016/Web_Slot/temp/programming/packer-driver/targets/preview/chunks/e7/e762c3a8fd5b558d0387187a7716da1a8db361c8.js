      ...
      _export("UniDropReelExample", UniDropReelExample = (_dec = ccclass('DropUniReelExample'), _dec2 = property(_crd && ReelBounceConfig === void 0 ? (_reportPossibleCrUseOfReelBounceConfig({
        ...
        */
        ...
        drop(ease, easedValueCustom) {
          ...
          var lastIcon = dropIcons[dropIcons.length - 1];
          ...
          var _loop = function _loop(i) {
            if (_this5.iconDropSpaceTime > 0) {
              ...
              _this5.scheduleOnce(() => {
                _this5.runDrop(dropIcons[i], lastIcon, ease, easedValueCustom);
              }, delay);
            } else {
              _this5.runDrop(dropIcons[i], lastIcon, ease, easedValueCustom);
            }
        ...
        dropBouncingAsync(dropIcon, lastIcon) {
          var _this7 = this;

          return _asyncToGenerator(function* () {
            return new Promise((resolve, reject) => {
              var dis = -_this7.bounceConfig.bounceDis;
              var downEasing = _this7.bounceConfig.downBounceEasing;
              var downDuration = _this7.bounceConfig.downBounceDuration;
              var upEasing = _this7.bounceConfig.upBounceEasing;
              var upDuration = _this7.bounceConfig.upBounceDuration;
              var downRealCurve = _this7.bounceConfig.useRealCurve ? _this7.bounceConfig.downBounceRealCurve : null;
              var upRealCurve = _this7.bounceConfig.useRealCurve ? _this7.bounceConfig.upBounceRealCurve : null;
              dropIcon.moveBy(_this7.moveDir.multiplyScalar(dis).negative(), downDuration, downEasing, downRealCurve);
              dropIcon.moveBy(_this7.moveDir.multiplyScalar(dis), upDuration, upEasing, upRealCurve);
              dropIcon.addCallback(() => {
                _this7.setDropFinished(dropIcon, lastIcon);
              });
            });
          })();
        }
