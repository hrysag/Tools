System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "a1266pbwk9FTpMQxoivvNGZ", "RS_BG_PM_Display", undefined);

      __checkObsolete__(['_decorator', 'Component', 'Node', 'CCBoolean']); //import { Orientation } from "db://assets/Scripts/Utils/Config";
      ...
      _export("RS_BG_PM_Display", RS_BG_PM_Display = (_dec = ccclass('RS_BG_PM_Display'), _dec2 = property({
        ...
        displayName: '是否為背景動畫',
        tooltip: '預設false'
      }), _dec(_class = (_class2 = class RS_BG_PM_Display extends (_crd && ContainerWholeBehavior === void 0 ? (_reportPossibleCrUseOfContainerWholeBehavior({
        error: Error()
...
//# sourceMappingURL=c5dd5bfc46f24057098d7cecee4ddf1bb66296f2.js.map