    ...
    execute: function () {
      ...
      _export("BkgChangeColor", BkgChangeColor = (_dec = ccclass('BkgChangeColor'), _dec2 = property({
        ...
        setTweenToDark(colorValue, isDark) {
          ...
          var value = colorNumber.value.toString(); //console.log('check_setTweenBrightness:', isDark, this._symbol.reelIndex, value);
        ...
        openDark(spColorMode) {
          if (spColorMode === void 0) {
            spColorMode = false;
          }

          this._colorState = true;
          var colorValue = this.getDarkBrightness(true, spColorMode);
        ...
        closeDark(spColorMode) {
          ...
          this._colorState = false;
          var colorValue = this.getDarkBrightness(false, spColorMode);
          this.changeBasicSpineDarkState(colorValue);
          this.changeBasicSpriteDarkState(colorValue);
        }
        ...
        openTweenDark(spColorMode) {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this._colorState = true;

            var colorValue = _this.getDarkBrightness(true, spColorMode);

            yield _this.setTweenToDark(colorValue, true);
          })();
        }
        ...
        closeTweenDark(spColorMode) {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this2._colorState = false;

            var colorValue = _this2.getDarkBrightness(false, spColorMode);

            yield _this2.setTweenToDark(colorValue, false);
          })();
        }
...
//# sourceMappingURL=930a192ffa538038f3f22bcaaaebefeb0124864b.js.map