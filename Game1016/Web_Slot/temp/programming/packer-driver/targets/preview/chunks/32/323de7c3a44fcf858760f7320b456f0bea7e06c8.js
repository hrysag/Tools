System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfWaysWinData(extras) {
    _reporterNs.report("WaysWinData", "../../../Scripts/GameScripts/BoardAnalysis/v1/WaysWinScoreAnalyzer", _context.meta, extras);
  }

  function _reportPossibleCrUseOfWaysWinScoreAnalyzer(extras) {
    _reporterNs.report("WaysWinScoreAnalyzer", "../../../Scripts/GameScripts/BoardAnalysis/v1/WaysWinScoreAnalyzer", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "3716c9OeFhDbJD8JKk49qP0", "WaysWinScoreAnalyzerTest", undefined);
      ...
      _export("WaysWinScoreAnalyzerTest", WaysWinScoreAnalyzerTest = class WaysWinScoreAnalyzerTest extends (_crd && WaysWinScoreAnalyzer === void 0 ? (_reportPossibleCrUseOfWaysWinScoreAnalyzer({
        ...
        getWinData(iconList) {
          ...
          var winPos = [];
          var lineWinDataList = [];
          var winData = this.getWaysWinData(iconList, TestConfig.REEL_AMOUNT, TestConfig.SYMBOL_LENGTH);
...
//# sourceMappingURL=323de7c3a44fcf858760f7320b456f0bea7e06c8.js.map