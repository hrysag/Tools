System.register(["__unresolved_0", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfreq(extras) {
    _reporterNs.report("req", "./checkScore055.js", _context.meta, extras);
  }

  function _reportPossibleCrUseOfd(extras) {
    _reporterNs.report("d", "./checkScore055.js", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      _crd = true; // I am the facade module who provides access to the CommonJS module './checkScore055.js'~

      if (!(_crd && req === void 0 ? (_reportPossibleCrUseOfreq({
        error: Error()
      }), req) : req)) {
        loader.throwInvalidWrapper('./checkScore055.js', _context.meta.url);
      }
...
//# sourceMappingURL=5f18bb4ac2a00f982483e12030fff15d25b08224.js.map