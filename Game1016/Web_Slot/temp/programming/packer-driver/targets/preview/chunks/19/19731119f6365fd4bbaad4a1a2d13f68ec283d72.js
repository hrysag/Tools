System.register(["__unresolved_0", "cc", "cc/env", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, assetManager, Button, Camera, Canvas, Color, director, EventHandler, gfx, instantiate, js, Label, Prefab, RenderTexture, resources, Toggle, tween, UITransform, Vec3, view, EDITOR, PREVIEW, Debug, GameSetting, _crd, _startTimer;
  ...
  function addEventHandlerToToggle(toggleNode, component, callback, customEventData) {
    ...
    var toggleClickEvents = toggle.checkEvents;
    var index = toggleClickEvents.indexOf(clickEventHandler);
  ...
  function makeSkippablePromise(targetPromise) {
    var skipFunc;
    var promiseForSkip = new Promise((resolve, reject) => {
      skipFunc = resolve;
    });
    var skippablePromise = Promise.any([targetPromise, promiseForSkip]);
    return {
...
//# sourceMappingURL=19731119f6365fd4bbaad4a1a2d13f68ec283d72.js.map