    ...
    execute: function () {
      ...
      _export("SliceAdditiveSprite", SliceAdditiveSprite = (_dec = ccclass('SliceAdditiveSprite'), _dec(_class = class SliceAdditiveSprite extends Sprite {
        ...
        _flushAssembler() {
          ...
          var assembler = this.type === Sprite.Type.SLICED && this.material !== null ? _crd && sliceAdditive === void 0 ? (_reportPossibleCrUseOfsliceAdditive({
            error: Error()
...
//# sourceMappingURL=adb3e90a5cbc1548419b5cf6ace2015758f96616.js.map