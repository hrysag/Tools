System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfSpineCtrlPropDef(extras) {
    _reporterNs.report("SpineCtrlPropDef", "./AnimationPlayStateBase", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "ea47d1GxxdNb5CcUO/gmJb7", "SpineSequencePlay", undefined);

      __checkObsolete__(['_decorator', 'Component', 'EventTarget', 'Node', 'sp', 'ISchedulable']);
      ...
      _export("SpineSequencePlay", SpineSequencePlay = (_dec = ccclass('SpineSequencePlay'), _dec2 = property({
        ...
        resetDataBeforeDestroy() {
          if (this._sp) {
            ...
            if (this._clearTracksSetting == (_crd && CleanTrackType === void 0 ? (_reportPossibleCrUseOfCleanTrackType({
              ...
              var _trackEntry = this._sp.getCurrent(0);

              if (_trackEntry) {
                this._sp.clearTrack(_trackEntry.trackIndex);
              }
            } else {
        ...
        findSequenceList(sequenceName) {
          for (var i = 0; i < this._sequenceData.sequenceList.length; i++) {
        ...
        playSequence(sequenceName) {
          ...
          var currentSequenceData = this._currentSequenceData.sequence;
          var currentItem;
        ...
        playSpineAnimation(item) {
          var trackEntry = this._sp.setAnimation(0, item.targetName, item.loop);
...
//# sourceMappingURL=59a07dc7f3ac7af293c1669ac42deeb1f091990e.js.map