System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, color, Sprite, SpriteFrame, UniIconBase, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, UniIconExample1016;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "560181myzxCM5wtq2fpXMOy", "UniIconExample1016", undefined);

      __checkObsolete__(['_decorator', 'color', 'Sprite', 'SpriteFrame']);
      ...
      _export("UniIconExample1016", UniIconExample1016 = (_dec = ccclass('UniIconExample1016'), _dec2 = property({
        range: [0, 255]
      }), _dec3 = property(Sprite), _dec4 = property(SpriteFrame), _dec(_class = (_class2 = class UniIconExample1016 extends (_crd && UniIconBase === void 0 ? (_reportPossibleCrUseOfUniIconBase({
        error: Error()
...
//# sourceMappingURL=23c9690281c004bd8180ac6431db7d7baba6fbca.js.map