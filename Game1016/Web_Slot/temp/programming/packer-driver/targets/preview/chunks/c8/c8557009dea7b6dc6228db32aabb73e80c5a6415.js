System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, UniIconBase, _decorator, CCFloat, Component, Enum, instantiate, Prefab, v3, Vec2, Vec3, Queue, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _crd, ccclass, property, LayoutType, StopType, BasicReel;
  ...
  function _reportPossibleCrUseOfIReel(extras) {
    _reporterNs.report("IReel", "db://assets/Scripts/ReelTemplate/ReelTemplate_3/Scripts/Interface/IReel", _context.meta, extras);
  }

  function _reportPossibleCrUseOfSymbolBase(extras) {
    _reporterNs.report("SymbolBase", "db://assets/Scripts/ReelTemplate/ReelTemplate_3/Scripts/Interface/SymbolBase", _context.meta, extras);
  }

  function _reportPossibleCrUseOfUniIconBase(extras) {
    _reporterNs.report("UniIconBase", "db://assets/Scripts/ReelTemplate/ReelTemplate_3/Scripts/UniIconBase", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "e765dZ0IiFPaY1L6f7nLzgZ", "BasicReel", undefined); //import { BasicIcon } from '../BasicIcon/BasicIcon';
      ...
      _export("BasicReel", BasicReel = (_dec = ccclass('BasicReel'), _dec2 = property({
        ...
        moveOnce() {
          ...
          for (var i = 0; i < this._iconList.length; ++i) {
            ...
            if (i === moveOutIndex) {
              var topPos = this.getIconPositionByIndex(0);
        ...
        checkPosition(move) {
          var pos = move.node.getPosition();
          console.log('check_pos', pos, this.maximumIconDic);

          if (pos.y <= -this.maximumIconDic) {}
        }
        ...
        moveOnceComplete(move) {
          ...
          return _asyncToGenerator(function* () {
            _this3.reArrangeIcon();

            _this3.changeSibling(_this3._iconList);

            _this3.onMoveOnceComplete == null || _this3.onMoveOnceComplete();

            if (_this3._stopType === StopType.Immediate || _this3._stopType === StopType.RunoutData && _this3.data.count === 0 || _this3._stopType === StopType.StopBySymbol && _this3.dequeueSymbol !== null && _this3.dequeueSymbol.stopSymbol) {
              //stop
              yield _this3.onStopRoll == null ? void 0 : _this3.onStopRoll();
              _this3.waitForRollComplete == null || _this3.waitForRollComplete();
            } else {
              _this3.moveOnce();
            }
          })();
        ...
        initLayout() {
          for (var i = 0; i < this.iconList.length; i++) {
            var pos = this.getIconPositionByIndex(i);
...
//# sourceMappingURL=c8557009dea7b6dc6228db32aabb73e80c5a6415.js.map