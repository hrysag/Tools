...
import { GameController, GenericUIManager, BetData, PlayerInfo, NetworkHandler, NewFlashModeEnum, BuyFeatureMode, Localization, BuyFeatureCardInfo } from 'db://assets/Scripts/ModuleEntry';
