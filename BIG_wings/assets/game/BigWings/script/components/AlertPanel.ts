import { AlertOptions, IfAlertPanel } from "@casino-mono/mvc";
import { AlertPanelEventMap } from "@casino-mono/mvc";
import { CCString, Component, Prefab, _decorator, instantiate, Node, Label, CCBoolean, EventHandler, Button, Input, CCObject } from "cc";
...
export type BigWingsAlertOptions = {
...
export class AlertPanel extends Component implements IfAlertPanel {
    ...
    protected alertMessageOptions: BigWingsAlertOptions = {
        title: "系統訊息",
        message: "",
    ...
    protected alertDialogs: string[] = ['alertBasicNone', 'alertBasic', 'alertDialog', 'iconAlertDialog'];
    /** 子節點Node */
    ...
    // 呼叫
    public alert(options: BigWingsAlertOptions): Promise<any> {
    ...
    protected onLoad(): void {
        this.create();
        const [alertBasicNone, alertBasic, alertDialog, iconAlertDialog] = this.alertDialogs;
...
export type BigWingsAlertEvent = {
...
export class BasicDialog {
    ...
    private onCloseClick() {
        this.onResolve({ state: DialogEventTypes.CLOSE, isAccept: false, isCancel: true });
    }
     ...
     * @returns 
     */
    public display(options: BigWingsAlertOptions) {
