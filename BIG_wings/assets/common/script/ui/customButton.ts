import { _decorator, Button, Sprite, CCFloat, EventTouch, Node, Vec3, tween, UITransform, UIOpacity, SpriteFrame, Color, color, Label, Font, sp } from 'cc';
...
export class customButton extends Button {
    ...
    protected _onMouseMoveIn(): void {
        ...
        tween(this.Label)
            .to(0, { scale: new Vec3(1.1, 1.1, 1) }, { easing: 'sineOut' })
            .start();
    }
    ...
    protected _onMouseMoveOut(): void {
        ...
        tween(this.Label)
            .to(0, { scale: new Vec3(1, 1, 1) }, { easing: 'sineOut' })
            .start();
    ...
    protected _updateState(): void {
        ...
        //同步更新label顏色四態
        if (this.syncLabelColor[0]?.target != null) {
