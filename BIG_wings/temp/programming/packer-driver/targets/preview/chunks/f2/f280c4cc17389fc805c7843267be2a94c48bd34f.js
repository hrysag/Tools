    ...
    execute: function () {
      ...
      _export("CustomizedButton", CustomizedButton = (_dec20 = ccclass('CustomizedButton'), _dec21 = property({
        ...
        _updateState() {
          ...
          for (var _data of this.syncLabelTransitionColor) {
            _data.target.getComponent(Label).color = _data[this._getButtonState() + "Color"];
          } //禁用時的灰階變化


          for (var _data2 of this.spriteDisabledGray) {
            _data2.grayscale = !this.interactable;
          } //禁用時的透明度變化


          for (var _data3 of this.spriteDisabledOpacity) {
            if (this.interactable) {
              _data3.uiOpacity.opacity = 255;
            } else {
              _data3.uiOpacity.opacity = _data3.opacity;
            }
          }
        }
