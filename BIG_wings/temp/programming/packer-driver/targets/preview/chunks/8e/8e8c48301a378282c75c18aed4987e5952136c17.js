System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, _dec, _class, _crd, ccclass, property, symbolInfo_TA;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "d4fceyI3OJOXLLKmj9s6Jnh", "symbolInfo_TA", undefined);
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'EventHandler', 'Button', 'Event', 'Sprite', 'UITransform', 'SpriteFrame', 'find', 'sp', 'Vec3', 'Label', 'Animation']);
      ...
      _export("symbolInfo_TA", symbolInfo_TA = (_dec = ccclass('symbolInfo_TA'), _dec(_class = class symbolInfo_TA extends Component {//     @property({ type: Node, tooltip: "slot資訊按鈕節點" })
...
//# sourceMappingURL=8e8c48301a378282c75c18aed4987e5952136c17.js.map