  ...
  return {
    ...
    execute: function () {
      ...
      _export("LangSupport", LangSupport = class LangSupport {
        constructor(source) {
          if (source === void 0) {
            source = (_crd && URLParameter === void 0 ? (_reportPossibleCrUseOfURLParameter({
              error: Error()
        ...
        addSupport(lang) {
          for (var _len = arguments.length, alias = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
            alias[_key - 1] = arguments[_key];
          }
