System.register([], function (_export, _context) {
  ...
  var EXP_LIMIT, MAX_DIGITS, NUMERALS, LN10, PI, DEFAULTS, inexact, quadrant, external, decimalError, invalidArgument, precisionLimitExceeded, cryptoUnavailable, tag, mathfloor, mathpow, isBinary, isHex, isOctal, isDecimal, BASE, LOG_BASE, MAX_SAFE_INTEGER, LN10_PRECISION, PI_PRECISION, P, divide, Decimal;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Decimal", Decimal = P.constructor = clone(DEFAULTS)); // Create the internal constants from their string values.


      LN10 = new Decimal(LN10);
      PI = new Decimal(PI);

      _export("default", Decimal);
    }
  };
});
//# sourceMappingURL=cfd59da676d8f96a2bc02a5450a7e0f9fff72731.js.map