    ...
    execute: function () {
      ...
      _export("symbolWin_TA", symbolWin_TA = (_dec = ccclass('symbolWin_TA'), _dec(_class = class symbolWin_TA extends Component {
        ...
        setSymbolWinData(symID, scatterReady, symbolNode) {
          ...
          var scatter = this.node.getChildByName('scatter');
          var stayFx = this.node.getChildByName('stayFx');
          var symbol = this.node.getChildByName('symbol');
        ...
        update() {
          if (this.targetSymbol) {
            var targetPos = this.targetSymbol.getPosition().add(this.targetSymbol.parent.parent.getPosition());
