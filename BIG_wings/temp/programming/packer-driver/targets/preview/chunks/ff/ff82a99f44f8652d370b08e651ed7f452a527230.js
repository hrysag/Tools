    ...
    execute: function () {
      ...
      _export("customButton", customButton = (_dec24 = ccclass('customButton'), _dec25 = property([CustomButtonSyncSprite]), _dec26 = property([CustomButtonSyncLabelColor]), _dec27 = property([CustomButtonSyncLabel]), _dec28 = property([CustomButtonScaleArg]), _dec29 = property([Sprite]), _dec30 = property([CustomButtonDisableOpacity]), _dec31 = property([Node]), _dec32 = property([Node]), _dec33 = property(Node), _dec34 = property(Node), _dec24(_class16 = (_class17 = class customButton extends Button {
        ...
        _onTouchBegan(event) {
          ...
          for (var _data of this.scaleArgs) {
            _data.target.setScale(new Vec3(1, 1, 1));

            tween(_data.target).to(_data.duration, {
              scale: new Vec3(_data.zoomScale, _data.zoomScale, 1)
            }, {
              easing: 'sineOut'
            }).start();
          }
        ...
        _onTouchEnded(event) {
          ...
          for (var _data2 of this.scaleArgs) {
            if (_data2.target.scale.x === 1) return;
            tween(_data2.target).to(_data2.duration, {
        ...
        _onTouchCancel(event) {
          ...
          for (var data of this.scaleArgs) {
        ...
        _updateState() {
          ...
          for (var data of this.syncSprite) {
          ...
          if (((_this$syncLabelColor$ = this.syncLabelColor[0]) == null ? void 0 : _this$syncLabelColor$.target) != null) {
            for (var _data3 of this.syncLabelColor) {
              _data3.target.getComponent(Label).color = _data3[this._getButtonState() + "Color"];
            }
          } // if(this._getButtonState()=="normal"||this._getButtonState()=="disabled"||this._getButtonState()=="hover"){


          for (var _data4 of this.syncLabelTexture) {
            if (_data4[this._getButtonState() + "Font"]) this.Label.getComponent(Label).font = _data4[this._getButtonState() + "Font"];
          } // }
          //禁用時的灰階變化


          for (var _data5 of this.disabledGray) {
            _data5.grayscale = !this.interactable;
          } //禁用時的透明度變化


          for (var _data6 of this.disabledOpacity) {
            if (this.interactable) {
              _data6.uiOpacity.opacity = 255;
            } else {
              _data6.uiOpacity.opacity = _data6.opacity;
            }
          }
        }
