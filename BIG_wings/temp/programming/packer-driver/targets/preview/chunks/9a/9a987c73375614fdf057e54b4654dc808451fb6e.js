    ...
    execute: function () {
      ...
      _export("BuyFreeGamePanel", BuyFreeGamePanel = (_dec = ccclass('BuyFreeGamePanel'), _dec2 = menu('BigWings/BuyFreeGamePanel'), _dec3 = property(Graphics), _dec4 = property(Node), _dec5 = property(sp.Skeleton), _dec6 = property({
        ...
        openPanel() {
          ...
          return _asyncToGenerator(function* () {
            return new Promise((resolve, reject) => {
              ...
              _this.cancelButton.enabled = true;
              _this.confirmButton.enabled = true;
              ...
              (_this$panel_spine = _this.panel_spine) == null ? void 0 : _this$panel_spine.setAnimation(0, 'loop', true);
              (_this$panel_node = _this.panel_node) == null ? void 0 : _this$panel_node.setScale(0, 0);
              tween(_this.panel_node).to(0.3, {
        ...
        confirm() {
          ...
          return _asyncToGenerator(function* () {
            var _this3$panel_spine;

            (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
              error: Error()
            }), AudioMgr) : AudioMgr).play('ui_button_buy_fg_confirm');
            _this3.cancelButton.enabled = false;
            _this3.confirmButton.enabled = false;
            (_this3$panel_spine = _this3.panel_spine) == null ? void 0 : _this3$panel_spine.setAnimation(0, 'down', false);
            yield (_crd && UtilsKit === void 0 ? (_reportPossibleCrUseOfUtilsKit({
              error: Error()
            }), UtilsKit) : UtilsKit).Defer(700);
            tween(_this3.node.getComponent(UIOpacity)).to(0.3, {
              opacity: 0
            }).start();
            yield (_crd && UtilsKit === void 0 ? (_reportPossibleCrUseOfUtilsKit({
              error: Error()
            ...
            _this3.node.emit((_crd && CommandEventName === void 0 ? (_reportPossibleCrUseOfCommandEventName({
              error: Error()
