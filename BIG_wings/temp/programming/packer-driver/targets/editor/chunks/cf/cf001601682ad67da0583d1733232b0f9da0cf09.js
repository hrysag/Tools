  ...
  return {
    ...
    execute: function () {
      ...
      _export("AbstractExchangePanel", AbstractExchangePanel = class AbstractExchangePanel {
        ...
        get ratio() {
          let ary = this.betBase.split(':').map(v => new (_crd && Decimal === void 0 ? (_reportPossibleCrUseOfDecimal({
            error: Error()
        ...
        get exBalance() {
          const ary = this._betBase.split(':').map(v => new (_crd && Decimal === void 0 ? (_reportPossibleCrUseOfDecimal({
            error: Error()
          }), Decimal) : Decimal)(v.replace("K", "000")));
        ...
        get nowMaxChange() {
          const canChange = new (_crd && Decimal === void 0 ? (_reportPossibleCrUseOfDecimal({
            error: Error()
          }), Decimal) : Decimal)(this._balance).div(this.ratio);
          const maxChange = new (_crd && Decimal === void 0 ? (_reportPossibleCrUseOfDecimal({
            error: Error()
        ...
        getChangeCredit(credit, fromBase, toBase) {
          const ary = fromBase.split(':').map(v => new (_crd && Decimal === void 0 ? (_reportPossibleCrUseOfDecimal({
            error: Error()
          }), Decimal) : Decimal)(v.replace("K", "000")));
          const fromCredit = new (_crd && Decimal === void 0 ? (_reportPossibleCrUseOfDecimal({
            error: Error()
          }), Decimal) : Decimal)(credit).times(ary[0]).div(ary[1]);
          const toAry = toBase.split(':').map(v => new (_crd && Decimal === void 0 ? (_reportPossibleCrUseOfDecimal({
            error: Error()
          }), Decimal) : Decimal)(v.replace("K", "000")));
