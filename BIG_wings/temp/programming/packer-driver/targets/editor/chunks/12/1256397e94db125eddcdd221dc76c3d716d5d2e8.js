  ...
  return {
    ...
    execute: function () {
      ...
      _export("Application", Application = (_dec = ccclass('Application'), _dec(_class = (_class2 = class Application extends Component {
        ...
        async setup() {
          console.log(this.getComponent(_crd && BigWingsView === void 0 ? (_reportPossibleCrUseOfBigWingsView({
            error: Error()
          }), BigWingsView) : BigWingsView), this);
          let model = new (_crd && BaseModel === void 0 ? (_reportPossibleCrUseOfBaseModel({
            error: Error()
          }), BaseModel) : BaseModel)();
          let view = new (_crd && BaseView === void 0 ? (_reportPossibleCrUseOfBaseView({
            error: Error()
          }), BaseView) : BaseView)();
          ...
          let event = false;
          console.log(`Connect`, event = await presenter.connect().catch(() => {
            return false;
          }));
          ...
          console.log(`JoinGame:`, await presenter.joinGame().catch(e => {
            return e;
          }));
          console.log(`LeaveGame:`, await presenter.leaveGame().catch(e => {
            return e;
          }));
