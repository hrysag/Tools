  ...
  return {
    ...
    execute: function () {
      ...
      _export("BigWingsView", BigWingsView = (_dec = ccclass('BigWingsView'), _dec2 = menu('BigWings/BigWingsView'), _dec3 = property({
        ...
        createPresenter() {
          let presenter = new (_crd && BigWingsPresenter === void 0 ? (_reportPossibleCrUseOfBigWingsPresenter({
            error: Error()
        ...
        async startPresenter(address) {
          ...
          console.log(`creditExchange:`, await presenter.creditExchange('1:1', 10000)); // console.log(`onBeginGame:`, await presenter.beginGame({ "BetCredit": 6, "HitFree": true }));
        ...
        async exit() {
          const {
            presenter
          } = this; // await presenter.leaveGame();
        ...
        configCommandEvent() {
          ...
          if (command) {
            ...
            command.event.on((_crd && CommandEventName === void 0 ? (_reportPossibleCrUseOfCommandEventName({
              error: Error()
            }), CommandEventName) : CommandEventName).BUY_FREEGAME, async betInfo => {
