...
import { CommandEventName, ExchangePanelEventName, ToolBarEventName } from '@casino-mono/mvc';
...
describe('BasePresenter Instance', () => {
    ...
    test('Should be instance of BasePresenter', () => {
        presenter = new BasePresenter(model, view);
        // @ts-ignore
    ...
    test('Should bet error', () => {
        // @ts-ignore
        expect(presenter.isServerError({event: false})).toBeTruthy();
        // @ts-ignore
    ...
    test('SaveUserAutoExchange', () => {
        // @ts-ignore
        presenter.sender.callServer = jest.fn();
        // presenter.saveUserAutoExchange({
        //     autoEx: true,
        //     autoValue: 1,
        //     autoRate: "auto",
        //     lastInput: []
    ...
    test('UpdateUserAnalysis', () => {
        // TODO: update user analysis test case
        // presenter.updateUserAnalysis();
    });
});
...
describe('BaseView Instance', () => {
    ...
    test('BaseView config configToolbarEvent', () => {
        ...
        // @ts-ignore
        view.costume.toolbar.event.on = (action: string, callback: any) => {
            callback();
    ...
    test('BaseView config configCommandEvent', () => {
        ...
        // @ts-ignore
        view.costume.command.event.on = (action: string, callback: any) => {
            callback();
            switch (action) {
    ...
    test('BaseView updateProgress', () => {
        view.updateProgress(10);
    });
    test('BaseView hideHTMLUI', () => {
        view.hideHTMLUI();
    });
